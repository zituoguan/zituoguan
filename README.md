...
- [AdGuardHome Sync](https://github.com/bakito/adguardhome-sync) - AdGuardHome Sync 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [OpenUEM](https://openuem.eu) - OpenUEM 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/open-uem/openuem-console)) `GPL-3.0` `Docker`
- [OPSI](https://www.opsi.org) - Linux 和 Windows 的硬件/软件清单、客户端管理、部署和补丁。 ([源代码](https://github.com/opsi-org/)) `GPL-3.0/AGPL-3.0` `OVF/Python`
- [Rackpad](https://rackpad.net) - Rackpad 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Kobii-git/rackpad)) `GPL-3.0` `Docker`
...
- [Marreta](https://marreta.link) - Marreta 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/manualdousuario/marreta)) `GPL-3.0` `Docker`
...
- [Redirecterr](https://github.com/varthe/Redirecterr) - Redirecterr 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [DashLit](https://dashlit.cwec.dev/) - DashLit 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/codewec/dashlit)) `MIT` `Docker`
...
- [Fenrus](https://github.com/revenz/Fenrus) - Fenrus 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Homarr iFrames](https://github.com/diogovalentte/homarr-iframes) - Homarr iFrames 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [It's MyTabs](https://github.com/louislam/its-mytabs) - It's MyTabs 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Jelu](https://bayang.github.io/jelu-web) - 已读和待读书单追踪器。 ([源代码](https://github.com/bayang/jelu)) `MIT` `Java/Docker`
- [Journiv](https://www.journiv.com) - Journiv 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/journiv/journiv-app)) `GPL-3.0` `Docker`
...
- [Pinkary](https://pinkary.com) - Pinkary 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/pinkary-project/pinkary.com)) `GPL-3.0` `Docker`
...
- [13ft Ladder](https://13ft-ladder.vercel.app/) - 13ft Ladder 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/wasi-master/13ft)) `GPL-3.0` `Docker`
- [Anonymous Overflow](https://aohub.httpjames.space) - Anonymous Overflow 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/httpjamesm/AnonymousOverflow)) `GPL-3.0` `Docker`
...
- [CaddyManager](https://github.com/caddymanager/caddymanager) - CaddyManager 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [Mantrae](https://mantrae.pages.dev) - Mantrae 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/MizuchiLabs/mantrae)) `GPL-3.0` `Docker`
- [Middleware Manager](https://github.com/hhftechnology/middleware-manager) - Middleware Manager 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Traefik Manager](https://traefik-manager.xyzlab.dev/) - Traefik Manager 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/chr0nzz/traefik-manager)) `GPL-3.0` `Docker`
...
- [DumbAssets](https://dumbassets.dumbware.io) - DumbAssets 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/DumbWareio/DumbAssets)) `Apache-2.0` `Docker`
- [DumbDo](https://github.com/DumbWareio/DumbDo) - DumbDo 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [DumbKan](https://github.com/DumbWareio/DumbKan) - DumbKan 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Kanba](https://kanba.co) - Kanba 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Kanba-co/kanba)) `GPL-3.0` `Docker`
...
- [NutriTrace](https://github.com/TraceApps/nutritrace) - NutriTrace 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Operately](https://operately.com) - Operately 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/operately/operately)) `GPL-3.0` `Docker`
...
- [qBit Manage](https://github.com/StuffAnThings/qbit_manage) - qBit Manage 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Roundup](https://www.roundup-tracker.org/) - 网站统计和数据分析平台。 ([源代码](https://github.com/roundup-tracker/roundup)) `GPL-3.0` `Docker`
- [SpendSpentSpent](https://lamarios.github.io/SpendSpentSpent/) - SpendSpentSpent 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/lamarios/SpendSpentSpent)) `GPL-3.0` `Docker`
...
- [TaskTrove](https://tasktrove.io) - TaskTrove 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dohsimpson/TaskTrove)) `Apache-2.0` `Docker`
- [TaskView](https://taskview.tech/) - TaskView 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Gimanh/taskview-community)) `GPL-3.0` `Docker`
...
- [Tenzu](https://http://tenzu.net) - Tenzu 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/BIRU-Scop/tenzu-back)) `GPL-3.0` `Docker`
- [Thrifty](https://buymeacoffee.com/tiehfood) - Thrifty 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/tiehfood/thrifty)) `GPL-3.0` `Docker`
- [Ticky](https://github.com/dkorecko/Ticky) - Ticky 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Squirrel Servers Manager](https://squirrelserversmanager.io/) - Squirrel Servers Manager 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/SquirrelCorporation/SquirrelServersManager)) `Apache-2.0` `Docker`
...
- [bknd](https://bknd.io) - bknd 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/bknd-io/bknd)) `GPL-3.0` `Docker`
- [eddrit](https://eddrit.com) - eddrit 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/corenting/eddrit)) `GPL-3.0` `Docker`
...
- [Flint](https://github.com/0xchasercat/flint) - Flint 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Ghostboard](https://github.com/jon6fingrs/ghostboard) - Ghostboard 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Statamic](https://statamic.com) - Statamic 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/statamic/cms)) `GPL-3.0` `Docker`
...
- [HymnoScribe](https://hymnoscribe.de) - HymnoScribe 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Revisor01/HymnoScribe)) `Apache-2.0` `Docker`
...
- [Scholarsome](https://http://scholarsome.com) - Scholarsome 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/hwgilbert16/scholarsome)) `GPL-3.0` `Docker`
...
- [OwnTracks Frontend](https://github.com/owntracks/frontend) - OwnTracks Frontend 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Bazarr](https://www.bazarr.media) - Bazarr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/morpheus65535/bazarr)) `GPL-3.0` `Docker`
...
- [Configarr](https://configarr.de/) - Configarr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/raydak-labs/configarr)) `GPL-3.0` `Docker`
...
- [Managarr](https://github.com/Dark-Alex-17/managarr) - Managarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Posterizarr](https://github.com/fscorrupt/posterizarr) - Posterizarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Recyclarr](https://recyclarr.dev) - Recyclarr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/recyclarr/recyclarr)) `GPL-3.0` `Docker`
...
- [SonaShow](https://github.com/TheWicklowWolf/SonaShow) - SonaShow 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Tautulli](https://tautulli.com) - Plex 媒体服务器的监控和统计分析工具。 ([源代码](https://github.com/Tautulli/Tautulli)) `GPL-3.0` `Docker`
- [Tracktor](https://tracktor.bytedge.in) - Tracktor 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/javedh-dev/tracktor)) `GPL-3.0` `Docker`
...
- [YTPTube](https://github.com/arabcoders/ytptube) - YTPTube 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Atomic CRM](https://http://marmelab.com/atomic-crm/) - Atomic CRM 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/marmelab/atomic-crm)) `GPL-3.0` `Docker`
...
- [Laudspeaker](https://laudspeaker.com/?ref=github) - Laudspeaker 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/laudspeaker/laudspeaker)) `GPL-3.0` `Docker`
- [Meerkat CRM](https://fbuchner.github.io/meerkat-crm/) - Meerkat CRM 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/fbuchner/meerkat-crm)) `GPL-3.0` `Docker`
...
- [ProxCenter](https://www.proxcenter.io) - ProxCenter 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/adminsyspro/proxcenter-ui)) `GPL-3.0` `Docker`
...
- [Webtop](https://github.com/linuxserver/docker-webtop) - Webtop 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [VaulTLS](https://github.com/7ritn/VaulTLS) - VaulTLS 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Vaultwarden](https://github.com/dani-garcia/vaultwarden) - 用Rust编写的轻量级Bitwarden服务器API实现。 `GPL-3.0` `Rust/Docker`
- [YeetFile](https://github.com/benbusby/yeetfile) - YeetFile 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [ARA](https://ara.recordsansible.org) - ARA 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/ansible-community/ara)) `GPL-3.0` `Docker`
- [Bugzilla](https://www.bugzilla.org/) - 通用缺陷跟踪器和测试工具，最初由Mozilla项目开发和使用。 ([源代码](https://github.com/bugzilla/bugzilla)) `MPL-2.0` `Perl`
- [Cert Warden](https://www.certwarden.com/) - Cert Warden 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/gregtwallace/certwarden)) `GPL-3.0` `Docker`
...
- [mkcert Web UI](https://github.com/jeffcaldwellca/mkcertWeb) - mkcert Web UI 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [osTicket](https://osticket.com) - osTicket 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/osTicket/osTicket)) `GPL-3.0` `Docker`
...
- [PlanarAlly](https://www.planarally.io/) - PlanarAlly 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Kruptein/PlanarAlly)) `GPL-3.0` `Docker`
...
- [Secrover](https://secrover.org) - Secrover 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Secrover/Secrover)) `GPL-3.0` `Docker`
...
- [AniBridge](https://http://anibridge.eliasbenb.dev) - AniBridge 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/anibridge/anibridge)) `GPL-3.0` `Docker`
...
- [Forms.md](https://forms.md) - Forms.md 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/formsmd/formsmd)) `MIT` `Docker`
- [Foundry Virtual Tabletop](https://foundryvtt.com/) - Foundry Virtual Tabletop 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/foundryvtt/foundryvtt)) `GPL-3.0` `Docker`
...
- [Kitsu](https://kitsu.cg-wire.com) - Kitsu 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/cgwire/kitsu)) `GPL-3.0` `Docker`
...
- [Lunar](https://lunarphp.com) - Lunar 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/lunarphp/lunar)) `GPL-3.0` `Docker`
...
- [Octelium](https://octelium.com/docs) - Octelium 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/octelium/octelium)) `GPL-3.0` `Docker`
...
- [Sharkord](https://sharkord.com) - Sharkord 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Sharkord/sharkord)) `GPL-3.0` `Docker`
- [SurveyJS](https://surveyjs.io/form-library) - SurveyJS 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/surveyjs/survey-library)) `GPL-3.0` `Docker`
- [TasmoAdmin](https://github.com/TasmoAdmin/TasmoAdmin) - TasmoAdmin 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Timeful](https://timeful.app) - Timeful 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/schej-it/timeful.app)) `GPL-3.0` `Docker`
- [Tymeslot](https://tymeslot.app) - Tymeslot 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Tymeslot/tymeslot)) `GPL-3.0` `Docker`
- [Wapy.dev](https://www.wapy.dev) - Wapy.dev 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/meceware/wapy.dev)) `GPL-3.0` `Docker`
...
- [OpenPanel](https://openpanel.com) - OpenPanel 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/stefanpejcic/OpenPanel)) `GPL-3.0` `Docker`
...
- [degoog](https://github.com/degoog-org/degoog) - degoog 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Diskover](https://diskoverdata.com) - Diskover 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/diskoverdata/diskover-community)) `GPL-3.0` `Docker`
...
- [Nimtable](https://github.com/nimtable/nimtable) - Nimtable 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [Redis Commander](https://http://joeferner.github.io/redis-commander/) - Redis Commander 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/joeferner/redis-commander)) `Apache-2.0` `Docker`
...
- [Cloud Commander](https://cloudcmd.io) - Cloud Commander 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/coderaiser/cloudcmd)) `GPL-3.0` `Docker`
- [Compose Craft](https://composecraft.com) - 容器化部署和管理工具。 ([源代码](https://github.com/composecraft/composecraft)) `Apache-2.0` `Docker`
- [Convert to it!](https://github.com/p2r3/convert) - Convert to it! 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Drivebase](https://drivebase.io) - Drivebase 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/drivebase/drivebase)) `GPL-3.0` `Docker`
- [Erugo](https://erugo.app) - Erugo 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/ErugoOSS/Erugo)) `GPL-3.0` `Docker`
- [FerriShare](https://github.com/TobiasMarschner/ferrishare) - FerriShare 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [File Wizard](https://github.com/LoredCast/filewizard) - File Wizard 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [FileSync](https://filesync.app) - FileSync 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/polius/FileSync)) `GPL-3.0` `Docker`
- [FolderHost](https://folderhost.org) - FolderHost 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/MertJSX/folderhost)) `GPL-3.0` `Docker`
- [FTPGrab](https://crazymax.dev/ftpgrab/) - FTPGrab 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/crazy-max/ftpgrab)) `GPL-3.0` `Docker`
- [Garage](https://garagehq.deuxfleurs.fr) - Garage 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/deuxfleurs-org/garage)) `GPL-3.0` `Docker`
...
- [GhostFile](https://github.com/jon6fingrs/ghostfile) - GhostFile 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Hoodik](https://github.com/hudikhq/hoodik) - Hoodik 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Lingarr](https://github.com/lingarr-translate/lingarr) - Lingarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Lufin](https://github.com/VityaSchel/lufin) - Lufin 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [Markopolis](https://markopolis.app) - Markopolis 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/rishikanthc/markopolis)) `MIT` `Docker`
- [myDrive](https://github.com/subnub/myDrive) - myDrive 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
- [Nextcloud Deck](https://apps.nextcloud.com/apps/deck) - Nextcloud Deck 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nextcloud/deck)) `GPL-3.0` `Docker`
- [Nextcloud Forms](https://apps.nextcloud.com/apps/forms) - Nextcloud Forms 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nextcloud/forms)) `GPL-3.0` `Docker`
...
- [Nextcloud Office](https://nextcloud.com/collaboraonline) - Nextcloud Office 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nextcloud/richdocuments)) `GPL-3.0` `Docker`
- [Nextcloud Social](https://apps.nextcloud.com/apps/social) - VPN 和网络安全连接工具。 ([源代码](https://github.com/nextcloud/social)) `GPL-3.0` `Docker`
- [Nextcloud Tables](https://apps.nextcloud.com/apps/tables) - Nextcloud Tables 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nextcloud/tables)) `GPL-3.0` `Docker`
- [Nextcloud Talk](https://nextcloud.com/talk) - 即时通讯和社交平台。 ([源代码](https://github.com/nextcloud/spreed)) `GPL-3.0` `Docker`
- [Nextcloud Tasks](https://apps.nextcloud.com/apps/tasks) - Nextcloud Tasks 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nextcloud/tasks)) `GPL-3.0` `Docker`
- [NextExplorer](https://explorer.nxz.ai) - NextExplorer 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nxzai/NextExplorer)) `GPL-3.0` `Docker`
- [OpenList](https://doc.oplist.org) - 支持多种存储后端的文件管理器。 ([源代码](https://github.com/OpenListTeam/OpenList)) `GPL-3.0` `Docker`
- [ownCloud Infinite Scale](https://doc.owncloud.com/ocis/) - ownCloud Infinite Scale 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/owncloud/ocis)) `GPL-3.0` `Docker`
- [OxiCloud](https://atalayalabs.github.io/OxiCloud/) - OxiCloud 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/AtalayaLabs/OxiCloud)) `GPL-3.0` `Docker`
- [PlikShare](https://plikshare.com) - PlikShare 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/damian-krychowski/plikshare)) `GPL-3.0` `Docker`
- [Pluton](https://usepluton.com) - 数据备份和恢复工具。 ([源代码](https://github.com/plutonhq/pluton)) `GPL-3.0` `Docker`
- [Profilarr](https://dictionarry.dev) - Profilarr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Dictionarry-Hub/profilarr)) `GPL-3.0` `Docker`
- [QuickDrop](https://github.com/RoastSlav/quickdrop) - QuickDrop 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Transfer.zip](https://transfer.zip) - Transfer.zip 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/robinkarlberg/transfer.zip-web)) `GPL-3.0` `Docker`
...
- [VersityGW](https://www.versity.com/products/versitygw/) - VersityGW 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/versity/versitygw)) `GPL-3.0` `Docker`
...
- [DumbDrop](https://github.com/DumbWareio/DumbDrop) - DumbDrop 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [NZBGet](https://nzbget.com) - NZBGet 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nzbgetcom/nzbget)) `GPL-3.0` `Docker`
...
- [Rackula](https://racku.la) - Rackula 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/RackulaLives/Rackula)) `GPL-3.0` `Docker`
...
- [torrra](https://torrra.readthedocs.io) - torrra 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/stabldev/torrra)) `GPL-3.0` `Docker`
...
- [Atuin](https://atuin.sh) - Atuin 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/atuinsh/atuin)) `GPL-3.0` `Docker`
...
- [Overr-Syncerr](https://github.com/gssariev/overr-syncerr) - Overr-Syncerr 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [Autocaliweb](https://codeberg.org/gelbphoenix/autocaliweb) - Autocaliweb 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/gelbphoenix/autocaliweb)) `GPL-3.0` `Docker`
...
- [Frigate-Notify](https://frigate-notify.0x2142.com/) - Frigate-Notify 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/0x2142/frigate-notify)) `Apache-2.0` `Docker`
...
- [Ontime](https://www.getontime.no) - Ontime 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/cpvalente/ontime)) `GPL-3.0` `Docker`
...
- [BroadcastChannel](https://memo.miantiao.me) - BroadcastChannel 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/miantiao-me/BroadcastChannel)) `GPL-3.0` `Docker`
...
- [Emoncms](https://emoncms.org) - Emoncms 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/emoncms/emoncms)) `GPL-3.0` `Docker`
...
- [Hollo](https://docs.hollo.social/) - Hollo 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/fedify-dev/hollo)) `GPL-3.0` `Docker`
...
- [Live Blog](https://www.sourcefabric.org/software/liveblog) - Live Blog 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/liveblog/liveblog)) `GPL-3.0` `Docker`
- [Logchef](https://logchef.app/) - 网站统计和数据分析平台。 ([源代码](https://github.com/mr-karan/logchef)) `GPL-3.0` `Docker`
- [Logdy](https://logdy.dev) - Logdy 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/logdyhq/logdy-core)) `Apache-2.0` `Docker`
...
- [Mbin](https://joinmbin.org) - Mbin 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/MbinOrg/mbin)) `GPL-3.0` `Docker`
- [Openchangelog](https://openchangelog.com) - Openchangelog 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/JonasHiltl/openchangelog)) `GPL-3.0` `Docker`
- [Panora](https://panora.dev) - Panora 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/panoratech/Panora)) `Apache-2.0` `Docker`
...
- [Tootik](https://github.com/dimkr/tootik) - Tootik 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Agregarr](https://github.com/agregarr/agregarr) - Agregarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Aurral](https://aurral.org) - Aurral 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/lklynet/aurral)) `GPL-3.0` `Docker`
...
- [Cinephage](https://github.com/MoldyTaint/Cinephage) - Cinephage 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Cleanuparr](https://github.com/Cleanuparr/Cleanuparr) - Cleanuparr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [CouchTube](https://couchtube.fly.dev/) - CouchTube 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/ozencb/couchtube)) `GPL-3.0` `Docker`
- [CyTube](https://github.com/calzoneman/sync) - 同步媒体、聊天等，支持任意数量的频道。 ([演示](https://cytu.be)) `MIT` `Node.js`
- [DeepSubX](https://github.com/garanda21/deepsubx) - DeepSubX 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Dim](https://github.com/Dusk-Labs/dim) - Dim 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) - Dispatcharr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [DVinyl](https://kyonew.me/dvinyl) - DVinyl 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Kyonew/DVinyl)) `GPL-3.0` `Docker`
- [Fireshare](https://fireshare.net) - 游戏服务器托管和管理平台。 ([源代码](https://github.com/ShaneIsrael/fireshare)) `GPL-3.0` `Docker`
- [Fladder](https://donutware.github.io/Fladder/) - Fladder 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/DonutWare/Fladder)) `GPL-3.0` `Docker`
- [Flox](https://simounet.github.io/flox/) - Flox 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Simounet/flox)) `GPL-3.0` `Docker`
- [Frames](https://github.com/eleven-am/frames) - Frames 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Guardian](https://github.com/HydroshieldMKII/Guardian) - Guardian 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [HomeTube](https://github.com/EgalitarianMonkey/hometube) - HomeTube 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Jellyfin Rewind](https://jellyfin-rewind.chaphasilor.xyz) - Jellyfin Rewind 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Chaphasilor/jellyfin-rewind)) `GPL-3.0` `Docker`
- [Jellyplist](https://github.com/kamilkosek/jellyplist) - Jellyplist 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
...
- [Jellysweep](https://github.com/jon4hz/jellysweep) - Jellysweep 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [LANCommander](https://lancommander.app) - 游戏服务器托管和管理平台。 ([源代码](https://github.com/LANCommander/LANCommander)) `GPL-3.0` `Docker`
- [Loops](https://joinloops.org) - Loops 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/joinloops/loops-server)) `GPL-3.0` `Docker`
- [m3u-editor](https://github.com/m3ue/m3u-editor) - m3u-editor 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Materialious](https://materialio.us) - Materialious 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Materialious/Materialious)) `GPL-3.0` `Docker`
...
- [Mydia](https://github.com/getmydia/mydia) - Mydia 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [nodecast-tv](https://github.com/technomancer702/nodecast-tv) - nodecast-tv 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Nzb DAV](https://github.com/nzbdav-dev/nzbdav) - Nzb DAV 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Omoide](https://github.com/EinAeffchen/Omoide) - AI 驱动的智能应用和智能体平台。 电子书和阅读管理平台。 `GPL-3.0` `Docker`
- [OpenCut](https://opencut.app) - OpenCut 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/OpenCut-app/OpenCut)) `GPL-3.0` `Docker`
- [OpenTogetherTube](https://opentogethertube.com) - OpenTogetherTube 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dyc3/opentogethertube)) `GPL-3.0` `Docker`
...
- [PASTA](https://www.pastatool.com) - PASTA 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/cglatot/pasta)) `GPL-3.0` `Docker`
...
- [Petio](https://petio.tv) - Petio 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/petio-team/petio)) `MIT` `Docker`
- [Piped](https://piped.video) - 注重隐私的 YouTube 前端，无广告和数据追踪。 ([源代码](https://github.com/TeamPiped/Piped)) `GPL-3.0` `Docker`
- [Pixelfin](https://github.com/nothing2obvi/pixelfin) - Pixelfin 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Plex Rewind](https://github.com/RaunoT/plex-rewind) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
- [Posteria](https://posteria.app) - Posteria 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/jeremehancock/Posteria)) `GPL-3.0` `Docker`
- [RadaRec](https://github.com/TheWicklowWolf/RadaRec) - RadaRec 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Riven](https://riven.tv) - Riven 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/rivenmedia/riven)) `GPL-3.0` `Docker`
- [Seanime](https://seanime.app) - Seanime 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/5rahim/seanime)) `GPL-3.0` `Docker`
- [SeerrBridge](https://soluify.com) - SeerrBridge 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Woahai321/SeerrBridge)) `Apache-2.0` `Docker`
...
- [Subatic](https://subatic.com) - Subatic 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/orthdron/subatic)) `GPL-3.0` `Docker`
- [SuggestArr](https://giuseppe99barchetta.github.io/SuggestArr/) - SuggestArr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/giuseppe99barchetta/SuggestArr)) `GPL-3.0` `Docker`
- [SyncTube](https://github.com/RblSb/SyncTube) - 轻量级且非常简单设置的 CyTube 替代方案，用于与朋友一起观看视频和聊天。 `MIT` `Node.js/Haxe`
- [Tracearr](https://www.tracearr.com) - Tracearr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/connorgallopo/Tracearr)) `GPL-3.0` `Docker`
...
- [Tunarr](https://tunarr.com/) - Tunarr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/chrisbenincasa/tunarr)) `GPL-3.0` `Docker`
- [TVHeadend](https://tvheadend.org) - TVHeadend 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/tvheadend/tvheadend)) `GPL-3.0` `Docker`
- [Unpackerr](https://unpackerr.zip) - Unpackerr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Unpackerr/unpackerr)) `GPL-3.0` `Docker`
...
- [ViniPlay](https://github.com/ardoviniandrea/ViniPlay) - ViniPlay 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [WatchState](https://github.com/arabcoders/watchstate) - WatchState 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Youlag](https://github.com/civilblur/youlag) - RSS 订阅和新闻阅读器。 `GPL-3.0` `Docker`
- [YT-DLP Web Player](https://github.com/Matszwe02/ytdlp_web_player) - YT-DLP Web Player 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Beatbump](https://beatbump.io/) - Beatbump 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/snuffyDev/Beatbump)) `Apache-2.0` `Docker`
...
- [DroppedNeedle](https://musicseerr.com/) - DroppedNeedle 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/DroppedNeedle/DroppedNeedle)) `GPL-3.0` `Docker`
- [Explo](https://github.com/LumePart/Explo) - Explo 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Fast Music Remover](https://github.com/omeryusufyagci/fast-music-remover) - Fast Music Remover 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Koito](https://koito.io) - Koito 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/gabehf/Koito)) `GPL-3.0` `Docker`
...
- [Metadata Remote](https://github.com/wow-signal-dev/metadata-remote) - Metadata Remote 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [MinusPod](https://github.com/ttlequals0/MinusPod) - MinusPod 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [moOde Audio](https://moodeaudio.org/) - 高保真音乐播放，适用于出色的 Raspberry Pi 单板计算机系列。 ([源代码](https://github.com/moode-player/moode)) `GPL-3.0` `PHP`
- [Moodist](https://github.com/remvze/moodist) - Moodist 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [NextBeats](https://nextbeats.vercel.app) - NextBeats 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/btahir/next-beats)) `Apache-2.0` `Docker`
...
- [Soulbeet](https://github.com/terry90/soulbeet) - Soulbeet 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [SoulSync](https://ssync.net/) - SoulSync 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Nezreka/SoulSync)) `GPL-3.0` `Docker`
...
- [SUB/WAVE](https://www.getsubwave.com) - SUB/WAVE 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/perminder-klair/subwave)) `GPL-3.0` `Docker`
...
- [yubal](https://github.com/guillevc/yubal) - yubal 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Yuvomi](https://yuvomi.cloud/) - Yuvomi 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/ulsklyc/yuvomi)) `GPL-3.0` `Docker`
- [ZipCaptions](https://zipcaptions.app) - ZipCaptions 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/jptrsn/zip-captions)) `GPL-3.0` `Docker`
...
- [Lowcoder](https://www.lowcoder.cloud/) - Lowcoder 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/lowcoder-org/lowcoder)) `Apache-2.0` `Docker`
- [Mercurial](https://www.mercurial-scm.org/) - 分布式源码控制管理工具。 ([源代码](https://repo.mercurial-scm.org/hg/file/tip)) `GPL-2.0` `Python/C/Rust`
- [Mergeable](https://www.usemergeable.dev) - Mergeable 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/pvcnt/mergeable)) `MIT` `Docker`
- [Mini QR](https://github.com/lyqht/mini-qr) - Mini QR 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [RunsOn](https://runs-on.com) - RunsOn 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/runs-on/runs-on)) `GPL-3.0` `Docker`
- [Rustpad](https://rustpad.io) - Rustpad 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/ekzhang/rustpad)) `MIT` `Docker`
- [Screenlite](https://screenlite.org) - Screenlite 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/screenlite/screenlite)) `Apache-2.0` `Docker`
...
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) - Tdarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Xibo](https://xibosignage.com) - Xibo 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/xibosignage/xibo)) `GPL-3.0` `Docker`
- [YAMLResume](https://yamlresume.dev) - YAMLResume 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/yamlresume/yamlresume)) `GPL-3.0` `Docker`
...
- [diyHue](https://diyhue.org/) - diyHue 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/diyhue/diyHue)) `GPL-3.0` `Docker`
...
- [Meshping](https://github.com/Svedrin/meshping) - Meshping 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [TypeType](https://typetype.video) - TypeType 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/TypeType-Video/TypeType)) `GPL-3.0` `Docker`
...
- [BirdNET-Analyzer](https://birdnet-team.github.io/BirdNET-Analyzer/) - BirdNET-Analyzer 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/birdnet-team/BirdNET-Analyzer)) `GPL-3.0` `Docker`
...
- [Koffan](https://github.com/PanSalut/Koffan) - Koffan 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [CoreControl](https://github.com/crocofied/CoreObs) - CoreControl 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Coroot](https://coroot.com) - 基于 eBPF 的零插桩可观测性平台。集成指标、日志、链路追踪和 AI 根因分析。 ([源代码](https://github.com/coroot/coroot)) `Apache-2.0` `Go/Docker`
- [CrossWatch](https://wiki.crosswatch.app) - CrossWatch 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/cenodude/CrossWatch)) `GPL-3.0` `Docker`
- [CrowdSec Manager](https://crowdsec-manager.hhf.technology/) - CrowdSec Manager 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/hhftechnology/crowdsec_manager)) `GPL-3.0` `Docker`
...
- [Dashwise](https://dashwise-next.vercel.app/) - Dashwise 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/andreasmolnardev/dashwise)) `GPL-3.0` `Docker`
...
- [ExcaliDash](https://github.com/ZimengXiong/ExcaliDash) - ExcaliDash 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Iso](https://iso.tim.cv) - Iso 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Coyenn/iso)) `Apache-2.0` `Docker`
- [Karakeep HomeDash](https://github.com/CodeJawn/karakeep-homedash) - Karakeep HomeDash 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Lab Dash](https://github.com/AnthonyGress/lab-dash) - Lab Dash 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Open DroneLog](https://www.opendronelog.com) - Open DroneLog 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/arpanghosh8453/open-dronelog)) `GPL-3.0` `Docker`
...
- [PortChecker](https://portchecker.io) - PortChecker 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dsgnr/portchecker.io)) `GPL-3.0` `Docker`
...
- [Self-Hosted Metrics](https://self-hosted-metrics.com) - Self-Hosted Metrics 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/kOlapsis/shm)) `GPL-3.0` `Docker`
- [selfh.st/icons](https://selfh.st/icons) - selfh.st/icons 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/selfhst/icons)) `GPL-3.0` `Docker`
...
- [Statping-ng](https://statping-ng.github.io) - Statping-ng 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/statping-ng/statping-ng)) `MIT` `Docker`
...
- [Traefik Log Dashboard](https://github.com/hhftechnology/traefik-log-dashboard) - Traefik Log Dashboard 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [TraLa](https://www.trala.fyi/) - TraLa 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dannybouwers/trala)) `GPL-3.0` `Docker`
...
- [WGDashboard](https://github.com/WGDashboard/WGDashboard) - WGDashboard 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Foldergram](https://foldergram.github.io) - Foldergram 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/foldergram/foldergram)) `GPL-3.0` `Docker`
...
- [Imagor Studio](https://imagor.net) - Imagor Studio 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/cshum/imagor-studio)) `GPL-3.0` `Docker`
- [Immich-Frame](https://github.com/immichFrame/ImmichFrame) - Immich-Frame 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Immich Kiosk](https://github.com/damongolding/immich-kiosk) - 轻量级幻灯片放映工具，可在自助终端设备和浏览器上运行，并使用 Immich 作为数据源。 `GPL-3.0` `Docker/Go`
- [Immich Power Tools](https://immich-power-tools.featureos.app/) - Immich Power Tools 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/immich-power-tools/immich-power-tools)) `GPL-3.0` `Docker`
...
- [Kriti Images](https://kritiimages.com) - Kriti Images 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/kritihq/kriti-images)) `Apache-2.0` `Docker`
...
- [Mazanoke](https://MAZANOKE.com) - Mazanoke 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/civilblur/mazanoke)) `GPL-3.0` `Docker`
...
- [ShotShare](https://github.com/mdshack/shotshare) - ShotShare 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
- [sigal](https://github.com/saimn/sigal) - 又一个简单的静态图库生成器。 `MIT` `Python`
- [SnapOtter](https://snapotter.com) - SnapOtter 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/snapotter-hq/SnapOtter)) `GPL-3.0` `Docker`
...
- [ProperDocs](https://properdocs.org/) - ProperDocs 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/ProperDocs/properdocs)) `GPL-3.0` `Docker`
...
- [Mindwtr](https://mindwtr.app) - Mindwtr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dongdongbh/Mindwtr)) `GPL-3.0` `Docker`
...
- [DumbWhoIs](https://dumbwhois.dumbware.io/) - DumbWhoIs 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/DumbWareio/DumbWhoIs)) `GPL-3.0` `Docker`
...
- [AutoKitteh](https://autokitteh.com) - AutoKitteh 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/autokitteh/autokitteh)) `GPL-3.0` `Docker`
...
- [Boxarr](https://github.com/iongpt/boxarr) - Boxarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Decypharr](https://github.com/sirrobot01/decypharr) - Decypharr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Dynacat](https://dynacat.artur.zone/) - Dynacat 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Panonim/dynacat)) `GPL-3.0` `Docker`
...
- [Figranium](https://figranium.dev) - Figranium 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/figranium/figranium)) `GPL-3.0` `Docker`
- [Flow-Like](https://flow-like.com) - Flow-Like 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Rheosoph/flow-like)) `GPL-3.0` `Docker`
...
- [GrowChief](https://growchief.com) - GrowChief 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/growchief/growchief)) `Apache-2.0` `Docker`
- [Habitat](https://gethabitat.org) - Habitat 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/carlnewton/habitat)) `GPL-3.0` `Docker`
...
- [Invio](https://invio.dev) - Invio 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/kittendevv/Invio)) `GPL-3.0` `Docker`
- [Invoicerr](https://docs.invoicerr.app/) - Invoicerr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/invoicerr-app/invoicerr)) `GPL-3.0` `Docker`
...
- [Nixopus](https://nixopus.com) - Nixopus 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/nixopus/nixopus)) `GPL-3.0` `Docker`
...
- [Rachoon](https://github.com/ad-on-is/rachoon) - Rachoon 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Rake](https://ruby.github.io/rake/) - 类似于 Make 的构建自动化工具，用 Ruby 编写并可扩展。 ([源代码](https://github.com/ruby/rake)) `MIT` `Ruby`
- [Rangarr](https://github.com/JudoChinX/rangarr) - Rangarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Rundeck](https://http://rundeck.org) - 跨多服务器的作业调度和自动化运维平台。 ([源代码](https://github.com/rundeck/rundeck)) `GPL-3.0` `Docker`
- [Scraparr](https://github.com/thecfu/scraparr) - Scraparr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [seelf](https://yuukanoo.github.io/seelf/) - seelf 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/YuukanOO/seelf)) `MIT` `Docker`
- [Shared Moments](https://github.com/tech-kev/SharedMoments) - Shared Moments 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Sonobarr](https://github.com/Dodelidoo-Labs/sonobarr) - Sonobarr 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [StencilBox](https://jamesread.github.io/StencilBox/) - StencilBox 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/jamesread/StencilBox)) `GPL-3.0` `Docker`
...
- [Vito](https://vitodeploy.com) - Vito 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/vitodeploy/vito)) `GPL-3.0` `Docker`
...
- [wol](https://github.com/Trugamr/wol) - wol 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Honey](https://demos-honey.djank.me/) - Honey 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dani3l0/honey)) `GPL-3.0` `Docker`
...
- [Invoice Builder](https://github.com/piratuks/invoice-builder) - Invoice Builder 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Subscription Manager](https://github.com/dh1011/subscription-manager) - Subscription Manager 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
- [Subtrackr](https://subtrackr.xyz/) - Subtrackr 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/bscott/subtrackr)) `GPL-3.0` `Docker`
...
- [Private Captcha](https://privatecaptcha.com) - Private Captcha 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/PrivateCaptcha/PrivateCaptcha)) `GPL-3.0` `Docker`
...
- [Crontab Guru](https://github.com/cronitorio/cronitor-cli) - Crontab Guru 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [GiftManager](https://github.com/icbestCA/giftmanager) - GiftManager 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Stormkit](https://app.stormkit.io) - Stormkit 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/stormkit-io/app-stormkit-io)) `Apache-2.0` `Docker`
...
- [Nexterm](https://nexterm.dev) - Nexterm 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/gnmyt/Nexterm)) `GPL-3.0` `Docker`
...
- [XPipe](https://xpipe.io) - XPipe 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/xpipe-io/xpipe)) `GPL-3.0` `Docker`
...
- [Dribdat](https://dribdat.cc) - Dribdat 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dribdat/dribdat)) `GPL-3.0` `Docker`
...
- [Ktistec](https://github.com/toddsundsted/ktistec) - Ktistec 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [pad.ws](https://github.com/coderamp-labs/pad.ws) - pad.ws 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Priviblur](https://github.com/syeopite/priviblur) - Priviblur 是一个自托管的 Web 应用和服务平台。 `Apache-2.0` `Docker`
- [qpixel](https://codidact.com/) - 基于问答的社区知识共享软件。 ([源代码](https://github.com/codidact/qpixel)) `AGPL-3.0` `Ruby`
- [Quetre](https://quetre.iket.me) - Quetre 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/zyachel/quetre)) `Apache-2.0` `Docker`
...
- [Storyden](https://www.storyden.org/) - Storyden 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/Southclaws/storyden)) `GPL-3.0` `Docker`
...
- [Touitomamout](https://github.com/louisgrasset/touitomamout) - Touitomamout 是一个自托管的 Web 应用和服务平台。 `MIT` `Docker`
...
- [Spacepad](https://spacepad.io) - Spacepad 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/magweter/spacepad)) `GPL-3.0` `Docker`
...
- [Nametag](https://github.com/mattogodoy/nametag) - Nametag 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
...
- [Relaticle](https://relaticle.com) - Relaticle 是一个自托管的 Web 应用和服务平台。 ([源代码](https://github.com/relaticle/relaticle)) `GPL-3.0` `Docker`
...
- [Moocup](https://github.com/jellydeck/moocup) - Moocup 是一个自托管的 Web 应用和服务平台。 `GPL-3.0` `Docker`
