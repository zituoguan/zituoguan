...
- [Roundup](https://www.roundup-tracker.org/) - 网站统计和数据分析平台。 ([源代码](https://github.com/roundup-tracker/roundup)) `GPL-3.0` `Docker`
...
- [Calorific](https://github.com/xdpirate/calorific) - 网站统计和数据分析平台。 `Apache-2.0` `Docker`
- [Clean Slate](https://cleanslate.sh) - 网站统计和数据分析平台。 ([源代码](https://github.com/successible/cleanslate)) `GPL-3.0` `Docker`
...
- [DollarDollar Bill Y'all](https://github.com/harung1993/dollardollar) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
...
- [HabitTrove](https://demo.habittrove.com/) - 网站统计和数据分析平台。 ([源代码](https://github.com/dohsimpson/HabitTrove)) `GPL-3.0` `Docker`
...
- [Rotki](https://rotki.com) - 网站统计和数据分析平台。 ([源代码](https://github.com/rotki/rotki)) `GPL-3.0` `Docker`
...
- [SerpBear](https://docs.serpbear.com/) - 网站统计和数据分析平台。 ([源代码](https://github.com/towfiqi/serpbear)) `GPL-3.0` `Docker`
...
- [TradeTally](https://tradetally.io) - 网站统计和数据分析平台。 ([源代码](https://github.com/GeneBO98/tradetally)) `GPL-3.0` `Docker`
...
- [Investbrain](https://investbra.in) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/investbrainapp/investbrain)) `GPL-3.0` `Docker`
...
- [Obico](https://obico.io) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/TheSpaghettiDetective/obico-server)) `GPL-3.0` `Docker`
...
- [Edit Mind](https://github.com/IliasHad/edit-mind) - AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
...
- [Shelfmark](https://github.com/calibrain/shelfmark) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
...
- [Nextcloud Mail](https://apps.nextcloud.com/apps/mail) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/nextcloud/mail)) `GPL-3.0` `Docker`
- [Nextcloud Notes](https://apps.nextcloud.com/apps/notes) - 知识管理和文档协作平台。 ([源代码](https://github.com/nextcloud/notes)) `GPL-3.0` `Docker`
...
- [BiblioReads](https://biblioreads.eu.org) - 电子书和阅读管理平台。 ([源代码](https://github.com/nesaku/BiblioReads)) `GPL-3.0` `Docker`
- [BookHaven](https://github.com/HrBingR/BookHaven) - RSS 订阅和新闻阅读器。 电子书和阅读管理平台。 `Apache-2.0` `Docker`
- [BookHeaven](https://bookheaven.ggarrido.dev/) - 电子书和阅读管理平台。 ([源代码](https://github.com/BookHeaven/BookHeaven.Server)) `GPL-3.0` `Docker`
- [BookLogr](https://github.com/Mozzo1000/booklogr) - 轻松管理您的个人图书馆。 ([演示](https://demo.booklogr.app/)) `Apache-2.0` `Docker`
- [BookOrbit](https://bookorbit.app) - 电子书和阅读管理平台。 ([源代码](https://github.com/bookorbit/bookorbit)) `GPL-3.0` `Docker`
...
- [Comic Library Utilities](https://clucomics.org) - 电子书和阅读管理平台。 ([源代码](https://github.com/allaboutduncan/clu-comics)) `GPL-3.0` `Docker`
...
- [IronCalc](https://www.ironcalc.com) - 电子书和阅读管理平台。 ([源代码](https://github.com/ironcalc/IronCalc)) `GPL-3.0` `Docker`
...
- [LinguaCafe](https://simjanos-dev.github.io/LinguaCafeHome/) - 电子书和阅读管理平台。 ([源代码](https://github.com/simjanos-dev/LinguaCafe)) `MIT` `Docker`
- [lurker](https://github.com/oppiliappan/lurker) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
- [Lute](https://github.com/LuteOrg/lute-v3) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
...
- [Obskurnee](https://github.com/zblesk/obskurnee) - 电子书和阅读管理平台。 `Apache-2.0` `Docker`
...
- [pyShelf](https://github.com/th3r00t/pyShelf) - 电子书和阅读管理平台。 `Apache-2.0` `Docker`
- [Storybook](https://storybook.js.org) - 电子书和阅读管理平台。 ([源代码](https://github.com/storybookjs/storybook)) `GPL-3.0` `Docker`
...
- [Fail2Ban-Report](https://github.com/SubleXBle/Fail2Ban-Report) - AI 驱动的智能应用和智能体平台。 `Apache-2.0` `Docker`
...
- [Logchef](https://logchef.app/) - 网站统计和数据分析平台。 ([源代码](https://github.com/mr-karan/logchef)) `GPL-3.0` `Docker`
...
- [Parseable](https://parseable.com) - 网站统计和数据分析平台。 ([源代码](https://github.com/parseablehq/parseable)) `GPL-3.0` `Docker`
...
- [Jellystat](https://github.com/CyferShepard/Jellystat) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
- [Jellyswarrm](https://github.com/LLukas22/Jellyswarrm) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
...
- [Medialytics](https://github.com/Drewpeifer/medialytics) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
- [MediaLyze](https://www.medialyze.app) - 电子书和阅读管理平台。 ([源代码](https://github.com/frederikemmer/MediaLyze)) `GPL-3.0` `Docker`
- [MediaManager](https://github.com/maxdorninger/MediaManager) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
...
- [Plex Rewind](https://github.com/RaunoT/plex-rewind) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
...
- [Streamystats](https://github.com/fredrikburmester/streamystats) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
...
- [Trackly](https://github.com/7eventy7/trackly) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
- [Trailarr](https://nandyalu.github.io/trailarr/) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/nandyalu/trailarr)) `GPL-3.0` `Docker`
...
- [AudioBookRequest](https://github.com/markbeep/AudioBookRequest/wiki/) - 电子书和阅读管理平台。 ([源代码](https://github.com/markbeep/AudioBookRequest)) `GPL-3.0` `Docker`
...
- [Listenarr](https://getlistenarr.com) - 电子书和阅读管理平台。 ([源代码](https://github.com/Listenarrs/Listenarr)) `GPL-3.0` `Docker`
...
- [ReadMeABook](https://github.com/kikootwo/ReadMeABook) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
- [Scriberr](https://scriberr.app) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/rishikanthc/Scriberr)) `GPL-3.0` `Docker`
...
- [Grimmory](https://grimmory.org) - 电子书和阅读管理平台。 ([源代码](https://github.com/grimmory-tools/grimmory)) `GPL-3.0` `Docker`
...
- [HA Time Machine](https://github.com/saihgupr/HomeAssistantTimeMachine) - AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
...
- [Amurex](https://api.amurex.ai) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/thepersonalaicompany/amurex-backend)) `MIT` `Docker`
...
- [Atlas CMMS](https://atlas-cmms.com) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/Grashjs/cmms)) `GPL-3.0` `Docker`
...
- [Liquor Locker](https://github.com/nguyenjessev/liquor-locker) - AI 驱动的智能应用和智能体平台。 `Apache-2.0` `Docker`
...
- [MedAssist](https://github.com/njic/medassist) - AI 驱动的智能应用和智能体平台。 `MIT` `Docker`
...
- [OmniPoly](https://github.com/kWeglinski/OmniPoly) - AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
...
- [Surmai](https://surmai.app/) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/rohitkumbhar/surmai)) `GPL-3.0` `Docker`
- [Unraid Guardian](https://github.com/stephondoestech/unraid-config-guardian) - AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Vane](https://github.com/ItzCrazyKns/Vane) - AI 驱动的搜索引擎（Perplexity AI 替代品）。 `MIT` `Docker`
- [WhoRang](https://github.com/Beast12/who-rang) - AI 驱动的智能应用和智能体平台。 `MIT` `Docker`
- [Willow](https://heywillow.io/) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/HeyWillow/willow)) `GPL-3.0` `Docker`
...
- [Mantium](https://github.com/diogovalentte/mantium) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
...
- [Perfice](https://perfice.adoe.dev) - 网站统计和数据分析平台。 ([源代码](https://github.com/p0lloc/perfice)) `GPL-3.0` `Docker`
...
- [PoeticMetric](https://poeticmetric.com) - 网站统计和数据分析平台。 ([源代码](https://github.com/th0th/poeticmetric)) `GPL-3.0` `Docker`
...
- [withoutbg](https://github.com/withoutbg/withoutbg-inference) - AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
...
- [Ackify](https://ackify.eu) - 电子书和阅读管理平台。 ([源代码](https://github.com/kOlapsis/ackify)) `GPL-3.0` `Docker`
...
- [Alexandrie](https://alexandrie-hub.fr) - 知识管理和文档协作平台。 ([源代码](https://github.com/Smaug6739/Alexandrie)) `GPL-3.0` `Docker`
- [Anchor](https://github.com/ZhFahim/anchor) - 知识管理和文档协作平台。 `GPL-3.0` `Docker`
...
- [Docusaurus](https://docusaurus.io) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/facebook/docusaurus)) `GPL-3.0` `Docker`
- [DumbPad](https://github.com/DumbWareio/DumbPad) - 知识管理和文档协作平台。 `Apache-2.0` `Docker`
- [EteSync](https://www.etesync.com) - 知识管理和文档协作平台。 日历和日程管理服务。 ([源代码](https://github.com/etesync/server)) `MIT` `Docker`
- [eziwiki](https://github.com/i3months/eziwiki) - 知识管理和文档协作平台。 `Apache-2.0` `Docker`
- [Glass Keep](https://github.com/nikunjsingh93/react-glass-keep) - 知识管理和文档协作平台。 `Apache-2.0` `Docker`
- [Haptic](https://haptic.md) - 知识管理和文档协作平台。 ([源代码](https://github.com/chroxify/haptic)) `Apache-2.0` `Docker`
...
- [Nanote](https://github.com/omarmir/nanote) - 知识管理和文档协作平台。 `GPL-3.0` `Docker`
- [NoteDiscovery](https://www.notediscovery.com) - 知识管理和文档协作平台。 ([源代码](https://github.com/gamosoft/NoteDiscovery)) `GPL-3.0` `Docker`
- [Owlistic](https://owlistic-notes.github.io/owlistic/) - 知识管理和文档协作平台。 ([源代码](https://github.com/owlistic-notes/owlistic)) `MIT` `Docker`
...
- [Poznote](https://poznote.com) - 知识管理和文档协作平台。 ([源代码](https://github.com/timothepoznanski/poznote)) `GPL-3.0` `Docker`
- [Project N.O.M.A.D.](https://github.com/Crosstalk-Solutions/project-nomad) - 知识管理和文档协作平台。 `GPL-3.0` `Docker`
- [ProperDocs](https://properdocs.org/) - Drop-in replacement for MkDocs ([源代码](https://github.com/ProperDocs/properdocs)) `GPL-3.0` `Docker`
- [Silicon Notes](https://github.com/cu/silicon) - 知识管理和文档协作平台。 `GPL-3.0` `Docker`
...
- [Speakr](https://github.com/murtaza-nasir/speakr) - 知识管理和文档协作平台。 `GPL-3.0` `Docker`
- [Sticky](https://www.sticky.today) - 知识管理和文档协作平台。 ([源代码](https://github.com/hamzasaleem2/sticky)) `GPL-3.0` `Docker`
...
- [Zen Notes](https://www.sheshbabu.com/zen/) - 知识管理和文档协作平台。 ([源代码](https://github.com/sheshbabu/zen)) `GPL-3.0` `Docker`
- [ZenNotes](https://zennotes.org) - 知识管理和文档协作平台。 ([源代码](https://github.com/ZenNotes/zennotes)) `GPL-3.0` `Docker`
...
- [HabitSync](https://github.com/jofoerster/habitsync) - 网站统计和数据分析平台。 `GPL-3.0` `Docker`
...
- [Sortarr](https://github.com/Jaredharper1/Sortarr) - 电子书和阅读管理平台。 `GPL-3.0` `Docker`
...
- [BBYEN](https://github.com/MarcelRobitaille/bbyen) - AI 驱动的智能应用和智能体平台。 `MIT` `Docker`
- [Bulwark](https://bulwarkmail.org) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/bulwarkmail/webmail)) `GPL-3.0` `Docker`
...
- [Gmail Cleaner](https://gururagavendra.github.io/gmail-cleaner/) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/Gururagavendra/gmail-cleaner)) `GPL-3.0` `Docker`
- [Hyvor Relay](https://relay.hyvor.com) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/hyvor/relay)) `GPL-3.0` `Docker`
...
- [MailFlow](https://mailflow.sh) - AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/maathimself/mailflow)) `GPL-3.0` `Docker`
...
- [Nortix Mail](https://github.com/Zhoros/NortixMail) - AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
