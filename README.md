...
- [软件](#软件)
  ...
  - [文档管理 - 机构知识库和数字图书馆](#文档管理---机构知识库和数字图书馆)
  - [文档管理 - 电子书](#文档管理---电子书)
  - [日历和联系人](#日历和联系人)
  - [日志管理](#日志管理)
  - [时间服务器](#时间服务器)
...
- [NanoClaw](https://nanoclaw.dev) - 轻量级个人 AI 聊天助手。 ([源代码](https://github.com/nanocoai/nanoclaw)) `GPL-3.0` `Docker`
...
- [Agent Skills](https://github.com/addyosmani/agent-skills) - 生产级工程技能包，为 AI 编码智能体提供代码审查、测试、部署等专业能力。 `MIT` `JavaScript/Docker`
...
- [CLI-Anything](https://clianything.cc) - 让所有命令行工具成为 AI 智能体可调用的能力，打通 AI 与终端工具链。 ([源代码](https://github.com/HKUDS/CLI-Anything)) `Apache-2.0` `Python/Docker`
...
- [Grok Build](https://x.ai/cli) - xAI 推出的编码智能体终端界面。全屏、鼠标交互、可扩展的 AI 编程助手。 ([源代码](https://github.com/xai-org/grok-build)) `Apache-2.0` `Rust/Docker`
...
- [LoopKit](https://github.com/Archive228/loopkit) - 33 个经过实战检验的 AI 技能集合，搭配极简 Claude 框架，兼容 Claude Code、Cursor、Codex 等编码智能体。 `MIT` `Docker`
...
- [OpenSpec](https://openspec.dev) - 面向 AI 编码助手的规范驱动开发（SDD）标准，通过结构化规范指导 AI 生成更准确的代码。 ([源代码](https://github.com/Fission-AI/openspec)) `MIT` `TypeScript/Docker`
...
- [Skills](https://github.com/mattpocock/skills) - 面向真实工程师的 AI 编码技能集合，可直接加载到 Claude Code 等编码智能体中使用。 `MIT` `Docker`
- [Superpowers](https://github.com/obra/superpowers) - AI 智能体技能框架与软件开发方法论，提供结构化构建和使用编码智能体的完整体系。 `MIT` `Docker`
...
- [AgentMemory](https://agent-memory.dev) - 为 AI 编码智能体提供持久化记忆，解决长任务上下文丢失问题，支持多会话知识积累。 ([源代码](https://github.com/rohitg00/agentmemory)) `Apache-2.0` `TypeScript/Docker`
...
- [Enbizcard](https://github.com/vishnuraghavb/EnBizCard) - AI 智能体的记忆存储和检索平台。 `MIT` `Docker`
...
- [Unsloth Studio](https://unsloth.ai/docs) - 在本地训练和微调开源大语言模型的统一界面。 ([源代码](https://github.com/unslothai/unsloth)) `GPL-3.0` `Docker`
...
- [AdGuardHome Sync](https://github.com/bakito/adguardhome-sync) - DNS 域名解析和管理服务。 `GPL-3.0` `Docker`
...
- [ddclient](https://ddclient.net) - DNS 管理和域名解析工具。 ([源代码](https://github.com/ddclient/ddclient)) `GPL-3.0` `Docker`
- [DDNS Updater](https://github.com/qdm12/ddns-updater) - 自动更新 DNS 记录以指向动态 IP 的工具。 `GPL-3.0` `Docker`
- [GoAway](https://pommee.github.io/goaway/) - AI 驱动的智能应用和智能体平台。 DNS 管理和域名解析工具。 ([源代码](https://github.com/pommee/goaway)) `GPL-3.0` `Docker`
...
- [Homebox](https://github.com/hay-kot/homebox) - IT 资产和库存管理平台。 `MIT` `Docker`
...
- [OpenUEM](https://openuem.eu) - IT 资产和库存管理平台。 ([源代码](https://github.com/open-uem/openuem-console)) `GPL-3.0` `Docker`
- [OPSI](https://www.opsi.org) - Linux 和 Windows 的硬件/软件清单、客户端管理、部署和补丁。 ([源代码](https://github.com/opsi-org/)) `GPL-3.0/AGPL-3.0` `OVF/Python`
- [Rackpad](https://rackpad.net) - IT 资产和库存管理平台。 ([源代码](https://github.com/Kobii-git/rackpad)) `GPL-3.0` `Docker`
...
- [Stock Scanner](https://github.com/DR-lin-eng/stock-scanner) - IT 资产和库存管理平台。 `MIT` `Docker`
...
- [Dokploy](https://dokploy.com) - 开源 PaaS 平台（Vercel/Heroku 替代品）。支持多服务器部署、Docker Compose、数据库管理和实时监控。 ([源代码](https://github.com/Dokploy/dokploy)) `Apache-2.0` `TypeScript/Docker`
...
- [Parse Server](https://parseplatform.org) - 开源 BaaS 平台（Firebase 替代品）。提供 REST/GraphQL API、推送通知、文件存储和社交登录。 ([源代码](https://github.com/parse-community/parse-server)) `BSD-3-Clause` `Node.js/Docker`
...
- [Astuto](https://github.com/astuto/astuto) - RSS 订阅和新闻阅读器。 数据库管理和查询工具。 `Apache-2.0` `Docker`
- [Bookheaven.reader](https://github.com/BookHeaven/BookHeaven.Reader) - BookHeaven Reader is an ebook reader app developed for Android e-ink readers (although it can work on any Android device) with the ability to 连接 to a BookHeaven 服务器 instance to 下载 ebooks, fonts and 同步 reading progress. `MIT` `HTML`
- [Bubo Reader](https://github.com/georgemandis/bubo-rss) - 非常极简的 RSS 阅读器。 ([演示](https://bubo-rss-demo.netlify.app/)) `MIT` `Node.js`
- [Comics Reader](https://github.com/onigoetz/Comics-Reader) - Read your comic book scans on tablet !。 `MIT` `JavaScript`
...
- [Extensions](https://github.com/FreshRSS/Extensions) - Extensions 是一个自托管的  应用。 `MIT` `Docker`
- [Feedbin](https://feedbin.com) - RSS 订阅和新闻阅读器。 数据库管理和查询工具。 电子书和阅读管理平台。 ([源代码](https://github.com/feedbin/feedbin)) `GPL-3.0` `Docker`
- [FeedCord](https://github.com/Qolors/FeedCord) `⚠` - 简单、轻量且可自定义的 Discord 服务器 RSS 新闻订阅工具。 `MIT` `Docker`
- [Feedcraft](https://github.com/Colin-XKL/FeedCraft) - Feedcraft 是一个自托管的  应用。 `MIT` `Docker`
- [Feedlynx](https://github.com/wezm/feedlynx) - RSS 订阅和新闻阅读器。 `Apache-2.0` `Docker`
- [Feedme](https://github.com/Seanium/FeedMe) - Feedme 是一个自托管的  应用。 `MIT` `Docker`
...
- [html2rss](https://html2rss.github.io/web-application/) - RSS 订阅和新闻阅读器。 ([源代码](https://github.com/html2rss/html2rss-web)) `GPL-3.0` `Docker`
...
- [Kill-the-Newsletter](https://kill-the-newsletter.com) - RSS 订阅和新闻阅读器。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/leafac/kill-the-newsletter)) `GPL-3.0` `Docker`
- [Koodo Reader](https://github.com/troyeguo/koodo-reader) - Koodo Reader 是一个自托管的  应用。 `MIT` `Docker`
- [Koreader](https://github.com/koreader/koreader) - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats, running on Cervantes, Kindle, Kobo, PocketBook and Android devices。 `MIT` `Lua`
...
- [LetterFeed](https://github.com/LeonMusCoden/LetterFeed) - RSS 订阅和新闻阅读器。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Librum Server](https://github.com/Librum-Reader/Librum-Server) - The Librum 服务器。 `MIT` `C#`
- [Miniflux](https://miniflux.app/) - 极简新闻阅读器。 ([源代码](https://github.com/miniflux/v2)) `Apache-2.0` `Go/deb/Docker`
- [Mrrss](https://github.com/WCY-dt/MrRSS) - Mrrss 是一个自托管的  应用。 `MIT` `Docker`
- [NewsBlur](https://www.newsblur.com/) - 个人新闻阅读器，将人们聚集在一起讨论世界。一种古老乐器的新声音。 ([源代码](https://github.com/samuelclay/NewsBlur)) `MIT` `Python`
- [Newsnow](https://github.com/ourongxing/newsnow) - Newsnow 是一个自托管的  应用。 `MIT` `Docker`
- [Newspipe](https://git.sr.ht/~cedric/newspipe) - 网页新闻阅读器。 ([演示](https://www.newspipe.org/signup)) `AGPL-3.0` `Python`
- [Nextcloud News](https://apps.nextcloud.com/apps/news) - RSS 订阅和新闻阅读器。 电子书和阅读管理平台。 ([源代码](https://github.com/nextcloud/news)) `GPL-3.0` `Docker`
...
- [Refeed](https://github.com/michaelkremenetsky/Refeed) - RSS 订阅和新闻阅读器。 电子书和阅读管理平台。 `MIT` `Docker`
- [RSS-Bridge](https://github.com/RSS-Bridge/rss-bridge) - 为没有提供 RSS/ATOM 订阅的网站生成相应的订阅源。 `Unlicense` `PHP/Docker`
- [Rss Funnel](https://github.com/shouya/rss-funnel) - Rss Funnel 是一个自托管的  应用。 `MIT` `Docker`
...
- [Rss](https://github.com/ssddanbrown/rss) - Rss 是一个自托管的  应用。 `MIT` `Docker`
- [RSS2EMail](https://github.com/rss2email/rss2email) - 获取 RSS/Atom 源并将新内容推送到任意邮箱，支持 OPML。 `GPL-2.0` `Python/deb`
- [RSSBox](https://rssbox.app) - RSS 订阅和新闻阅读器。 ([源代码](https://github.com/versun/RSSBox)) `GPL-3.0` `Docker`
...
- [Rsspub](https://github.com/harshit181/RSSPub) - Rsspub 是一个自托管的  应用。 `MIT` `Docker`
- [Selfoss](https://selfoss.aditu.de/) - 新型多用途 RSS 阅读器、实时流、混搭、聚合 Web 应用程序。 ([源代码](https://github.com/fossar/selfoss)) `GPL-3.0` `PHP`
- [Send2ereader](https://github.com/daniel-j/send2ereader) - Send2ereader 是一个自托管的  应用。 `MIT` `Docker`
- [Sprout Track](https://www.sprout-track.com) - RSS 订阅和新闻阅读器。 ([源代码](https://github.com/Oak-and-Sprout/sprout-track)) `GPL-3.0` `Docker`
...
- [Ttrss](https://github.com/framasoft/ttrss) - Ttrss 是一个自托管的  应用。 `MIT` `Docker`
...
- [Wewe Rss](https://github.com/cooderl/wewe-rss) - Wewe Rss 是一个自托管的  应用。 `MIT` `Docker`
- [Yarr](https://github.com/nkanaev/yarr) - Yarr（yet another rss reader）是一个基于Web的Feed聚合器，可以用作桌面应用程序和个人自托管服务器。 `MIT` `Go`
- [Zenfeed](https://github.com/glidea/zenfeed) - Zenfeed 是一个自托管的  应用。 `MIT` `Docker`
...
- [Awesome](https://github.com/YOURLS/awesome) - 网址缩短和链接管理服务。 `MIT` `Docker`
...
- [Dub](https://dub.co) - 开源链接管理平台，支持短链接创建和分析。 ([源代码](https://github.com/dubinc/dub)) `GPL-3.0` `Docker`
- [Fli.so](https://Fli.so) - 网址缩短服务。 ([源代码](https://github.com/thisuxhq/fli.so)) `MIT` `Docker`
...
- [Marreta](https://marreta.link) - 网址缩短和链接管理服务。 ([源代码](https://github.com/manualdousuario/marreta)) `GPL-3.0` `Docker`
...
- [Redirecterr](https://github.com/varthe/Redirecterr) - 网址缩短和链接管理服务。 `Apache-2.0` `Docker`
...
- [Sink](https://Sink.Cool) - 简洁高效的网址缩短服务。 ([源代码](https://github.com/miantiao-me/Sink)) `GPL-3.0` `Docker`
- [SuperBin](https://github.com/Zhoros/SuperBin) - 网址缩短服务。 代码片段和文本分享工具。 `GPL-3.0` `Docker`
...
- [Dashboard Icons](https://github.com/walkxhub/dashboard-icons) - 自托管仪表板。 `MIT` `Docker`
- [Dasherr](https://github.com/erohtar/Dasherr) - A minimal and 轻量级 仪表板 for your 自托管 services (and bookmarks)。 `MIT` `JavaScript/Docker`
- [Dashlet](https://github.com/jaberio/dashlet) - 轻量级 仪表板 for small apps。 `MIT` `JavaScript/Docker`
- [DashLit](https://dashlit.cwec.dev/) - DashLit is 自托管 startpage for your 服务器. ([源代码](https://github.com/codewec/dashlit)) `MIT` `TypeScript`
- [Dashly](https://github.com/lklynet/dashly) - Dashly is a 可自定义, 实时 仪表板 for Nginx 代理 管理器 用户。 `MIT` `JavaScript/Docker`
- [Dashmachine](https://github.com/rmountjoy92/DashMachine) - 应用仪表板和起始页。 `MIT` `Docker`
...
- [Fenrus](https://github.com/revenz/Fenrus) - Fenrus 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Flame](https://github.com/pawelmalak/flame) - 自托管的起始页仪表板。可轻松管理应用链接、书签和服务器状态概览。 `MIT` `TypeScript/Docker`
...
- [Homarr iFrames](https://github.com/diogovalentte/homarr-iframes) - 现代化自托管仪表板。 `GPL-3.0` `Docker`
...
- [Homepage](https://gethomepage.dev) - 高度可定制的应用仪表板起始页，支持 Docker 和服务 API 自动集成。 ([源代码](https://github.com/gethomepage/homepage)) `GPL-3.0` `Node.js/Docker`
...
- [Laravel Admin Sortable](https://github.com/xiaoxuan6/laravel-admin-sortable) - 个人起始页和服务仪表板。 `MIT` `Docker`
...
- [Organizr](https://github.com/causefx/Organizr) - 自托管服务的统一仪表板，可集中管理和访问所有服务。 `GPL-3.0` `Docker`
...
- [Anylink](https://github.com/bjdgyc/anylink) - 书签收藏和链接管理工具。 `MIT` `Docker`
...
- [Faridoon](https://jamesread.github.io/Faridoon/) - 即时通讯和社交平台。 ([源代码](https://github.com/jamesread/Faridoon)) `GPL-3.0` `Docker`
- [Faved](https://faved.to/) - 精心设计的书签管理器，结合强大的标签、即时搜索和简洁无干扰的界面，专为大型收藏和高效工作流优化。 ([演示](https://demo.faved.to/), [源代码](https://github.com/denho/faved)) `MIT` `Docker`
...
- [GitSave](https://github.com/TimWitzdam/GitSave) - 日历和日程管理服务。 `Apache-2.0` `Docker`
- [Grimoire](https://github.com/goniszewski/grimoire) - 书签收藏和链接管理工具。 电子书和阅读管理平台。 `MIT` `Docker`
- [It's MyTabs](https://github.com/louislam/its-mytabs) - 书签收藏和链接管理工具。 `GPL-3.0` `Docker`
- [Jelu](https://bayang.github.io/jelu-web) - 已读和待读书单追踪器。 ([源代码](https://github.com/bayang/jelu)) `MIT` `Java/Docker`
- [Journiv](https://www.journiv.com) - 书签收藏和链接管理工具。 ([源代码](https://github.com/journiv/journiv-app)) `GPL-3.0` `Docker`
...
- [Kisslists](https://github.com/vincent/kisslists) - 书签收藏和链接管理工具。 `MIT` `Docker`
...
- [Pinkary](https://pinkary.com) - 书签收藏和链接管理工具。 ([源代码](https://github.com/pinkary-project/pinkary.com)) `GPL-3.0` `Docker`
- [Pinry](https://pinry.github.io/pinry/) - 图片和链接的收藏与分享板。 ([源代码](https://github.com/pinry/pinry)) `MIT` `Docker`
- [Postmarks](https://postmarks.glitch.me) - 书签收藏和链接管理工具。 电子书和阅读管理平台。 ([源代码](https://github.com/ckolderup/postmarks)) `GPL-3.0` `Docker`
...
- [RSS Librarian](https://www.rsslibrarian.ch/librarian.php) - RSS 订阅和新闻阅读器。 电子书和阅读管理平台。 ([源代码](https://github.com/thefranke/rss-librarian)) `GPL-3.0` `Docker`
...
- [Ties](https://github.com/raffomania/ties) - 书签收藏和链接管理工具。 电子书和阅读管理平台。 `GPL-3.0` `Docker`
...
- [Bililive Go](https://github.com/hr3lxphr6j/bililive-go) - 人力资源和员工管理平台。 `MIT` `Docker`
...
- [Orangehrm](https://github.com/jmlcas/orangehrm) - 人力资源和员工管理平台。 `MIT` `Docker`
...
- [13ft Ladder](https://13ft-ladder.vercel.app/) - HTTP 反向代理和流量管理工具。 ([源代码](https://github.com/wasi-master/13ft)) `GPL-3.0` `Docker`
- [Anonymous Overflow](https://aohub.httpjames.space) - HTTP 反向代理和流量管理工具。 ([源代码](https://github.com/httpjamesm/AnonymousOverflow)) `GPL-3.0` `Docker`
...
- [CaddyManager](https://github.com/caddymanager/caddymanager) - 自动 HTTPS 的现代化 Web 服务器。 `Apache-2.0` `Docker`
- [Cloudflared](https://github.com/cloudflare/cloudflared) - Cloudflare Tunnel 客户端，用于建立安全隧道。 `GPL-3.0` `Docker`
- [Docker Socket Proxy](https://github.com/Tecnativa/docker-socket-proxy) - HTTP 反向代理和流量管理工具。 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [FlareSolverr](https://github.com/FlareSolverr/FlareSolverr) - 用于绕过 Cloudflare 保护的代理服务器。 `GPL-3.0` `Docker`
...
- [Immich Public Proxy](https://github.com/alangrainger/immich-public-proxy) - HTTP 反向代理和流量管理工具。 `GPL-3.0` `Docker`
- [iodine](https://code.kryo.se/iodine/) - 基于DNS的IPv4隧道解决方案，使您能够启动一个socks5代理监听器。 ([源代码](https://github.com/yarrick/iodine)) `ISC` `C/deb`
- [KrakenD](https://www.krakend.io) - HTTP 反向代理和流量管理工具。 ([源代码](https://github.com/krakend/krakend-ce)) `GPL-3.0` `Docker`
- [Mantrae](https://mantrae.pages.dev) - HTTP 反向代理和流量管理工具。 ([源代码](https://github.com/MizuchiLabs/mantrae)) `GPL-3.0` `Docker`
- [Middleware Manager](https://github.com/hhftechnology/middleware-manager) - HTTP 反向代理和流量管理工具。 `GPL-3.0` `Docker`
- [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) - Docker 容器的自动化反向代理，自动生成 Nginx 配置。 `GPL-3.0` `Docker`
- [Nginx UI](https://nginxui.com) - 基于 Web 的 Nginx 管理界面，支持配置和监控。 ([源代码](https://github.com/0xJacky/nginx-ui)) `GPL-3.0` `Docker`
- [Nginxwebui](https://github.com/cym1102/nginxWebUI) - HTTP 反向代理和流量管理工具。 `MIT` `Docker`
- [NPMplus](https://github.com/ZoeyVid/NPMplus) - HTTP 反向代理和流量管理工具。 `GPL-3.0` `Docker`
- [NPS Enhanced](https://d-jy.net/docs/nps/) - HTTP 反向代理和流量管理工具。 ([源代码](https://github.com/djylb/nps)) `GPL-3.0` `Docker`
- [OAuth2 Proxy](https://oauth2-proxy.github.io/oauth2-proxy) - 为 HTTP 请求提供 OAuth 2.0 认证的反向代理。 ([源代码](https://github.com/oauth2-proxy/oauth2-proxy)) `GPL-3.0` `Docker`
...
- [Remnawave](https://docs.rw) - 基于 Xray-core 的强大代理管理面板，注重简洁易用。提供用户管理、流量统计和订阅链接生成等功能。 ([源代码](https://github.com/remnawave/panel)) `AGPL-3.0` `TypeScript/Docker`
- [Requestly](https://requestly.com/) - HTTP 请求拦截和修改工具，用于调试和测试。 ([源代码](https://github.com/requestly/requestly)) `GPL-3.0` `Docker`
- [Self-Hosted Gateway](https://gethomerun.app) - HTTP 反向代理和流量管理工具。 VPN 和网络安全连接工具。 容器化部署和管理工具。 ([源代码](https://github.com/hintjen/selfhosted-gateway)) `MIT` `Docker`
...
- [Traefik Manager](https://traefik-manager.xyzlab.dev/) - 现代化反向代理和负载均衡器。 ([源代码](https://github.com/chr0nzz/traefik-manager)) `GPL-3.0` `Docker`
- [Z-Wave JS UI](https://zwave-js.github.io/zwave-js-ui) - HTTP 反向代理和流量管理工具。 物联网设备和智能家居管理平台。 ([源代码](https://github.com/zwave-js/zwave-js-ui)) `GPL-3.0` `Docker`
...
- [Hasty Paste](https://github.com/enchant97/hasty-paste) - 代码片段和文本分享工具。 `MIT` `Docker`
...
- [MicroBin](https://microbin.eu) - 轻量级 Pastebin 和文件分享服务。 ([源代码](https://github.com/szabodanika/microbin)) `GPL-3.0` `Docker`
...
- [Snipo](https://github.com/MohamedElashri/snipo) - 轻量级的代码片段管理器，支持文件夹、标签、API 和 GitHub Gist 同步，用于保存和组织代码与文本片段。 ([演示](https://snipo.melashri.dev/)) `AGPL-3.0` `Go/Docker`
...
- [Actionview](https://github.com/lxerxa/actionview) - An issue tracking 工具 based on laravel+reactjs for small and medium-sized enterprises, 开源 and free, similar to Jira. `MIT` `PHP`
...
- [Dopplertask](https://github.com/dopplertask/dopplertask) - Dopplertask 是一个自托管的  应用。 `MIT` `Docker`
- [DumbAssets](https://dumbassets.dumbware.io) - DumbAssets 是一个自托管的  应用。 ([源代码](https://github.com/DumbWareio/DumbAssets)) `Apache-2.0` `Docker`
- [DumbDo](https://github.com/DumbWareio/DumbDo) - DumbDo 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [DumbKan](https://github.com/DumbWareio/DumbKan) - DumbKan 是一个自托管的  应用。 `MIT` `Docker`
...
- [Jpress](https://github.com/JPressProjects/jpress) - JPress，一个使用 Java 开发的建站神器，目前已经有 10w+ 网站使用 JPress 进行驱动，其中包括多个政府机构，200+上市公司，中科院、红+字会等。 `MIT` `JavaScript`
- [Jw Community](https://github.com/jogetworkflow/jw-community) - Joget is an 开源 no-code/low-code application platform that combines the best of rapid application development, 商业 process 自动化 and 工作流 管理. This Joget 开源 repository is licensed under GPLv3. For commercial licensing, please visit www.joget.org. `MIT` `JavaScript`
- [Kan](https://kan.bn) - 基于看板的项目管理工具。 ([源代码](https://github.com/kanbn/kan)) `GPL-3.0` `Docker`
- [Kanba](https://kanba.co) - Kanba is an 开源 项目管理 工具 for 现代化 团队. ([源代码](https://github.com/Kanba-co/kanba)) `GPL-3.0` `TypeScript`
...
- [NutriTrace](https://github.com/TraceApps/nutritrace) - NutriTrace 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Operately](https://operately.com) - Operately 是一个自托管的  应用。 ([源代码](https://github.com/operately/operately)) `GPL-3.0` `Docker`
...
- [Project Management](https://github.com/devaslanphp/project-management) - Project Management 是一个自托管的  应用。 `MIT` `Docker`
- [qBit Manage](https://github.com/StuffAnThings/qbit_manage) - qBit Manage 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Reor](https://github.com/reorproject/reor) - Reor 是一个自托管的  应用。 `MIT` `Docker`
- [Roundup](https://www.roundup-tracker.org/) - Roundup 是一个自托管的  应用。 ([源代码](https://github.com/roundup-tracker/roundup)) `GPL-3.0` `Docker`
- [SpendSpentSpent](https://lamarios.github.io/SpendSpentSpent/) - SpendSpentSpent 是一个自托管的  应用。 ([源代码](https://github.com/lamarios/SpendSpentSpent)) `GPL-3.0` `Docker`
...
- [Taskcafe](https://github.com/JordanKnott/taskcafe) - Taskcafe 是一个自托管的  应用。 `MIT` `Docker`
- [Taskrr](https://github.com/unmaykr-a/taskrr) - Taskrr 是一个自托管的  应用。 `MIT` `Docker`
- [Tasks.md](https://github.com/BaldissaraMatheus/Tasks.md) - 支持 Markdown 语法的自托管文件型任务管理板。 `MIT` `Docker`
- [TaskTrove](https://tasktrove.io) - TaskTrove 是一个自托管的  应用。 ([源代码](https://github.com/dohsimpson/TaskTrove)) `Apache-2.0` `Docker`
- [TaskView](https://taskview.tech/) - TaskView 是一个自托管的  应用。 ([源代码](https://github.com/Gimanh/taskview-community)) `GPL-3.0` `Docker`
...
- [Teemii](https://github.com/dokkaner/teemii) - Teemii 是一个自托管的  应用。 `MIT` `Docker`
- [Tenzu](https://http://tenzu.net) - Tenzu 是一个自托管的  应用。 ([源代码](https://github.com/BIRU-Scop/tenzu-back)) `GPL-3.0` `Docker`
- [Thrifty](https://buymeacoffee.com/tiehfood) - Thrifty 是一个自托管的  应用。 ([源代码](https://github.com/tiehfood/thrifty)) `GPL-3.0` `Docker`
- [Ticky](https://github.com/dkorecko/Ticky) - Ticky 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [TREK](https://github.com/mauriceboe/TREK) - 实时协作旅行规划工具。 `GPL-3.0` `Docker`
- [tududi](https://tududi.com/) - 具备分层结构、智能重复任务和无缝 Telegram 集成的任务管理工具。 ([源代码](https://github.com/chrisvel/tududi)) `MIT` `Docker`
- [Unlocker](https://github.com/paolo-projects/unlocker) - Unlocker 是一个自托管的  应用。 `MIT` `Docker`
...
- [Weektodo](https://github.com/manuelernestog/weektodo) - Weektodo 是一个自托管的  应用。 `MIT` `Docker`
...
- [Xteve](https://github.com/xteve-project/xTeVe) - Xteve 是一个自托管的  应用。 `MIT` `Docker`
...
_相关: [财务与预算管理](#财务与预算管理), [库存管理](#库存管理)_

- [Atlas CMMS](https://atlas-cmms.com) - 企业计算机化维护管理系统（CMMS），支持工单管理、设备跟踪和预防性维护。 ([源代码](https://github.com/Grashjs/cmms)) `GPL-3.0` `TypeScript/Docker`
- [Aureus](https://aureuserp.com) - 综合性企业资源规划（ERP）系统。 ([源代码](https://github.com/aureuserp/aureuserp)) `GPL-3.0` `Docker`
...
- [Etherpad Lite](https://github.com/ether/etherpad-lite) - 企业资源规划和业务管理平台。 `MIT` `Docker`
- [Euterpe Mobile](https://github.com/ironsmile/euterpe-mobile) - 企业资源规划和业务管理平台。 `MIT` `Docker`
...
- [Gomodel](https://github.com/ENTERPILOT/GoModel) - 企业资源规划和业务管理平台。 `MIT` `Docker`
...
- [Qqbot](https://github.com/sliverp/qqbot) - 企业资源规划和业务管理平台。 `MIT` `Docker`
...
- [Squirrel Servers Manager](https://squirrelserversmanager.io/) - 服务器集群管理和监控平台。 ([源代码](https://github.com/SquirrelCorporation/SquirrelServersManager)) `Apache-2.0` `Docker`
...
- [bknd](https://bknd.io) - 健康数据和健身活动追踪工具。 ([源代码](https://github.com/bknd-io/bknd)) `GPL-3.0` `Docker`
- [eddrit](https://eddrit.com) - 健康数据和健身活动追踪工具。 ([源代码](https://github.com/corenting/eddrit)) `GPL-3.0` `Docker`
...
- [Exercise Diary](https://github.com/aceberg/ExerciseDiary) - 健康和健身追踪管理工具。 `MIT` `Docker`
...
- [Flint](https://github.com/0xchasercat/flint) - 健康数据和健身活动追踪工具。 `GPL-3.0` `Docker`
- [Garmin Grafana](https://github.com/arpanghosh8453/garmin-grafana) - Garmin 健康数据的 Grafana 可视化仪表板。 `GPL-3.0` `Docker`
...
- [MediKeep](https://github.com/afairgiant/MediKeep) - 健康和健身追踪管理工具。 `GPL-3.0` `Docker`
...
- [Workout Challenge](https://github.com/vanalmsick/workout_challenge) - 健康和健身追踪管理工具。 `GPL-3.0` `Docker`
- [Workout Tracker](https://github.com/jovandeginste/workout-tracker) - 网站统计和数据分析平台。 健康和健身追踪管理工具。 `GPL-3.0` `Docker`
- [Workout.cool](https://workout.cool) - 健康和健身追踪管理工具。 ([源代码](https://github.com/Snouzy/workout-cool)) `GPL-3.0` `Docker`
...
- [Ascii Generator.site](https://github.com/hermanTenuki/ASCII-Generator.site) - 内容管理和网站建设平台。 `MIT` `Docker`
...
- [Ghostboard](https://github.com/jon6fingrs/ghostboard) - 内容管理和网站建设平台。 `MIT` `Docker`
- [Ghosthub](https://github.com/BleedingXiko/GhostHub) - 内容管理和网站建设平台。 `MIT` `Docker`
- [Grav](https://getgrav.org) - 快速、简单、灵活的基于文件的 Web 内容管理系统。 ([源代码](https://github.com/getgrav/grav)) `GPL-3.0` `Docker`
- [Gravity](https://gravity.beryju.io) - DNS 管理和域名解析工具。 ([源代码](https://github.com/BeryJu/gravity)) `GPL-3.0` `Docker`
- [Hexo Generator Index](https://github.com/hexojs/hexo-generator-index) - 内容管理和网站建设平台。 `MIT` `Docker`
- [Hexo Theme Next](https://github.com/theme-next/hexo-theme-next) - 内容管理和网站建设平台。 `MIT` `Docker`
- [Hexon](https://github.com/gethexon/hexon) - 内容管理和网站建设平台。 `MIT` `Docker`
- [Hugo Theme Meme](https://github.com/reuixiy/hugo-theme-meme) - 内容管理和网站建设平台。 `MIT` `Docker`
...
- [Silex](https://www.silex.me) - 在线网站搭建和发布平台。 ([源代码](https://github.com/silexlabs/Silex)) `GPL-3.0` `Docker`
...
- [Statamic](https://statamic.com) - 内容管理和网站建设平台。 ([源代码](https://github.com/statamic/cms)) `GPL-3.0` `Docker`
...
- [Vanblog](https://github.com/Mereithhh/vanblog) - 内容管理和网站建设平台。 `MIT` `Docker`
...
- [Website Shot](https://github.com/flowko/website-shot) - 内容管理和网站建设平台。 `MIT` `Docker`
- [WinterCMS](https://wintercms.com/) - 基于Laravel PHP框架构建的快速且安全的内容管理系统。 ([源代码](https://github.com/wintercms/winter)) `MIT` `PHP`
- [Winwin Hexo Editor](https://github.com/YuJianghao/winwin-hexo-editor) - 内容管理和网站建设平台。 `MIT` `Docker`
...
- [Ackee](https://ackee.electerious.com) - 注重隐私的网站访问统计分析工具。 ([源代码](https://github.com/electerious/Ackee)) `GPL-3.0` `Docker`
...
- [Calorific](https://github.com/xdpirate/calorific) - Dead 简单 自托管 calorie tracker。 `Apache-2.0` `PHP`
- [Clean Slate](https://cleanslate.sh) - ☀️ Track food without judgment。 ([源代码](https://github.com/successible/cleanslate)) `GPL-3.0` `TypeScript`
- [Community Edition](https://github.com/plausible/community-edition) - 示例 Docker Compose 设置 for hosting Plausible 社区 Edition。 `MIT` `Docker`
...
- [Cube](https://cube.dev) - 开源语义层（Headless BI），为下游工具提供一致的指标定义和 SQL/REST/GraphQL API。 ([源代码](https://github.com/cube-js/cube)) `Apache-2.0` `Rust/TypeScript/Docker`
...
- [DataEase](https://dataease.io) - 开源 BI 分析平台（Tableau 替代品）。支持拖拽式可视化、多数据源连接和大屏展示。 ([源代码](https://github.com/dataease/dataease)) `GPL-3.0` `Java/Docker`
- [DollarDollar Bill Y'all](https://github.com/harung1993/dollardollar) - DollarDollar Bill Y'all 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [HabitTrove](https://demo.habittrove.com/) - HabitTrove 是一个自托管的  应用。 ([源代码](https://github.com/dohsimpson/HabitTrove)) `GPL-3.0` `Docker`
...
- [onWatch](https://onwatch.onllm.dev) - 网站统计和数据分析平台。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/onllm-dev/onWatch)) `GPL-3.0` `Docker`
- [Open Web Analytics](https://http://www.openwebanalytics.com) - 自托管的网站访问统计分析平台。 ([源代码](https://github.com/Open-Web-Analytics/Open-Web-Analytics)) `GPL-3.0` `Docker`
...
- [Rotki](https://rotki.com) - Rotki 是一个自托管的  应用。 ([源代码](https://github.com/rotki/rotki)) `GPL-3.0` `Docker`
...
- [SerpBear](https://docs.serpbear.com/) - SerpBear 是一个自托管的  应用。 ([源代码](https://github.com/towfiqi/serpbear)) `GPL-3.0` `Docker`
...
- [SparkyFitness](https://codewithcj.github.io/SparkyFitness/) - 网站统计和数据分析平台。 健康和健身追踪管理工具。 ([源代码](https://github.com/CodeWithCJ/SparkyFitness)) `GPL-3.0` `Docker`
...
- [TradeTally](https://tradetally.io) - TradeTally 是一个自托管的  应用。 ([源代码](https://github.com/GeneBO98/tradetally)) `GPL-3.0` `Docker`
...
- [HymnoScribe](https://hymnoscribe.de) - 在线办公文档和表格协作工具。 ([源代码](https://github.com/Revisor01/HymnoScribe)) `Apache-2.0` `Docker`
...
- [Skyoffice](https://github.com/kevinshen56714/SkyOffice) - 在线办公文档和表格协作工具。 `MIT` `Docker`
...
- [Excalidraw Cn](https://github.com/korbinzhao/excalidraw-cn) - 图表、流程图和白板绘制工具。 `MIT` `Docker`
...
- [Smart Excalidraw Next](https://github.com/liujuntao123/smart-excalidraw-next) - 图表、流程图和白板绘制工具。 `MIT` `Docker`
- [Tldraw](https://github.com/tldraw/tldraw) - 图表、流程图和白板绘制工具。 `MIT` `Docker`
...
- [Scholarsome](https://http://scholarsome.com) - 在线教育和课程管理平台。 ([源代码](https://github.com/hwgilbert16/scholarsome)) `GPL-3.0` `Docker`
...
- [GeoPulse](https://tess1o.github.io/geopulse/) - 网站统计和数据分析平台。 地图和地理位置服务平台。 ([源代码](https://github.com/tess1o/geopulse)) `GPL-3.0` `Docker`
- [Global Threat Map](https://github.com/unicodeveloper/globalthreatmap) - 地图和地理位置服务平台。 `GPL-3.0` `Docker`
- [GraphHopper](https://graphhopper.com/) - 使用OpenStreetMap的快速路由库和服务器。 ([源代码](https://github.com/graphhopper/graphhopper)) `Apache-2.0` `Java`
- [Mind Map](https://github.com/wanglin2/mind-map) - 地图和地理信息服务平台。 `MIT` `Docker`
...
- [OwnTracks Frontend](https://github.com/owntracks/frontend) - 地图和地理信息服务平台。 `MIT` `Docker`
...
- [Reitti](https://www.dedicatedcode.com/projects/reitti/) - 网站统计和数据分析平台。 地图和地理位置服务平台。 ([源代码](https://github.com/dedicatedcode/reitti)) `GPL-3.0` `Docker`
- [Scratch Map](https://github.com/ad3m3r5/scratch-map) - 网站统计和数据分析平台。 地图和地理位置服务平台。 `MIT` `Docker`
- [Seatable Plugin Map](https://github.com/seatable/seatable-plugin-map) - 地图和地理信息服务平台。 `MIT` `Docker`
- [Swing Client](https://github.com/geoffrey45/swing-client) - 地图和地理信息服务平台。 `MIT` `Docker`
...
- [Backup X](https://github.com/jeessy2/backup-x) - 数据备份和恢复管理工具。 `MIT` `Docker`
- [Backupninja](https://0xacab.org/liberate/backupninja) - 轻量级、可扩展的元备份系统，提供集中方式配置和协调多种备份工具。 `GPL-2.0` `Shell`
- [BackupPC](https://github.com/backuppc/backuppc) - 数据备份和恢复工具。 `GPL-3.0` `Docker`
...
- [Borg Backup Server](https://www.borgbackupserver.com) - 数据备份和恢复工具。 ([源代码](https://github.com/marcpope/borgbackupserver)) `GPL-3.0` `Docker`
- [Borg UI](https://docs.borgui.com) - 数据备份和恢复工具。 ([源代码](https://github.com/karanhudia/borg-ui)) `GPL-3.0` `Docker`
...
- [Civitai Data Manager](https://github.com/jmsltnv/civitai-data-manager) - 数据备份和恢复工具。 AI 驱动的智能应用和智能体平台。 `Apache-2.0` `Docker`
...
- [Docker Volume Backup](https://offen.github.io/docker-volume-backup/) - 数据备份和恢复工具。 容器化部署和管理工具。 ([源代码](https://github.com/offen/docker-volume-backup)) `GPL-3.0` `Docker`
- [Duplicacy](https://duplicacy.com) - 跨平台加密备份工具，支持多种云端存储后端。 ([源代码](https://github.com/gilbertchen/duplicacy)) `MIT` `Docker`
...
- [Elysian](https://github.com/Aadityajoshi151/Elysian) - 数据备份和恢复工具。 书签收藏和链接管理工具。 电子书和阅读管理平台。 `MIT` `Docker`
- [Fog](https://www.fogproject.org/) - 克隆/镜像解决方案与救援套件。 ([源代码](https://github.com/FOGProject/fogproject)) `GPL-3.0` `PHP/Shell`
- [Git-Sync](https://github.com/AkashRajpurohit/git-sync/wiki) - 数据备份和恢复工具。 ([源代码](https://github.com/AkashRajpurohit/git-sync)) `GPL-3.0` `Docker`
- [Harborguard](https://github.com/HarborGuard/HarborGuard) - 数据备份和恢复管理工具。 `MIT` `Docker`
- [Kopia](https://kopia.io) - 跨平台备份工具，支持快照、加密和云端存储。 ([源代码](https://github.com/kopia/kopia)) `GPL-3.0` `Docker`
...
- [Repliqate](https://lminlone.github.io/repliqate/) - 数据备份和恢复工具。 容器化部署和管理工具。 ([源代码](https://github.com/lminlone/repliqate)) `Apache-2.0` `Docker`
...
- [Uncloud](https://uncloud.run) - 服务器备份和管理平台。 ([源代码](https://github.com/psviderski/uncloud)) `GPL-3.0` `Docker`
...
- [Velld](https://velld.vercel.app) - 数据备份和恢复工具。 数据库管理和查询工具。 ([源代码](https://github.com/dendianugerah/velld)) `GPL-3.0` `Docker`
- [Vykar](https://vykar.borgbase.com) - 数据备份和恢复工具。 ([源代码](https://github.com/borgbase/vykar)) `GPL-3.0` `Docker`
...
- [Bazarr](https://www.bazarr.media) - 字幕自动下载和管理工具。 ([源代码](https://github.com/morpheus65535/bazarr)) `GPL-3.0` `Docker`
- [Bgmi](https://github.com/BGmi/BGmi) - 自动追番工具，提供 CLI 和 Web UI 管理订阅的番剧（寻找维护者中）。 `MIT` `Python`
- [ChannelTube](https://github.com/TheWicklowWolf/ChannelTube) `⚠` - 使用 yt-dlp 定期从 YouTube 频道下载视频或音频。 `AGPL-3.0` `Docker`
- [Cobalt](https://cobalt.tools) - 快速便捷的在线媒体下载工具，支持多种平台。 ([源代码](https://github.com/imputnet/cobalt)) `GPL-3.0` `Docker`
- [Configarr](https://configarr.de/) - 同步 TRaSH 指南 + custom configs with Sonarr/Radarr。 ([源代码](https://github.com/raydak-labs/configarr)) `GPL-3.0` `TypeScript`
...
- [ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook) - 将电子书自动转换为有声书的工具。 `GPL-3.0` `Docker`
- [Iptv M3u Maker](https://github.com/EvilCult/iptv-m3u-maker) - IPTV 国内+国外 电视台直播源m3u文件, 收集&汇总&本地源脚本。 `MIT` `HTML`
- [Iptv Sources](https://github.com/HerbertHe/iptv-sources) - Autoupdate iptv sources。 `MIT` `TypeScript/Docker`
- [Iptv Speed Tester](https://github.com/evecus/IPTV-Speed-Tester) - Iptv Speed Tester 是一个自托管的  应用。 `MIT` `Docker`
- [Iptv](https://github.com/rebeliptv/iptv) - Automatic M3U playlist and XML 指南 updater for IPTV clients with interactive web 界面. `MIT` `Go/Docker`
- [Iptvnator](https://github.com/4gray/iptvnator) - 跨平台 IPTV 播放器，支持 m3u/m3u8 播放列表、收藏夹、节目指南和回看功能。 `MIT` `TypeScript`
- [Jackett](https://github.com/Jackett/Jackett) - 为多个 BitTorrent 追踪站提供统一 API 查询接口。 `GPL-3.0` `Docker`
- [Kaloscope](https://kaloscope.org) - 工作流驱动的本地媒体管理器，支持番剧、漫画、小说、电影等多种媒体类型的自动化管理。 ([源代码](https://github.com/kaloscope/kaloscope)) `GPL-3.0` `Python/Docker`
- [Katelyatv](https://github.com/katelya77/KatelyaTV) - 一个基于MoonTV(LunaTV)二次开发的项目。新项目：https://GitHub.com/Decohererk/DecoTV。 `MIT` `TypeScript`
- [Kometa](https://kometa.wiki) - Plex 媒体库的元数据管理和自定义工具。 ([源代码](https://github.com/Kometa-Team/Kometa)) `GPL-3.0` `Docker`
- [Kvideo](https://github.com/KuekHaoYang/KVideo) - 一个基于 Next.js 16 构建的现代化视频聚合播放平台。采用独特的 "Liquid Glass" 设计语言，提供流畅的视觉体验和强大的视频搜索功能。 `MIT` `TypeScript`
- [Libretv](https://github.com/bestZwei/LibreTV) - 不要fork此仓库，去fork上游：。 `MIT` `JavaScript`
...
- [Managarr](https://github.com/Dark-Alex-17/managarr) - Managarr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Media Manager](https://github.com/laravel-admin-extensions/media-manager) - Media Manager 是一个自托管的  应用。 `MIT` `Docker`
- [Mediatracker](https://github.com/bonukai/MediaTracker) - Mediatracker 是一个自托管的  应用。 `MIT` `Docker`
...
- [Migu Video](https://github.com/develop202/migu_video) - Migu Video 是一个自托管的  应用。 `MIT` `Docker`
- [MKVPriority](https://github.com/kennethsible/mkvpriority) - 使用可配置的优先级评分选择首选音频和字幕轨道，并设置相应的默认和强制标志。 `MIT` `Python/Docker`
- [Moontvplus](https://github.com/mtvpls/MoonTVPlus) - Moontvplus 是一个自托管的  应用。 `MIT` `Docker`
...
- [Posterizarr](https://github.com/fscorrupt/posterizarr) - Posterizarr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Prowlarr](https://prowlarr.com) - 索引器管理工具，为 Starr 应用提供统一的索引器管理。 ([源代码](https://github.com/Prowlarr/Prowlarr)) `GPL-3.0` `Docker`
- [Radarr](https://radarr.video/) - 通过 Usenet 和 BitTorrent 自动下载电影（Sonarr 的分支）。 ([源代码](https://github.com/Radarr/Radarr)) `GPL-3.0` `C#/Docker`
- [Readarr](https://readarr.com) - 电子书和有声书自动下载管理器（Sonarr for Ebooks），支持 Usenet 和 BitTorrent。 ([源代码](https://github.com/Readarr/Readarr)) `GPL-3.0` `C#/Docker`
...
- [Recyclarr](https://recyclarr.dev) - Recyclarr 是一个自托管的  应用。 ([源代码](https://github.com/recyclarr/recyclarr)) `GPL-3.0` `Docker`
- [Replex](https://github.com/lostb1t/replex) - HTTP 反向代理和流量管理工具。 `MIT` `Docker`
...
- [SonaShow](https://github.com/TheWicklowWolf/SonaShow) - SonaShow 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Tautulli](https://tautulli.com) - Plex 媒体服务器的监控和统计分析工具。 ([源代码](https://github.com/Tautulli/Tautulli)) `GPL-3.0` `Docker`
- [Tracktor](https://tracktor.bytedge.in) - Tracktor 是一个自托管的  应用。 ([源代码](https://github.com/javedh-dev/tracktor)) `GPL-3.0` `Docker`
...
- [Videotogether](https://github.com/VideoTogether/VideoTogether) - Videotogether 是一个自托管的  应用。 `MIT` `Docker`
...
- [Wizarr](https://wizarr.dev) - 自托管的媒体服务器用户邀请和管理系统，专为 Jellyfin、Plex 和 Emby 设计。 ([源代码](https://github.com/wizarrrr/wizarr)) `MIT` `Python/Docker`
...
- [YoutubeDL-Material](https://github.com/Tzahi12345/YoutubeDL-Material) - 基于 Web 的视频下载管理工具。 `GPL-3.0` `Docker`
...
- [YTPTube](https://github.com/arabcoders/ytptube) - YTPTube 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Atomic CRM](https://http://marmelab.com/atomic-crm/) - 客户关系和销售管理平台。 ([源代码](https://github.com/marmelab/atomic-crm)) `GPL-3.0` `Docker`
...
- [Laudspeaker](https://laudspeaker.com/?ref=github) - 客户关系和销售管理平台。 ([源代码](https://github.com/laudspeaker/laudspeaker)) `GPL-3.0` `Docker`
- [Meerkat CRM](https://fbuchner.github.io/meerkat-crm/) - 客户关系和销售管理平台。 ([源代码](https://github.com/fbuchner/meerkat-crm)) `GPL-3.0` `Docker`
- [Monica](https://monicahq.com/) - 个人关系管理器，一种新型的 CRM，用于组织与您的朋友和家人的互动。 ([源代码](https://github.com/monicahq/monica)) `AGPL-3.0` `PHP/Docker`
- [Ocrmypdf](https://github.com/ocrmypdf/OCRmyPDF) - 客户关系和销售管理平台。 `MIT` `Docker`
...
- [AnyAppStart](https://github.com/aceberg/AnyAppStart) - 容器化部署和管理工具。 `Apache-2.0` `Docker`
- [Atheos Docker](https://github.com/Atheos/Atheos-Docker) - 基于 Web 云 IDE and code editor with minimal footprint and requirements. `MIT` `Docker`
- [Cf Workers Docker.io](https://github.com/cmliu/CF-Workers-docker.io) - 这个项目是一个基于 Cloudflare Workers 的 Docker 镜像代理工具。它能够中转对 Docker 官方镜像仓库的请求，解决一些访问限制和加速访问的问题。 `MIT` `JavaScript/Docker`
- [Container Hub](https://github.com/eznix86/docker-registry-ui) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Containers](https://github.com/bitnami/containers) - Bitnami container images。 `MIT` `Shell/Docker`
- [Cup](https://cup.sergi0g.dev) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/sergi0g/cup)) `GPL-3.0` `Docker`
- [Davical Docker](https://github.com/fintechstudios/davical-docker) - Standalone DAViCal Docker 图片 (based on official PHP 图片)。 `MIT` `PHP/Docker`
- [Dockcheck](https://github.com/mag37/dockcheck) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Docker 1panel](https://github.com/okxlin/docker-1panel) - Docker 1panel 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Chromium](https://github.com/linuxserver/docker-chromium) - Docker Chromium 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Code Server](https://github.com/linuxserver/docker-code-server) - Docker Code Server 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Compose](https://docs.docker.com/compose/) - 定义和运行多容器 Docker 应用。 ([源代码](https://github.com/docker/compose)) `Apache-2.0` `Go`
- [Docker Filezilla](https://github.com/jlesage/docker-filezilla) - Docker Filezilla 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Flare](https://github.com/soulteary/docker-flare) - Docker Flare 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Flarum](https://github.com/mondediefr/docker-flarum) - Docker Flarum 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Handbrake](https://github.com/jlesage/docker-handbrake) - Docker Handbrake 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Hexo](https://github.com/spurin/docker-hexo) - Docker Hexo 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Image Pusher](https://github.com/tech-shrimp/docker_image_pusher) - Docker Image Pusher 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Jitsi Meet](https://github.com/jitsi/docker-jitsi-meet) - Docker Jitsi Meet 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Kspeeder](https://github.com/linkease/docker_kspeeder) - Docker Kspeeder 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Mkvtoolnix](https://github.com/jlesage/docker-mkvtoolnix) - Docker Mkvtoolnix 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Modem](https://github.com/apocas/docker-modem) - Docker Modem 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Port Viewer](https://github.com/hollowpnt92/docker-port-viewer) - Docker Port Viewer 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Registry Browser](https://github.com/klausmeyer/docker-registry-browser) - 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [Docker Rss](https://github.com/thebigbone/docker-rss) - Docker Rss 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Smtp](https://github.com/WeAreGenki/docker-smtp) - Docker Smtp 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Superset](https://github.com/amancevice/docker-superset) - Docker Superset 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Swarm](https://docs.docker.com/engine/swarm/) - 管理 Docker 引擎集群。 ([源代码](https://github.com/moby/swarmkit)) `Apache-2.0` `Go`
- [Docker Switchboard](https://github.com/cfstcyr/docker-switchboard) - Docker Switchboard 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Updater](https://github.com/liquidguru/docker-updater) - Docker Updater 是一个自托管的  应用。 `MIT` `Docker`
- [Docker Wechat](https://github.com/RICwang/docker-wechat) - Docker Wechat 是一个自托管的  应用。 `MIT` `Docker`
- [Docker.ui](https://github.com/gohutool/docker.ui) - Docker.ui 是一个自托管的  应用。 `MIT` `Docker`
- [Docker](https://www.docker.com/) - 为开发者和系统管理员构建、发布和运行分布式应用的平台。 ([源代码](https://www.docker.com/community/open-source/)) `Apache-2.0` `Go`
- [Dockerfile](https://github.com/typecho/Dockerfile) - Dockerfile 是一个自托管的  应用。 `MIT` `Docker`
- [Dockerizalo](https://github.com/undernightcore/dockerizalo) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Dockhand](https://dockhand.pro) - 容器化部署和管理工具。 ([源代码](https://github.com/Finsys/dockhand)) `GPL-3.0` `Docker`
- [Docking Station](https://github.com/LooLzzz/docking-station) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Dockpeek](https://github.com/dockpeek/dockpeek) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `Apache-2.0` `Docker`
- [DockTail](https://docktail.org) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/marvinvr/docktail)) `GPL-3.0` `Docker`
- [Dockwatch](https://dockwatch.wiki) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/Notifiarr/dockwatch)) `GPL-3.0` `Docker`
- [Doku](https://github.com/amerkurev/doku) - 容器化部署和管理工具。 `Apache-2.0` `Docker`
- [DweebUI](https://www.dweebui.com/) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/lllllllillllllillll/DweebUI)) `MIT` `Docker`
...
- [Lazydocker](https://github.com/jesseduffield/lazydocker) - The lazier way to 管理 everything Docker。 `MIT` `Go`
- [Librephotos Docker](https://github.com/LibrePhotos/librephotos-docker) - 自托管照片管理服务，类似 Google Photos。 `MIT` `Docker`
- [LoggiFly](https://clemcer.github.io/LoggiFly/) - 服务器和服务的监控与告警平台。 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/clemcer/LoggiFly)) `GPL-3.0` `Docker`
...
- [Openwrt Docker](https://github.com/SuLingGG/OpenWrt-Docker) - Openwrt Docker 是一个自托管的  应用。 `MIT` `Docker`
- [Oxker](https://github.com/mrjackwills/oxker) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [PatchPanda](https://github.com/dkorecko/PatchPanda) - 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [Pms Docker](https://github.com/plexinc/pms-docker) - Pms Docker 是一个自托管的  应用。 `MIT` `Docker`
...
- [Portall](https://github.com/need4swede/Portall) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `MIT` `Docker`
- [ProxCenter](https://www.proxcenter.io) - ProxCenter 是一个自托管的  应用。 ([源代码](https://github.com/adminsyspro/proxcenter-ui)) `GPL-3.0` `Docker`
- [Quant Ux Docker](https://github.com/bmcgonag/quant-ux-docker) - Quant Ux Docker 是一个自托管的  应用。 `MIT` `Docker`
- [Rclonebrowser Docker](https://github.com/romancin/rclonebrowser-docker) - Rclonebrowser Docker 是一个自托管的  应用。 `MIT` `Docker`
- [Sablier](https://sablierapp.dev/) - 按需启动和停止 Docker 容器的反向代理。 ([源代码](https://github.com/sablierapp/sablier)) `GPL-3.0` `Docker`
...
- [Taiga Docker](https://github.com/taigaio/taiga-docker) - Taiga Docker 是一个自托管的  应用。 `MIT` `Docker`
...
- [Traccar Docker](https://github.com/traccar/traccar-docker) - Traccar Docker 是一个自托管的  应用。 `MIT` `Docker`
- [Tugtainer](https://github.com/Quenary/tugtainer) - 数据备份和恢复工具。 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Vcompose](https://github.com/zbrave/vcompose) - Vcompose 是一个自托管的  应用。 `MIT` `Docker`
- [Vnstat Docker](https://github.com/vergoh/vnstat-docker) - 网络流量监控工具。 `MIT` `Docker`
- [Webtop](https://github.com/linuxserver/docker-webtop) - Webtop 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Yacht](https://github.com/SelfhostedPro/Yacht) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `MIT` `Docker`
...
- [Authman](https://github.com/simular/authman-server) - 身份认证和访问控制解决方案。 `MIT` `Docker`
- [Bitwarden Rs](https://github.com/dani-garcia/bitwarden_rs) - 密码和敏感凭据的安全管理工具。 `MIT` `Docker`
- [Bitwarden](https://bitwarden.com/) `⚠` - 带有网页应用、浏览器扩展和移动应用的密码管理器。 ([源代码](https://github.com/bitwarden/server)) `AGPL-3.0` `Docker/C#`
- [Cap](https://trycap.dev) - 自托管验证码系统，无需第三方服务。 ([源代码](https://github.com/tiagozip/cap)) `GPL-3.0` `Docker`
- [Einvault](https://github.com/davefatkin/EinVault) - 密码和敏感凭据的安全管理工具。 `MIT` `Docker`
- [FlashPaper](https://github.com/AndrewPaglusch/FlashPaper) - 密码和凭据安全管理工具。 `GPL-3.0` `Docker`
- [Kontoj](https://kontoj.galaksio.tech) - 密码和凭据安全管理工具。 ([源代码](https://github.com/galaksiotech/kontoj)) `MIT` `Docker`
- [OpenBao](https://openbao.org/) - 密钥和加密凭据的安全管理平台，Vault 的替代品。 ([源代码](https://github.com/openbao/openbao)) `GPL-3.0` `Docker`
- [OrigamiVault](https://github.com/origamivault/origamivault) - 密码和凭据安全管理工具。 `GPL-3.0` `Docker`
- [Padloc](https://padloc.app) - 现代开源密码管理器，支持团队协作。提供 Web PWA、浏览器扩展、桌面和移动客户端。 ([源代码](https://github.com/padloc/padloc)) `AGPL-3.0` `TypeScript/Docker`
...
- [Pswd](https://github.com/remvze/pswd) - 密码和敏感凭据的安全管理工具。 `MIT` `Docker`
- [PWgen](https://github.com/jocxfin/pwgen) - 密码和凭据安全管理工具。 `MIT` `Docker`
...
- [VaulTLS](https://github.com/7ritn/VaulTLS) - 密码和敏感凭据的安全管理工具。 `GPL-3.0` `Docker`
- [Vaultwarden](https://github.com/dani-garcia/vaultwarden) - 用Rust编写的轻量级Bitwarden服务器API实现。 `GPL-3.0` `Rust/Docker`
- [YeetFile](https://github.com/benbusby/yeetfile) - 密码和敏感凭据的安全管理工具。 `Apache-2.0` `Docker`
...
- [ARA](https://ara.recordsansible.org) - 工单管理和 Helpdesk 客服系统。 ([源代码](https://github.com/ansible-community/ara)) `GPL-3.0` `Docker`
- [Bugzilla](https://www.bugzilla.org/) - 通用缺陷跟踪器和测试工具，最初由Mozilla项目开发和使用。 ([源代码](https://github.com/bugzilla/bugzilla)) `MPL-2.0` `Perl`
- [Cert Warden](https://www.certwarden.com/) - 工单管理和 Helpdesk 客服系统。 ([源代码](https://github.com/gregtwallace/certwarden)) `GPL-3.0` `Docker`
...
- [mkcert Web UI](https://github.com/jeffcaldwellca/mkcertWeb) - 工单管理和 Helpdesk 客服系统。 `GPL-3.0` `Docker`
- [osTicket](https://osticket.com) - 工单管理和 Helpdesk 客服系统。 ([源代码](https://github.com/osTicket/osTicket)) `GPL-3.0` `Docker`
...
- [Peppermint](https://peppermint.sh) - 轻量级工单管理和 Helpdesk 系统。 ([源代码](https://github.com/Peppermint-Lab/peppermint)) `Apache-2.0` `Docker`
- [PlanarAlly](https://www.planarally.io/) - 工单管理和 Helpdesk 客服系统。 ([源代码](https://github.com/Kruptein/PlanarAlly)) `GPL-3.0` `Docker`
...
- [Secrover](https://secrover.org) - 工单管理和 Helpdesk 客服系统。 ([源代码](https://github.com/Secrover/Secrover)) `GPL-3.0` `Docker`
...
_相关: [财务与预算管理](#财务与预算管理), [企业资源规划（ERP）](#企业资源规划（erp）)_
...
- [AniBridge](https://http://anibridge.eliasbenb.dev) - The smart way to keep your anime lists perfectly synchronized。 ([源代码](https://github.com/anibridge/anibridge)) `GPL-3.0` `Python/Docker`
...
- [Forms.md](https://forms.md) - Forms.md 是一个自托管的  应用。 ([源代码](https://github.com/formsmd/formsmd)) `MIT` `Docker`
- [Foundry Virtual Tabletop](https://foundryvtt.com/) - Foundry Virtual Tabletop 是一个自托管的  应用。 ([源代码](https://github.com/foundryvtt/foundryvtt)) `GPL-3.0` `Docker`
...
- [Investbrain](https://investbra.in) - Investbrain 是一个自托管的  应用。 ([源代码](https://github.com/investbrainapp/investbrain)) `GPL-3.0` `Docker`
- [Kitsu](https://kitsu.cg-wire.com) - 协作 Platform for Animation and VFX Productions。 ([源代码](https://github.com/cgwire/kitsu)) `GPL-3.0` `Python`
...
- [Lunar](https://lunarphp.com) - Lunar 是一个自托管的  应用。 ([源代码](https://github.com/lunarphp/lunar)) `GPL-3.0` `Docker`
...
- [Obico](https://obico.io) - Obico 是一个自托管的  应用。 ([源代码](https://github.com/TheSpaghettiDetective/obico-server)) `GPL-3.0` `Docker`
- [Octelium](https://octelium.com/docs) - Octelium 是一个自托管的  应用。 ([源代码](https://github.com/octelium/octelium)) `GPL-3.0` `Docker`
- [Ohmyform](https://github.com/ohmyform/ohmyform) - Ohmyform 是一个自托管的  应用。 `MIT` `Docker`
...
- [Pollinations](https://github.com/pollinations/pollinations) - Pollinations 是一个自托管的  应用。 `MIT` `Docker`
...
- [Sharkord](https://sharkord.com) - Sharkord 是一个自托管的  应用。 ([源代码](https://github.com/Sharkord/sharkord)) `GPL-3.0` `Docker`
- [SurveyJS](https://surveyjs.io/form-library) - SurveyJS 是一个自托管的  应用。 ([源代码](https://github.com/surveyjs/survey-library)) `GPL-3.0` `Docker`
- [Surveyking](https://github.com/javahuang/SurveyKing) - Surveyking 是一个自托管的  应用。 `MIT` `Docker`
- [TasmoAdmin](https://github.com/TasmoAdmin/TasmoAdmin) - TasmoAdmin 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Timeful](https://timeful.app) - Timeful 是一个自托管的  应用。 ([源代码](https://github.com/schej-it/timeful.app)) `GPL-3.0` `Docker`
- [Tymeslot](https://tymeslot.app) - Tymeslot 是一个自托管的  应用。 ([源代码](https://github.com/Tymeslot/tymeslot)) `GPL-3.0` `Docker`
- [Wapy.dev](https://www.wapy.dev) - Wapy.dev 是一个自托管的  应用。 ([源代码](https://github.com/meceware/wapy.dev)) `GPL-3.0` `Docker`
...
- [Airbyte](https://airbyte.com) - 开源数据集成平台（ELT）。支持 300+ 连接器，可编排数据同步到数据仓库和数据湖。 ([源代码](https://github.com/airbytehq/airbyte)) `MIT` `Python/Docker`
- [Arcane](https://getarcane.app) - 应用部署和基础设施管理平台。 ([源代码](https://github.com/getarcaneapp/arcane)) `GPL-3.0` `Docker`
...
- [Komodo](https://komo.do) - 多服务器构建和部署管理平台。 ([源代码](https://github.com/moghtech/komodo)) `GPL-3.0` `Docker`
...
- [1Panel](https://1panel.pro) - 现代化 Linux 服务器管理面板，支持一键部署应用。 ([源代码](https://github.com/1Panel-dev/1Panel)) `GPL-3.0` `Docker`
...
- [Cosmos](https://cosmos-cloud.io) - 自托管平台，集成反向代理、SSL 证书管理、SSO 认证、防火墙和 Docker 管理。 ([源代码](https://github.com/azukaar/Cosmos-Server)) `AGPL-3.0` `JavaScript/Docker`
...
- [OpenPanel](https://openpanel.com) - 服务器管理和运维控制面板。 ([源代码](https://github.com/stefanpejcic/OpenPanel)) `GPL-3.0` `Docker`
...
- [Deep Research](https://github.com/dzhng/deep-research) - 全文搜索引擎和索引管理服务。 `MIT` `Docker`
- [degoog](https://github.com/degoog-org/degoog) - 全文搜索引擎和索引管理服务。 `GPL-3.0` `Docker`
- [Diskover](https://diskoverdata.com) - 全文搜索引擎和索引管理服务。 ([源代码](https://github.com/diskoverdata/diskover-community)) `GPL-3.0` `Docker`
- [Edit Mind](https://github.com/IliasHad/edit-mind) - Edit Mind 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Quickwit](https://quickwit.io) - 云原生日志和追踪搜索引擎，兼容 Elasticsearch API 和 Jaeger/OTEL 协议。 ([源代码](https://github.com/quickwit-oss/quickwit)) `Apache-2.0` `Rust/Docker`
- [Search Plugins](https://github.com/qbittorrent/search-plugins) - 全文搜索引擎和索引管理服务。 `MIT` `Docker`
- [Search4all](https://github.com/fatwang2/search4all) - 全文搜索引擎和索引管理服务。 `MIT` `Docker`
- [Searx](https://github.com/searx/searx) - 全文搜索引擎和索引管理服务。 `MIT` `Docker`
...
- [Shelfmark](https://github.com/calibrain/shelfmark) - Shelfmark 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Whoogle](https://pypi.org/project/whoogle-search/) - 注重隐私的元搜索引擎，无追踪和广告。 ([源代码](https://github.com/benbusby/whoogle-search)) `GPL-3.0` `Docker`
- [Yacy](https://yacy.net/en/index.html) - 基于对等、去中心化的搜索引擎服务器。 ([源代码](https://github.com/yacy/yacy_search_server)) `GPL-2.0` `Java/Docker/K8S`
- [Yuindex](https://github.com/liyupi/yuindex) - 全文搜索引擎和索引管理服务。 `MIT` `Docker`
...
- [App](https://github.com/WebDB-App/app) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
...
- [ClickHouse](https://clickhouse.com) - 开源实时分析型列式数据库管理系统。支持 SQL 查询、高压缩率和 PB 级数据分析。 ([源代码](https://github.com/ClickHouse/ClickHouse)) `Apache-2.0` `C++/Docker`
...
- [Dbackup](https://github.com/Skyfay/DBackup) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [DbGate](https://www.dbgate.io) - 现代化数据库管理工具，支持 SQLite、MySQL、PostgreSQL 等。 ([源代码](https://github.com/dbgate/dbgate)) `GPL-3.0` `Docker`
- [Dbx](https://github.com/t8y2/dbx) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [Drawdb](https://github.com/drawdb-io/drawdb) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [Evidence](https://evidence.dev) - 基于代码的BI工具。使用SQL和Markdown编写报告，并以网站形式呈现。 ([源代码](https://github.com/evidence-dev/evidence)) `MIT` `Node.js`
- [Hoarder App](https://github.com/MohamedBassem/hoarder-app) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [InfluxDB](https://influxdata.com) - 高性能时序数据库，专为指标、事件和实时分析场景设计。 ([源代码](https://github.com/influxdata/influxdb)) `GPL-3.0` `Docker`
...
- [NeoDB](https://neodb.net) - 数据库管理和查询工具。 网站统计和数据分析平台。 ([源代码](https://github.com/neodb-social/neodb)) `GPL-3.0` `Docker`
- [Nimtable](https://github.com/nimtable/nimtable) - 数据库管理和 Web 管理界面。 `Apache-2.0` `Docker`
- [PG Back Web](https://github.com/eduardolat/pgbackweb) - 数据备份和恢复工具。 数据库管理和查询工具。 `Apache-2.0` `Docker`
- [pgAdmin](https://www.pgadmin.org) - 数据库管理和查询工具。 ([源代码](https://github.com/pgadmin-org/pgadmin4)) `GPL-3.0` `Docker`
- [pgweb](https://sosedoff.github.io/pgweb) - 基于 Web 的 PostgreSQL 数据库浏览器和管理界面。 ([源代码](https://github.com/sosedoff/pgweb)) `GPL-3.0` `Docker`
- [phpMyAdmin](https://www.phpmyadmin.net/) - 通过 Web 界面管理 MySQL 和 MariaDB 数据库的经典工具。 ([源代码](https://github.com/phpmyadmin/phpmyadmin)) `GPL-3.0` `Docker`
...
- [Redis Commander](https://http://joeferner.github.io/redis-commander/) - 数据库管理和 Web 管理界面。 ([源代码](https://github.com/joeferner/redis-commander)) `Apache-2.0` `Docker`
- [Redis](https://redis.io) - 开源内存数据结构存储系统，用作数据库、缓存和消息代理，支持多种数据结构。 ([源代码](https://github.com/redis/redis)) `BSD-3-Clause` `Docker`
- [Redisinsight](https://github.com/RedisInsight/RedisInsight) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [Sqlite Web](https://github.com/coleifer/sqlite-web) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [Sqliteviz](https://github.com/lana-k/sqliteviz) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
...
- [Teable](https://teable.ai) - 基于 PostgreSQL 的无代码数据库电子表格。 ([源代码](https://github.com/teableio/teable)) `GPL-3.0` `Docker`
- [Undb](https://github.com/undb-xyz/undb) - 数据库管理和 Web 管理界面。 `MIT` `Docker`
- [Valkey](https://valkey.io) - 开源内存键值数据库，兼容 Redis 协议。 ([源代码](https://github.com/valkey-io/valkey)) `GPL-3.0` `Docker`
- [WhoDB](https://whodb.com) - 支持多种数据库的统一 Web 管理界面。 ([源代码](https://github.com/clidey/whodb)) `GPL-3.0` `Docker`
...
- [Dufs](https://github.com/sigoden/dufs) - 静态文件服务器，支持上传、搜索和访问控制。 `GPL-3.0` `Docker`
...
- [VERT](https://vert.sh) - 基于设备的文件格式转换工具。 ([源代码](https://github.com/VERT-sh/VERT)) `GPL-3.0` `Docker`
...
- [FileBrowser Quantum](https://github.com/gtsteffaniak/filebrowser) - 基于 Web 的文件管理器，支持文件浏览和上传。 `GPL-3.0` `Docker`
...
- [Zerobyte](https://zerobyte.app) - 基于 Web 的文件分享和管理平台。 ([源代码](https://github.com/nicotsx/zerobyte)) `GPL-3.0` `Docker`
...
- [Aipan Netdisk Search](https://github.com/unilei/aipan-netdisk-search) - Aipan.me is free to use. `MIT` `TypeScript`
- [AirPipe](https://airpipe.sanyamgarg.com) - 文件传输和共享工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/Sanyam-G/Airpipe)) `GPL-3.0` `Docker`
- [Alist](https://github.com/Xhofe/alist) - 支持多种存储后端的文件列表程序。 `MIT` `Docker`
- [Aliyundrive Webdav](https://github.com/messense/aliyundrive-webdav) - 阿里云盘 WebDAV 服务。 `MIT` `Rust`
- [Aliyundrivedailycheck](https://github.com/mrabit/aliyundriveDailyCheck) - 阿里云盘每日签到脚本 青龙面板支持。 `MIT` `JavaScript`
- [Aliyunpan](https://github.com/tickstep/aliyunpan) - 阿里云盘命令行客户端，支持JavaScript插件，支持同步备份功能。 `MIT` `Go`
- [All In One](https://github.com/nextcloud/all-in-one) - 📦 The official Nextcloud 安装 method. Provides 简单 部署 and maintenance with most features included in this one Nextcloud instance. `MIT` `PHP/Docker`
- [Cloud Commander](https://cloudcmd.io) - ✨☁️📁✨ 云 Commander 文件 管理器 for the web with console and editor. ([源代码](https://github.com/coderaiser/cloudcmd)) `GPL-3.0` `JavaScript/Docker`
- [Cloud189](https://github.com/Aruelius/cloud189) - 天翼云盘 CLI Python。 `MIT` `Python`
- [Cloud189checkin](https://github.com/hetaoos/Cloud189Checkin) - 天翼云盘自动签到服务。 `MIT` `C#`
- [Cloudsaver](https://github.com/jiangrui1994/CloudSaver) - 一个基于 Vue 3 + Express 的网盘资源搜索与转存工具。 `MIT` `TypeScript`
- [Compose Craft](https://composecraft.com) - 容器化部署和管理工具。 ([源代码](https://github.com/composecraft/composecraft)) `Apache-2.0` `Docker`
- [Convert to it!](https://github.com/p2r3/convert) - Truly universal online 文件 converter。 `GPL-3.0` `TypeScript`
- [Dock-Dploy](https://docker-compose.hhf.technology) - 容器化部署和管理工具。 ([源代码](https://github.com/hhftechnology/Dock-Dploy)) `GPL-3.0` `Docker`
- [Dockman](https://dockman.radn.dev/) - 容器化部署和管理工具。 ([源代码](https://github.com/RA341/dockman)) `GPL-3.0` `Docker`
- [Dpanel](https://github.com/donknap/dpanel) - Dpanel 是一个自托管的  应用。 `MIT` `Docker`
- [Drivebase](https://drivebase.io) - Drivebase 是一个自托管的  应用。 ([源代码](https://github.com/drivebase/drivebase)) `GPL-3.0` `Docker`
- [Erugo](https://erugo.app) - Erugo 是一个自托管的  应用。 ([源代码](https://github.com/ErugoOSS/Erugo)) `GPL-3.0` `Docker`
- [FerriShare](https://github.com/TobiasMarschner/ferrishare) - FerriShare 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [File Wizard](https://github.com/LoredCast/filewizard) - File Wizard 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Filecodebox](https://github.com/vastsa/FileCodeBox) - Filecodebox 是一个自托管的  应用。 `MIT` `Docker`
- [Fileflows](https://github.com/revenz/FileFlows) - Fileflows 是一个自托管的  应用。 `MIT` `Docker`
- [Filegogo](https://github.com/a-wing/filegogo) - Filegogo 是一个自托管的  应用。 `MIT` `Docker`
- [FileSync](https://filesync.app) - FileSync 是一个自托管的  应用。 ([源代码](https://github.com/polius/FileSync)) `GPL-3.0` `Docker`
- [FolderHost](https://folderhost.org) - FolderHost 是一个自托管的  应用。 ([源代码](https://github.com/MertJSX/folderhost)) `GPL-3.0` `Docker`
- [FTPGrab](https://crazymax.dev/ftpgrab/) - FTPGrab 是一个自托管的  应用。 ([源代码](https://github.com/crazy-max/ftpgrab)) `GPL-3.0` `Docker`
- [Garage](https://garagehq.deuxfleurs.fr) - 轻量级分布式对象存储。 ([源代码](https://github.com/deuxfleurs-org/garage)) `GPL-3.0` `Docker`
...
- [GhostFile](https://github.com/jon6fingrs/ghostfile) - GhostFile 是一个自托管的  应用。 `MIT` `Docker`
- [Go Drive](https://github.com/devld/go-drive) - Go Drive 是一个自托管的  应用。 `MIT` `Docker`
- [GoMFT](https://github.com/StarFleetCPTN/GoMFT) - 文件传输和共享工具。 `MIT` `Docker`
- [Harbor](https://goharbor.io/) - 云原生镜像仓库，存储、签名和扫描内容。 ([源代码](https://github.com/goharbor/harbor)) `Apache-2.0` `Docker/K8S`
- [Hoodik](https://github.com/hudikhq/hoodik) - Hoodik 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Kkfileview](https://github.com/kekingcn/kkFileView) - Universal 文件 Online Preview 项目 based on Spring-Boot。 `MIT` `Java`
- [Kodexplorer](https://github.com/kalcaddle/KodExplorer) - 私有云盘和文档管理系统。 `MIT` `Docker`
- [Kodiwebportal](https://github.com/yanncam/KodiWebPortal) - The Web Portal for Kodi to display, 搜索 and 下载 your personal multimedia content. `MIT` `PHP`
- [Lingarr](https://github.com/lingarr-translate/lingarr) - Lingarr is an application that supports both local and SaaS translation services to translate subtitle 文件 into a specified target language. With automated translation 选项, Lingarr simplifies translating subtitles. `GPL-3.0` `C#`
- [Litepan](https://github.com/Ponphil/LitePan) - LitePan - 多网盘聚合与管理工具，支持 WebDAV、STRM、媒体整理。 `MIT` `Python`
- [Lufin](https://github.com/VityaSchel/lufin) - Lufin 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Markopolis](https://markopolis.app) - Markopolis 是一个自托管的  应用。 ([源代码](https://github.com/rishikanthc/markopolis)) `MIT` `Docker`
- [Maxkb](https://github.com/1Panel-dev/MaxKB) - Maxkb 是一个自托管的  应用。 `MIT` `Docker`
- [Minio](https://github.com/minio/minio) - 高性能对象存储服务器。 `MIT` `Docker`
- [myDrive](https://github.com/subnub/myDrive) - 自托管云存储和文件管理平台。 `MIT` `Docker`
- [Nextcloud Deck](https://apps.nextcloud.com/apps/deck) - 自托管私有云存储和协作平台，支持文件同步和共享。 ([源代码](https://github.com/nextcloud/deck)) `GPL-3.0` `Docker`
- [Nextcloud Forms](https://apps.nextcloud.com/apps/forms) - 自托管私有云存储和协作平台，支持文件同步和共享。 ([源代码](https://github.com/nextcloud/forms)) `GPL-3.0` `Docker`
- [Nextcloud Mail](https://apps.nextcloud.com/apps/mail) - Nextcloud Mail 是一个自托管的  应用。 ([源代码](https://github.com/nextcloud/mail)) `GPL-3.0` `Docker`
- [Nextcloud Notes](https://apps.nextcloud.com/apps/notes) - Nextcloud Notes 是一个自托管的  应用。 ([源代码](https://github.com/nextcloud/notes)) `GPL-3.0` `Docker`
- [Nextcloud Office](https://nextcloud.com/collaboraonline) - 自托管私有云存储和协作平台，支持文件同步和共享。 ([源代码](https://github.com/nextcloud/richdocuments)) `GPL-3.0` `Docker`
- [Nextcloud Social](https://apps.nextcloud.com/apps/social) - VPN 和网络安全连接工具。 ([源代码](https://github.com/nextcloud/social)) `GPL-3.0` `Docker`
- [Nextcloud Tables](https://apps.nextcloud.com/apps/tables) - 自托管私有云存储和协作平台，支持文件同步和共享。 ([源代码](https://github.com/nextcloud/tables)) `GPL-3.0` `Docker`
- [Nextcloud Talk](https://nextcloud.com/talk) - 即时通讯和社交平台。 ([源代码](https://github.com/nextcloud/spreed)) `GPL-3.0` `Docker`
- [Nextcloud Tasks](https://apps.nextcloud.com/apps/tasks) - 自托管私有云存储和协作平台，支持文件同步和共享。 ([源代码](https://github.com/nextcloud/tasks)) `GPL-3.0` `Docker`
- [NextExplorer](https://explorer.nxz.ai) - NextExplorer 是一个自托管的  应用。 ([源代码](https://github.com/nxzai/NextExplorer)) `GPL-3.0` `Docker`
- [OpenList](https://doc.oplist.org) - 支持多种存储后端的文件管理器。 ([源代码](https://github.com/OpenListTeam/OpenList)) `GPL-3.0` `Docker`
- [ownCloud Infinite Scale](https://doc.owncloud.com/ocis/) - 自托管文件同步和共享平台。 ([源代码](https://github.com/owncloud/ocis)) `GPL-3.0` `Docker`
- [OxiCloud](https://atalayalabs.github.io/OxiCloud/) - OxiCloud 是一个自托管的  应用。 ([源代码](https://github.com/AtalayaLabs/OxiCloud)) `GPL-3.0` `Docker`
- [Pancheck](https://github.com/Lampon/PanCheck) - Pancheck 是一个自托管的  应用。 `MIT` `Docker`
- [Panhub.shenzjd.com](https://github.com/wu529778790/panhub.shenzjd.com) - Panhub.shenzjd.com 是一个自托管的  应用。 `MIT` `Docker`
- [Panindex](https://github.com/libsgh/PanIndex) - Panindex 是一个自托管的  应用。 `MIT` `Docker`
- [Pansou](https://github.com/fish2018/pansou) - Pansou 是一个自托管的  应用。 `MIT` `Docker`
- [PlikShare](https://plikshare.com) - PlikShare 是一个自托管的  应用。 ([源代码](https://github.com/damian-krychowski/plikshare)) `GPL-3.0` `Docker`
- [Pluton](https://usepluton.com) - 数据备份和恢复工具。 ([源代码](https://github.com/plutonhq/pluton)) `GPL-3.0` `Docker`
- [Profilarr](https://dictionarry.dev) - Profilarr 是一个自托管的  应用。 ([源代码](https://github.com/Dictionarry-Hub/profilarr)) `GPL-3.0` `Docker`
- [QuickDrop](https://github.com/RoastSlav/quickdrop) - QuickDrop 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [RustFS](https://github.com/rustfs/rustfs) - 高性能分布式对象存储系统。 `GPL-3.0` `Docker`
...
- [Sun Panel](https://github.com/hslr-s/sun-panel) - Sun Panel 是一个自托管的  应用。 `MIT` `Docker`
- [The One File](https://therecanonlybe.one/The-One-File/) - 地图和地理位置服务平台。 ([源代码](https://github.com/gelatinescreams/The-One-File)) `GPL-3.0` `Docker`
- [Tl Rtc File](https://github.com/tl-open-source/tl-rtc-file) - Tl Rtc File 是一个自托管的  应用。 `MIT` `Docker`
- [Transfer.zip](https://transfer.zip) - Transfer.zip 是一个自托管的  应用。 ([源代码](https://github.com/robinkarlberg/transfer.zip-web)) `GPL-3.0` `Docker`
- [Translations](https://github.com/filerun/translations) - Translations 是一个自托管的  应用。 `MIT` `Docker`
...
- [VersityGW](https://www.versity.com/products/versitygw/) - VersityGW 是一个自托管的  应用。 ([源代码](https://github.com/versity/versitygw)) `GPL-3.0` `Docker`
- [Webdav Aliyundriver](https://github.com/zxbu/webdav-aliyundriver) - Webdav Aliyundriver 是一个自托管的  应用。 `MIT` `Docker`
- [Xiaoya Alist](https://github.com/DDS-Derek/xiaoya-alist) - 支持多种存储后端的文件列表程序。 `MIT` `Docker`
...
- [Zfile](https://github.com/zhaojun1998/zfile) - 在线文件目录和云存储管理工具。 `MIT` `Docker`
...
- [DumbDrop](https://github.com/DumbWareio/DumbDrop) - 点对点文件传输和共享工具。 `Apache-2.0` `Docker`
- [Exatorrent](https://github.com/varbhat/exatorrent) - 点对点文件传输和共享工具。 `MIT` `Docker`
- [Fastsend](https://github.com/ShouChenICU/FastSend) - 点对点文件传输和共享工具。 `MIT` `Docker`
- [FilePizza](https://github.com/kern/filepizza) - 基于 WebRTC 的浏览器端点对点文件传输工具。 `GPL-3.0` `Docker`
- [Flood](https://flood.js.org) - 基于 Web 的 rTorrent 种子管理界面。 ([源代码](https://github.com/jesec/flood)) `GPL-3.0` `Docker`
- [Live Torrent](https://github.com/Davenchy/live-torrent) - 点对点文件传输和共享工具。 `MIT` `Docker`
- [Notifuse](https://www.notifuse.com) - 文件传输和共享工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/Notifuse/notifuse)) `GPL-3.0` `Docker`
- [NZBGet](https://nzbget.com) - 点对点文件传输和共享工具。 ([源代码](https://github.com/nzbgetcom/nzbget)) `GPL-3.0` `Docker`
- [PairDrop](https://pairdrop.net) - 基于浏览器的跨平台文件共享工具，灵感来自 AirDrop。 ([源代码](https://github.com/schlagmichdoch/PairDrop)) `GPL-3.0` `Docker`
...
- [Rackula](https://racku.la) - 点对点文件传输和共享工具。 ([源代码](https://github.com/RackulaLives/Rackula)) `GPL-3.0` `Docker`
...
- [Snapdrop](https://snapdrop.net) - 基于浏览器的局域网文件即时共享工具。 ([源代码](https://github.com/SnapDrop/snapdrop)) `MIT` `Docker`
- [torrra](https://torrra.readthedocs.io) - 点对点文件传输和共享工具。 ([源代码](https://github.com/stabldev/torrra)) `GPL-3.0` `Docker`
...
- [VueTorrent](https://vuetorrent.github.io/demo) - 轻量级 qBittorrent Web 管理界面，基于 Vue.js。 ([源代码](https://github.com/VueTorrent/VueTorrent)) `GPL-3.0` `Docker`
...
- [Atuin](https://atuin.sh) - 多设备文件同步和分发工具。 ([源代码](https://github.com/atuinsh/atuin)) `GPL-3.0` `Docker`
...
- [Overr-Syncerr](https://github.com/gssariev/overr-syncerr) - 多设备文件同步和分发工具。 `Apache-2.0` `Docker`
...
- [Self Hosted Livesync Server](https://github.com/vrtmrz/self-hosted-livesync-server) - 多设备文件同步和分发工具。 `MIT` `Docker`
...
- [EventCatalog](https://eventcatalog.dev) - 事件驱动架构的文档和设计工具。 ([源代码](https://github.com/event-catalog/eventcatalog)) `GPL-3.0` `Docker`
...
- [Papermark](https://papermark.io) - 开源 DocSend 替代品。支持文档分享、访问跟踪、自定义域名和链接到期设置。 ([源代码](https://github.com/mfts/papermark)) `AGPL-3.0` `TypeScript/Docker`
...
- [Pdf3md](https://github.com/murtaza-nasir/pdf3md) - 文档管理和自动化处理平台。 `MIT` `Docker`
...
- [Pdfmanager](https://github.com/G0rsthir/pdfmanager) - 文档管理和自动化处理平台。 `MIT` `Docker`
- [Scan To Paperless](https://github.com/sbrunner/scan-to-paperless) - 文档管理和自动化处理平台。 `MIT` `Docker`
...
- [Trwebocr](https://github.com/alisen39/TrWebOCR) - 文档管理和自动化处理平台。 `MIT` `Docker`
...
_相关: [内容管理系统（CMS）](#内容管理系统（cms）), [档案和数字保存](#档案和数字保存)_
...
- [Autocaliweb](https://codeberg.org/gelbphoenix/autocaliweb) - 电子书管理和阅读平台。 ([源代码](https://github.com/gelbphoenix/autocaliweb)) `GPL-3.0` `Docker`
- [BiblioReads](https://biblioreads.eu.org) - An Alternative 私有 Goodreads Front-End. ([源代码](https://github.com/nesaku/BiblioReads)) `GPL-3.0` `JavaScript`
- [BookHaven](https://github.com/HrBingR/BookHaven) - RSS 订阅和新闻阅读器。 电子书和阅读管理平台。 `Apache-2.0` `Docker`
- [BookHeaven](https://bookheaven.ggarrido.dev/) - BookHeaven 服务器 is a web app to 管理 your ebook 库. Compatible with OPDS, Koreader 同步 and a custom API for the BookHeaven Reader android app. ([源代码](https://github.com/BookHeaven/BookHeaven.Server)) `GPL-3.0` `HTML/Docker`
- [BookLogr](https://github.com/Mozzo1000/booklogr) - 轻松管理您的个人图书馆。 ([演示](https://demo.booklogr.app/)) `Apache-2.0` `Docker`
- [Bookmark Plugin](https://github.com/luchenqun/bookmark-plugin) - 电子书管理和阅读平台。 `MIT` `Docker`
- [Bookologia](https://github.com/blankresearch/Bookologia) - 电子书管理和阅读平台。 `MIT` `Docker`
- [BookOrbit](https://bookorbit.app) - BookOrbit: 个人图书管理与阅读空间。 ([源代码](https://github.com/bookorbit/bookorbit)) `GPL-3.0` `TypeScript/Docker`
- [Booksonic Air](https://github.com/popeen/Booksonic-Air) - 基于 Airsonic 的有声书服务器，支持流式播放和播客订阅。 `MIT` `Java`
...
- [Cashbook](https://github.com/DingDangDog/cashbook) - 电子书管理和阅读平台。 `MIT` `Docker`
- [Comic Library Utilities](https://clucomics.org) - Digital comic curation app to read, 管理, edit, and 更新 库 of any size. ([源代码](https://github.com/allaboutduncan/clu-comics)) `GPL-3.0` `Python`
...
- [IronCalc](https://www.ironcalc.com) - Main engine of the IronCalc ecosystem。 ([源代码](https://github.com/ironcalc/IronCalc)) `GPL-3.0` `Rust`
...
- [Librum](https://librumreader.com) - RSS 订阅和新闻阅读器。 电子书和阅读管理平台。 ([源代码](https://github.com/Librum-Reader/Librum)) `MIT` `Docker`
- [LinguaCafe](https://simjanos-dev.github.io/LinguaCafeHome/) - LinguaCafe is a 自托管 software that helps language learners read foreign languages. ([源代码](https://github.com/simjanos-dev/LinguaCafe)) `MIT` `TypeScript`
- [lurker](https://github.com/oppiliappan/lurker) - lurker 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Lute](https://github.com/LuteOrg/lute-v3) - Lute 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [MyBibliotheca](https://github.com/pickles4evaaaa/mybibliotheca) - 电子书和阅读管理平台。 物联网设备和智能家居管理平台。 `GPL-3.0` `Docker`
- [MyMangaDB](https://github.com/FabianRolfMatthiasNoll/MyMangaDB) `⚠` - 漫画收藏管理器，支持自动获取元数据、MyAnimeList 导入及详细的收藏统计。 `GPL-3.0` `Docker`
- [Obskurnee](https://github.com/zblesk/obskurnee) - Obskurnee 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Openreads](https://github.com/mateusz-bak/openreads) - 网站统计和数据分析平台。 电子书和阅读管理平台。 `Apache-2.0` `Docker`
- [Paperless AI](https://clusterzx.github.io/paperless-ai/) - 为 Paperless-ngx 提供 AI 自动分类和标签功能的插件。 ([源代码](https://github.com/clusterzx/paperless-ai)) `GPL-3.0` `Docker`
- [pyShelf](https://github.com/th3r00t/pyShelf) - pyShelf 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Storybook](https://storybook.js.org) - Storybook 是一个自托管的  应用。 ([源代码](https://github.com/storybookjs/storybook)) `GPL-3.0` `Docker`
...
- [Agendav](https://github.com/agendav/agendav) - 日历、联系人和日程管理服务。 `MIT` `Docker`
...
- [FluidCalendar](https://github.com/dotnetfactory/fluid-calendar) - 日历和日程管理服务。 `GPL-3.0` `Docker`
- [Frigate-Notify](https://frigate-notify.0x2142.com/) - 日历、联系人和日程管理服务。 ([源代码](https://github.com/0x2142/frigate-notify)) `Apache-2.0` `Docker`
...
- [Luna](https://github.com/Opisek/luna) - 日历和日程管理服务。 `GPL-3.0` `Docker`
...
- [Ontime](https://www.getontime.no) - 日历、联系人和日程管理服务。 ([源代码](https://github.com/cpvalente/ontime)) `GPL-3.0` `Docker`
...
- [Zensical](https://zensical.org/docs/) - 跨平台日历和联系人同步服务。 ([源代码](https://github.com/zensical/zensical)) `GPL-3.0` `Docker`
...
- [BroadcastChannel](https://memo.miantiao.me) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/miantiao-me/BroadcastChannel)) `GPL-3.0` `Docker`
- [Cloudlog](https://magicbug.co.uk/cloudlog/) - 随时随地记录你的业余无线电联络。 ([源代码](https://github.com/magicbug/cloudlog)) `MIT` `PHP/Docker`
- [Dozzle](https://dozzle.dev/) - Docker 容器的实时日志查看器，轻量级 Web 界面。 ([源代码](https://github.com/amir20/dozzle)) `GPL-3.0` `Docker`
- [Emoncms](https://emoncms.org) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/emoncms/emoncms)) `GPL-3.0` `Docker`
- [Fail2Ban-Report](https://github.com/SubleXBle/Fail2Ban-Report) - Fail2Ban-Report 是一个自托管的  应用。 `Apache-2.0` `Docker`
...
- [Graylog](https://www.graylog.org) - 集中式日志管理平台，支持实时日志采集、搜索、分析和告警。 ([源代码](https://github.com/Graylog2/graylog2-server)) `GPL-3.0` `Docker`
- [Hollo](https://docs.hollo.social/) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/fedify-dev/hollo)) `GPL-3.0` `Docker`
- [Immich Drop](https://github.com/Nasogaa/immich-drop) - 身份认证和访问控制解决方案。 `GPL-3.0` `Docker`
- [jetlog](https://github.com/pbogre/jetlog) - 个人飞行跟踪器和查看器。 `GPL-2.0` `Docker`
- [Kubetail](https://www.kubetail.com) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/kubetail-org/kubetail)) `GPL-3.0` `Docker`
- [Live Blog](https://www.sourcefabric.org/software/liveblog) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/liveblog/liveblog)) `GPL-3.0` `Docker`
- [Logchef](https://logchef.app/) - 轻量级, single-binary log 分析 界面 for ClickHouse, focused on 高性能 querying and 可视化。 ([源代码](https://github.com/mr-karan/logchef)) `GPL-3.0` `Go`
- [Logdy](https://logdy.dev) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/logdyhq/logdy-core)) `Apache-2.0` `Docker`
...
- [Mbin](https://joinmbin.org) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/MbinOrg/mbin)) `GPL-3.0` `Docker`
- [Openchangelog](https://openchangelog.com) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/JonasHiltl/openchangelog)) `GPL-3.0` `Docker`
- [Panora](https://panora.dev) - 集中式日志采集、分析和可视化平台。 ([源代码](https://github.com/panoratech/Panora)) `Apache-2.0` `Docker`
- [Parseable](https://parseable.com) - Parseable 是一个自托管的  应用。 ([源代码](https://github.com/parseablehq/parseable)) `GPL-3.0` `Docker`
...
- [SmokePing](https://http://www.smokeping.org) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/oetiker/SmokePing)) `GPL-3.0` `Docker`
- [Synology Torrserver](https://github.com/vladlenas/Synology-TorrServer) - 集中式日志采集、分析和可视化平台。 `MIT` `Docker`
- [Tootik](https://github.com/dimkr/tootik) - 集中式日志采集、分析和可视化平台。 `GPL-3.0` `Docker`
- [Vector](https://vector.dev) - 高性能可观测性数据管道，采集、转换和转发日志和指标。 ([源代码](https://github.com/vectordotdev/vector)) `GPL-3.0` `Docker`
...
- [Agregarr](https://github.com/agregarr/agregarr) - Agregarr is a Plex Collections 管理器 that keeps your Home and Recommended fresh by frequently updating it with collections from various sources。 `GPL-3.0` `TypeScript`
- [Aurral](https://aurral.org) - The best in 开源 音乐 discovery. ([源代码](https://github.com/lklynet/aurral)) `GPL-3.0` `JavaScript`
- [AuthPortal](https://github.com/modom-ofn/auth-portal) - 身份认证和访问控制解决方案。 HTTP 反向代理和流量管理工具。 `GPL-3.0` `Docker`
- [Bililiverecorder](https://github.com/BililiveRecorder/BililiveRecorder) - 录播姬 | mikufans 生放送录制。 `MIT` `C#`
- [Briefing](https://brie.fi/ng) - 即时通讯和社交平台。 ([源代码](https://github.com/holtwick/briefing)) `Apache-2.0` `Docker`
- [Cinephage](https://github.com/MoldyTaint/Cinephage) - The AIO solution to your 自托管 媒体 gathering needs。 `GPL-3.0` `TypeScript`
- [Cleanuparr](https://github.com/Cleanuparr/Cleanuparr) - Advanced 下载 管理器 for the Servarr ecosystem。 `GPL-3.0` `C#`
- [CouchTube](https://couchtube.fly.dev/) - 📺 A 自托管, YouTube based application that recreates the feel of a 电视剧 channel. CouchTube schedules YouTube 视频 playback dynamically from 用户-defined channel lists. 自定义, 分享, and submit JSON-based playlists to make CouchTube your own!。 ([源代码](https://github.com/ozencb/couchtube)) `GPL-3.0` `Go`
- [CyTube](https://github.com/calzoneman/sync) - 同步媒体、聊天等，支持任意数量的频道。 ([演示](https://cytu.be)) `MIT` `Node.js`
- [DeepSubX](https://github.com/garanda21/deepsubx) - DeepSubX 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Dim](https://github.com/Dusk-Labs/dim) - Dim 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) - Dispatcharr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [DVinyl](https://kyonew.me/dvinyl) - DVinyl 是一个自托管的  应用。 ([源代码](https://github.com/Kyonew/DVinyl)) `GPL-3.0` `Docker`
- [Fireshare](https://fireshare.net) - 游戏服务器托管和管理平台。 ([源代码](https://github.com/ShaneIsrael/fireshare)) `GPL-3.0` `Docker`
- [Fladder](https://donutware.github.io/Fladder/) - Fladder 是一个自托管的  应用。 ([源代码](https://github.com/DonutWare/Fladder)) `GPL-3.0` `Docker`
- [Flox](https://simounet.github.io/flox/) - Flox 是一个自托管的  应用。 ([源代码](https://github.com/Simounet/flox)) `GPL-3.0` `Docker`
- [Frames](https://github.com/eleven-am/frames) - Frames 是一个自托管的  应用。 `MIT` `Docker`
- [Games on Whales](https://games-on-whales.github.io/wolf/stable/) - 容器化部署和管理工具。 游戏服务器托管和管理平台。 ([源代码](https://github.com/games-on-whales/wolf)) `GPL-3.0` `Docker`
- [Guardian](https://github.com/HydroshieldMKII/Guardian) - Guardian 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [HomeTube](https://github.com/EgalitarianMonkey/hometube) - HomeTube 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Jellyfin Rewind](https://jellyfin-rewind.chaphasilor.xyz) - 开源媒体服务器。 ([源代码](https://github.com/Chaphasilor/jellyfin-rewind)) `GPL-3.0` `Docker`
- [Jellyplist](https://github.com/kamilkosek/jellyplist) - A  实用工具 to 帮助 you 同步 playlists from spotify to your jellyfin 服务器。 `Apache-2.0` `Python`
- [Jellystat](https://github.com/CyferShepard/Jellystat) - Jellystat is a free and 开源 统计 App for Jellyfin。 `GPL-3.0` `JavaScript`
- [Jellyswarrm](https://github.com/LLukas22/Jellyswarrm) - Bring all your Jellyfin servers together。 `GPL-3.0` `Rust`
- [Jellysweep](https://github.com/jon4hz/jellysweep) - 🧹 Jellysweep is a smart cleanup 工具 for your Jellyfin 媒体 服务器。 `GPL-3.0` `Go`
- [LANCommander](https://lancommander.app) - 游戏服务器托管和管理平台。 ([源代码](https://github.com/LANCommander/LANCommander)) `GPL-3.0` `Docker`
- [Livego](https://github.com/gwuhaolin/livego) - Live 视频 流媒体 服务器 in golang。 `MIT` `Go`
- [Loops](https://joinloops.org) - The federated short 视频 sharing platform. ([源代码](https://github.com/joinloops/loops-server)) `GPL-3.0` `PHP`
- [m3u-editor](https://github.com/m3ue/m3u-editor) - m3u-editor 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Maintainerr](https://maintainerr.info) - 服务器和服务的监控与告警平台。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/Maintainerr/Maintainerr)) `GPL-3.0` `Docker`
- [Materialious](https://materialio.us) - Materialious 是一个自托管的  应用。 ([源代码](https://github.com/Materialious/Materialious)) `GPL-3.0` `Docker`
...
- [Medialytics](https://github.com/Drewpeifer/medialytics) - Medialytics 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [MediaLyze](https://www.medialyze.app) - MediaLyze 是一个自托管的  应用。 ([源代码](https://github.com/frederikemmer/MediaLyze)) `GPL-3.0` `Docker`
- [MediaManager](https://github.com/maxdorninger/MediaManager) - MediaManager 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Meet](https://visio.numerique.gouv.fr) - 即时通讯和社交平台。 ([源代码](https://github.com/suitenumerique/meet)) `GPL-3.0` `Docker`
- [Mydia](https://github.com/getmydia/mydia) - Mydia 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [nodecast-tv](https://github.com/technomancer702/nodecast-tv) - nodecast-tv 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Nzb DAV](https://github.com/nzbdav-dev/nzbdav) - Nzb DAV 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Omoide](https://github.com/EinAeffchen/Omoide) - AI 驱动的智能应用和智能体平台。 电子书和阅读管理平台。 `GPL-3.0` `Docker`
- [OpenCut](https://opencut.app) - OpenCut 是一个自托管的  应用。 ([源代码](https://github.com/OpenCut-app/OpenCut)) `GPL-3.0` `Docker`
- [OpenTogetherTube](https://opentogethertube.com) - OpenTogetherTube 是一个自托管的  应用。 ([源代码](https://github.com/dyc3/opentogethertube)) `GPL-3.0` `Docker`
...
- [PASTA](https://www.pastatool.com) - PASTA 是一个自托管的  应用。 ([源代码](https://github.com/cglatot/pasta)) `GPL-3.0` `Docker`
...
- [Petio](https://petio.tv) - Petio 是一个自托管的  应用。 ([源代码](https://github.com/petio-team/petio)) `MIT` `Docker`
- [Piped](https://piped.video) - 注重隐私的 YouTube 前端，无广告和数据追踪。 ([源代码](https://github.com/TeamPiped/Piped)) `GPL-3.0` `Docker`
- [Pixelfin](https://github.com/nothing2obvi/pixelfin) - Pixelfin 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Plex Rewind](https://github.com/RaunoT/plex-rewind) - Plex Rewind 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Posteria](https://posteria.app) - Posteria 是一个自托管的  应用。 ([源代码](https://github.com/jeremehancock/Posteria)) `GPL-3.0` `Docker`
- [RadaRec](https://github.com/TheWicklowWolf/RadaRec) - RadaRec 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Rapidbay](https://github.com/hauxir/rapidbay/) - 支持在浏览器或 Chromecast/AppleTV/智能电视中搜索和播放种子视频的流媒体服务/种子客户端。 `MIT` `Python/Docker`
- [Reiverr](https://github.com/aleksilassila/reiverr) - 数据库管理和查询工具。 `MIT` `Docker`
...
- [Riven](https://riven.tv) - Riven 是一个自托管的  应用。 ([源代码](https://github.com/rivenmedia/riven)) `GPL-3.0` `Docker`
- [Seanime](https://seanime.app) - Seanime 是一个自托管的  应用。 ([源代码](https://github.com/5rahim/seanime)) `GPL-3.0` `Docker`
- [SeerrBridge](https://soluify.com) - SeerrBridge 是一个自托管的  应用。 ([源代码](https://github.com/Woahai321/SeerrBridge)) `Apache-2.0` `Docker`
- [SRS](https://ossrs.net) - 一个简单、高效和实时的视频服务器，支持RTMP、WebRTC、HLS、HTTP-FLV和SRT。 ([源代码](https://github.com/ossrs/srs)) `MIT` `Docker/C++`
- [Streamystats](https://github.com/fredrikburmester/streamystats) - Streamystats 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Subatic](https://subatic.com) - Subatic 是一个自托管的  应用。 ([源代码](https://github.com/orthdron/subatic)) `GPL-3.0` `Docker`
- [SuggestArr](https://giuseppe99barchetta.github.io/SuggestArr/) - SuggestArr 是一个自托管的  应用。 ([源代码](https://github.com/giuseppe99barchetta/SuggestArr)) `GPL-3.0` `Docker`
- [SyncTube](https://github.com/RblSb/SyncTube) - 轻量级且非常简单设置的 CyTube 替代方案，用于与朋友一起观看视频和聊天。 `MIT` `Node.js/Haxe`
- [Tracearr](https://www.tracearr.com) - Tracearr 是一个自托管的  应用。 ([源代码](https://github.com/connorgallopo/Tracearr)) `GPL-3.0` `Docker`
- [Trackly](https://github.com/7eventy7/trackly) - Trackly 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Trailarr](https://nandyalu.github.io/trailarr/) - Trailarr 是一个自托管的  应用。 ([源代码](https://github.com/nandyalu/trailarr)) `GPL-3.0` `Docker`
...
- [Tunarr](https://tunarr.com/) - Tunarr 是一个自托管的  应用。 ([源代码](https://github.com/chrisbenincasa/tunarr)) `GPL-3.0` `Docker`
- [TVHeadend](https://tvheadend.org) - TVHeadend 是一个自托管的  应用。 ([源代码](https://github.com/tvheadend/tvheadend)) `GPL-3.0` `Docker`
- [Unpackerr](https://unpackerr.zip) - Unpackerr 是一个自托管的  应用。 ([源代码](https://github.com/Unpackerr/unpackerr)) `GPL-3.0` `Docker`
...
- [ViniPlay](https://github.com/ardoviniandrea/ViniPlay) - ViniPlay 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [WatchState](https://github.com/arabcoders/watchstate) - WatchState 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Youlag](https://github.com/civilblur/youlag) - RSS 订阅和新闻阅读器。 `GPL-3.0` `Docker`
- [YT-DLP Web Player](https://github.com/Matszwe02/ytdlp_web_player) - YT-DLP Web Player 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Airsonic Advanced](https://github.com/airsonic-advanced/airsonic-advanced) - 音乐流媒体服务器，兼容 Subsonic 客户端。 `MIT` `Docker`
- [Airsonic](https://github.com/airsonic/airsonic) - 音乐流媒体服务器，兼容 Subsonic 客户端。 `MIT` `Docker`
- [Algermusicplayer](https://github.com/algerkong/AlgerMusicPlayer) - 一个第三方音乐播放器、本地服务、桌面歌词、音乐下载、远程控制。 `MIT` `TypeScript`
- [Ampache](https://ampache.org/) - Web 基础的音频/视频流应用。 ([演示](https://play.dogmazic.net/), [源代码](https://github.com/ampache/ampache)) `AGPL-3.0` `PHP`
- [Auddly Server](https://github.com/Wellenline/auddly-server) - 简单 自托管 音乐 流媒体 服务器。 `MIT` `TypeScript/Docker`
- [AudioBookRequest](https://github.com/markbeep/AudioBookRequest/wiki/) - Minimal and 轻量级 audiobook request 管理/wishlist for Plex/Audiobookshelf/Jellyfin。 ([源代码](https://github.com/markbeep/AudioBookRequest)) `GPL-3.0` `Python`
- [Audiobookshelf App](https://github.com/advplyr/audiobookshelf-app) - 自托管有声书和播客服务器。 `MIT` `Docker`
...
- [Beatbump](https://beatbump.io/) - Alternative YouTube 音乐 frontend built with Svelte/SvelteKit 🎧。 ([源代码](https://github.com/snuffyDev/Beatbump)) `Apache-2.0` `TypeScript`
...
- [Diosic](https://github.com/Reknij/diosic) - Diosic 是一个自托管的  应用。 `MIT` `Docker`
- [DroppedNeedle](https://musicseerr.com/) - DroppedNeedle 是一个自托管的  应用。 ([源代码](https://github.com/DroppedNeedle/DroppedNeedle)) `GPL-3.0` `Docker`
- [Ersatztv](https://github.com/jasongdove/ErsatzTV) - Ersatztv 是一个自托管的  应用。 `MIT` `Docker`
- [Explo](https://github.com/LumePart/Explo) - Explo 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Fast Music Remover](https://github.com/omeryusufyagci/fast-music-remover) - Fast Music Remover 是一个自托管的  应用。 `MIT` `Docker`
- [Feishin](https://github.com/jeffvli/feishin) - Feishin 是一个自托管的  应用。 `MIT` `Docker`
...
- [Koito](https://koito.io) - Koito is a 现代化, themeable scrobbler that you can use with any program that scrobbles to a custom ListenBrainz URL。 ([源代码](https://github.com/gabehf/Koito)) `GPL-3.0` `Go/Docker`
...
- [Listenarr](https://getlistenarr.com) - Listenarr automates audiobook collection 管理 similar to Sonarr or Radarr, but for audiobooks. It can 搜索, 下载, and organize your 库 automatically using metadata from Audible and other sources. ([源代码](https://github.com/Listenarrs/Listenarr)) `GPL-3.0` `C#`
- [LMS](https://github.com/epoupon/lms) - 通过Web界面访问您的自托管音乐。 `GPL-3.0` `Docker/deb/C++`
- [Lx Music Sync Server](https://github.com/lyswhut/lx-music-sync-server) - Lx Music Sync Server 是一个自托管的  应用。 `MIT` `Docker`
...
- [Maloja](https://maloja.krateng.ch) - 数据库管理和查询工具。 ([源代码](https://github.com/krateng/maloja)) `MIT` `Docker`
- [Melody](https://github.com/foamzou/melody) - Melody 是一个自托管的  应用。 `MIT` `Docker`
- [Metadata Remote](https://github.com/wow-signal-dev/metadata-remote) - Metadata Remote 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [MinusPod](https://github.com/ttlequals0/MinusPod) - MinusPod 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [moOde Audio](https://moodeaudio.org/) - 高保真音乐播放，适用于出色的 Raspberry Pi 单板计算机系列。 ([源代码](https://github.com/moode-player/moode)) `GPL-3.0` `PHP`
- [Moodist](https://github.com/remvze/moodist) - Moodist 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Music Assistant](https://music-assistant.io) - 统一管理和控制多个音乐库和播放设备的平台。 ([源代码](https://github.com/music-assistant/server)) `GPL-3.0` `Docker`
- [Music Tag Web](https://github.com/xhongc/music-tag-web) - Music Tag Web 是一个自托管的  应用。 `MIT` `Docker`
- [Music](https://github.com/Sherlockouo/music) - Music 是一个自托管的  应用。 `MIT` `Docker`
- [Musiccard](https://github.com/aidaox/MusicCard) - Musiccard 是一个自托管的  应用。 `MIT` `Docker`
- [Musicn](https://github.com/zonemeen/musicn) - Musicn 是一个自托管的  应用。 `MIT` `Docker`
...
- [NextBeats](https://nextbeats.vercel.app) - NextBeats 是一个自托管的  应用。 ([源代码](https://github.com/btahir/next-beats)) `Apache-2.0` `Docker`
- [Octo-Fiesta](https://github.com/V1ck3s/octo-fiesta) - HTTP 反向代理和流量管理工具。 `GPL-3.0` `Docker`
- [One Api](https://github.com/songquanpeng/one-api) - One Api 是一个自托管的  应用。 `MIT` `Docker`
- [Pawtunes](https://github.com/Jackysi/PawTunes) - Pawtunes 是一个自托管的  应用。 `MIT` `Docker`
- [PigeonPod](https://pigeonpod.cloud) - 地图和地理位置服务平台。 ([源代码](https://github.com/aizhimou/pigeon-pod)) `GPL-3.0` `Docker`
...
- [Podsync](https://github.com/mxpv/podsync) - RSS 订阅和新闻阅读器。 `GPL-3.0` `Docker`
- [Polaris](https://github.com/agersant/polaris) - 针对大型音乐收藏、易用性和高性能优化的音乐浏览和流媒体应用。 `MIT` `Rust/Docker`
- [Radishes](https://github.com/radishes-music/radishes) - Radishes 是一个自托管的  应用。 `MIT` `Docker`
- [ReadMeABook](https://github.com/kikootwo/ReadMeABook) - ReadMeABook 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Reverb](https://github.com/maxjb-xyz/reverb) - Reverb 是一个自托管的  应用。 `MIT` `Docker`
- [Scriberr](https://scriberr.app) - Scriberr 是一个自托管的  应用。 ([源代码](https://github.com/rishikanthc/Scriberr)) `GPL-3.0` `Docker`
- [Snapcast](https://github.com/snapcast/snapcast) - 同步多房间音频服务器。 `GPL-3.0` `C++/deb`
- [Soniqboom](https://github.com/SFCyris/SoniqBoom) - Soniqboom 是一个自托管的  应用。 `MIT` `Docker`
- [Soulbeet](https://github.com/terry90/soulbeet) - Soulbeet 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [SoulSync](https://ssync.net/) - SoulSync 是一个自托管的  应用。 ([源代码](https://github.com/Nezreka/SoulSync)) `GPL-3.0` `Docker`
...
- [SUB/WAVE](https://www.getsubwave.com) - SUB/WAVE 是一个自托管的  应用。 ([源代码](https://github.com/perminder-klair/subwave)) `GPL-3.0` `Docker`
...
- [Unlock Music](https://github.com/ix64/unlock-music) - Unlock Music 是一个自托管的  应用。 `MIT` `Docker`
- [Vocard](https://vocard.xyz) - 即时通讯和社交平台。 ([源代码](https://github.com/ChocoMeow/Vocard)) `GPL-3.0` `Docker`
...
- [Yesplaymusic](https://github.com/qier222/YesPlayMusic) - Yesplaymusic 是一个自托管的  应用。 `MIT` `Docker`
- [yubal](https://github.com/guillevc/yubal) - yubal 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Yuvomi](https://yuvomi.cloud/) - Yuvomi 是一个自托管的  应用。 ([源代码](https://github.com/ulsklyc/yuvomi)) `GPL-3.0` `Docker`
- [ZipCaptions](https://zipcaptions.app) - ZipCaptions 是一个自托管的  应用。 ([源代码](https://github.com/jptrsn/zip-captions)) `GPL-3.0` `Docker`
...
- [Chinese Dos Games Web](https://github.com/rwv/chinese-dos-games-web) - 游戏服务器托管和管理工具。 `MIT` `Docker`
...
- [Lodestone](https://www.lodestone.cc/) - 游戏服务器托管和管理平台。 ([源代码](https://github.com/Lodestone-Team/lodestone)) `MIT` `Docker`
...
- [Nakama](https://heroiclabs.com) - 为社交和实时游戏设计的可扩展后端服务。 ([源代码](https://github.com/heroiclabs/nakama)) `GPL-3.0` `Docker`
...
- [Playedu](https://github.com/PlayEdu/PlayEdu) - 游戏服务器托管和管理工具。 `MIT` `Docker`
- [Playlistdl](https://github.com/TannerNelson16/playlistdl) - 游戏服务器托管和管理工具。 `MIT` `Docker`
...
- [RetroAssembly](https://retroassembly.com) - 游戏服务器托管和管理平台。 ([源代码](https://github.com/arianrhodsandlot/retroassembly)) `GPL-3.0` `Docker`
- [Scribble.rs](https://github.com/scribble-rs/scribble.rs) - 一个基于网络的你画我猜游戏。 ([演示](https://scribblers.fly.dev)) `BSD-3-Clause` `Go/Docker`
- [Squeezeplay](https://github.com/ralph-irving/squeezeplay) - 游戏服务器托管和管理工具。 `MIT` `Docker`
- [Steam Headless](https://github.com/Steam-Headless/docker-steam-headless) - 在 Docker 容器中运行 Steam 游戏平台。 `GPL-3.0` `Docker`
...
- [Zy Player](https://github.com/Hunlongyu/ZY-Player) - 游戏服务器托管和管理工具。 `MIT` `Docker`
...
- [Apollo](https://github.com/ClassicOldSong/Apollo) - 游戏串流服务器，Sunshine 的分支，支持以客户端设备原生分辨率进行串流。改进的虚拟显示和手柄支持。 `GPL-3.0` `C++/Docker`
...
- [Gramps](https://gramps-project.org/) - 家族族谱研究和关系管理软件。 ([源代码](https://github.com/gramps-project/gramps)) `GPL-3.0` `Docker`
...
- [9router](https://github.com/decolua/9router) - Unlimited FREE AI coding. 连接 Claude Code, Codex, Cursor, Cline, Copilot, Antigravity to FREE Claude/GPT/Gemini via 40+ providers. Auto-fallback, RTK -40% 令牌, never hit limits. `MIT` `JavaScript`
- [Android](https://github.com/gotify/android) - An app for creating push notifications for new messages posted to gotify/服务器. `MIT` `Java`
- [Anti Ad](https://github.com/privacy-protection-tools/anti-AD) - 致力于成为中文区命中率最高的广告过滤列表，实现精确的广告屏蔽和隐私保护。anti-AD 现已支持 AdGuardHome，dnsmasq，Surge，Pi-Hole，Clash, mihomo，smartdns，sing-box 等网络组件。完全兼容常见的广告过滤工具所支持的各种广告过滤列表格式。 `MIT` `Docker`
- [Apitable](https://github.com/apitable/apitable) - 🚀🎉📚 APITable, an API-oriented low-code platform for building 协作 apps and better than all other Airtable 开源 alternatives. `MIT` `TypeScript`
- [Apktool](https://github.com/iBotPeaches/Apktool) - A 工具 for reverse engineering Android apk 文件。 `MIT` `Java`
- [Arcall](https://github.com/anyRTC-UseCase/ARCall) - 一对一呼叫、邀请呼叫、音视频通话、多人通话，适合陌生人交友、在线教学、在线医疗、智能终端等场景；更能轻松实现腾讯会议，Zoom会议，钉钉课堂等多人音视频交互类场景。一对一音视频，一对多音视频。 `MIT` `JavaScript`
- [Astrbot](https://github.com/AstrBotDevs/AstrBot) - AI 智能体 Assistant & development 框架 that integrates lots of 即时通讯 platforms, LLMs, 插件 and AI feature, and can be your openclaw alternative. ✨。 `MIT` `Python/Docker`
- [Astro](https://github.com/igorsheg/astro) - An open, extensible, 仪表板 for all of your homelab services. `MIT` `TypeScript/Docker`
- [Astroluma](https://github.com/Sanjeet990/Astroluma) - 功能丰富的自托管仪表板。 `MIT` `Docker`
- [Aurora](https://github.com/aurora-develop/aurora) - Free chatgpt API。 `MIT` `Go`
- [Auto Bangumi](https://github.com/EstrellaXD/Auto_Bangumi) - AutoBangumi - 全自动追番工具。 `MIT` `Python/Docker`
- [Autopiano](https://github.com/AutoPiano/AutoPiano) - 🎹 自由钢琴 AutoPiano - 简单 & Elegant Piano Online。 `MIT` `JavaScript`
- [Autoredact](https://github.com/karant-dev/AutoRedact) - 🛡️ 客户端-side, 隐私-first 图片 redaction 工具. Automatically detects and blurs PII (Emails, IPs, 密钥) using local OCR. No 服务器, no 数据 leaks. `MIT` `TypeScript`
- [Avataaars Generator](https://github.com/fangpenlin/avataaars-generator) - 简单 generator React app for avataaars。 `MIT` `TypeScript`
- [Banban](https://github.com/m0g/banban) - 自托管 Kanban board 工具。 `MIT` `TypeScript`
- [Bar Keep](https://github.com/nckslvrmn/bar_keep) - A 简单 inventory 管理器 for your home bar。 `MIT` `HTML/Docker`
- [Bark Server](https://github.com/Finb/bark-server) - Backend of Bark。 `MIT` `Go`
- [Bender](https://github.com/jez500/bender) - 可管理链接的仪表板。 `MIT` `Docker`
- [Bettafish](https://github.com/666ghj/BettaFish) - 微舆：人人可用的多Agent舆情分析助手，打破信息茧房，还原舆情原貌，预测未来走向，辅助决策！从0实现，不依赖任何框架。 `MIT` `Python`
- [Booklore](https://github.com/adityachandelgit/BookLore) - Booklore 是一个自托管的  应用。 `MIT` `Docker`
- [Bypy](https://github.com/houtianze/bypy) - Python 客户端 for Baidu Yun (Personal 云 存储) 百度云/百度网盘Python客户端。 `MIT` `Python`
- [Call Me](https://github.com/miroslavpejic85/call-me) - 🟢 WebRTC click-to-call platform for instant 实时 communication in a persistent shared room with unlimited participants where 用户 can join and call each other instantly. No signup or 设置 required. `MIT` `JavaScript/Docker`
- [Calmness](https://github.com/remvze/calmness) - Breathing exercise in your browser. `MIT` `TypeScript`
- [Cat](https://github.com/celaraze/cat) - Sebastian is a LLM assistant with the ability to have permanent 记忆. `MIT` `PHP`
- [Chevereto Free](https://github.com/Chevereto/Chevereto-Free) - Chevereto Free 是一个自托管的  应用。 `MIT` `Docker`
- [Clipable](https://github.com/clipable/clipable) - A 简单, 自托管, alternative to Streamable。 `MIT` `Go`
- [Codexa](https://github.com/thehijacker/codexa) - A 自托管 EPUB web reader with multi-用户 支持, OPDS browsing, KOReader 同步, and a built-in dictionary lookup — all in a single 轻量级 Node.js container. `MIT` `JavaScript`
- [Cogito](https://github.com/Tukks/cogito) - An another second brain app。 `MIT` `Java`
- [Compiler Explorer](https://github.com/compiler-explorer/compiler-explorer) - Run compilers interactively from your web browser and interact with the assembly。 `MIT` `TypeScript`
- [Composing.studio](https://github.com/ekzhang/composing.studio) - 协作 音乐 composition for everyone. `MIT` `TypeScript`
- [Crawlab](https://github.com/crawlab-team/crawlab) - 分布式 web crawler 管理 platform for spiders 管理 regardless of languages and 框架. 分布式爬虫管理平台，支持任何语言和框架。 `MIT` `Go/Docker`
- [Daedalos](https://github.com/DustinBrett/daedalOS) - 桌面 environment in the browser。 `MIT` `JavaScript`
- [Darcs](https://darcs.net/) - 跨平台版本控制系统，类似 git、mercurial 或 svn，但采用完全不同的思路：关注变更而非快照。 ([源代码](https://darcs.net/releases/)) `GPL-2.0` `Haskell`
- [Dashwise Next](https://github.com/andreasmolnardev/dashwise-next) - Dashwise Next 是一个自托管的  应用。 `MIT` `Docker`
- [Deeptutor](https://github.com/HKUDS/DeepTutor) - Deeptutor 是一个自托管的  应用。 `MIT` `Docker`
- [Deskreen](https://github.com/pavlobu/deskreen) - Deskreen 是一个自托管的  应用。 `MIT` `Docker`
- [Digikam](https://github.com/KDE/digikam) - Digikam 是一个自托管的  应用。 `MIT` `Docker`
...
- [Django Mdict](https://github.com/jiangnianshun/django-mdict) - Django Mdict 是一个自托管的  应用。 `MIT` `Docker`
- [Dongguatv](https://github.com/EdNovas/dongguaTV) - Dongguatv 是一个自托管的  应用。 `MIT` `Docker`
- [Easy Countdown](https://github.com/Yooooomi/easy-countdown) - Easy Countdown 是一个自托管的  应用。 `MIT` `Docker`
- [Easy Gate](https://github.com/r7wx/easy-gate) - Easy Gate 是一个自托管的  应用。 `MIT` `Docker`
- [Easynode](https://github.com/chaos-zhu/easynode) - Easynode 是一个自托管的  应用。 `MIT` `Docker`
- [Edrys](https://github.com/edrys-org/edrys) - Edrys 是一个自托管的  应用。 `MIT` `Docker`
- [Eidos](https://github.com/mayneyao/eidos) - Eidos 是一个自托管的  应用。 `MIT` `Docker`
- [Elysian Extension](https://github.com/Aadityajoshi151/Elysian-Extension) - Elysian Extension 是一个自托管的  应用。 `MIT` `Docker`
- [Euserv Extend](https://github.com/CokeMine/EUserv_extend) - Euserv Extend 是一个自托管的  应用。 `MIT` `Docker`
- [Fast Poster](https://github.com/psoho/fast-poster) - Fast Poster 是一个自托管的  应用。 `MIT` `Docker`
- [Fasttrack](https://github.com/theqldcoalminer/fasttrack) - Fasttrack 是一个自托管的  应用。 `MIT` `Docker`
- [Flask Mdict](https://github.com/liuyug/flask-mdict) - Flask Mdict 是一个自托管的  应用。 `MIT` `Docker`
- [Flowsint](https://github.com/reconurge/flowsint) - Flowsint 是一个自托管的  应用。 `MIT` `Docker`
- [Font Ttf](https://github.com/Fangyh09/font-ttf) - Font Ttf 是一个自托管的  应用。 `MIT` `Docker`
- [Fossflow](https://github.com/stan-smith/FossFLOW) - Fossflow 是一个自托管的  应用。 `MIT` `Docker`
- [Freeaskinternet](https://github.com/nashsu/FreeAskInternet) - Freeaskinternet 是一个自托管的  应用。 `MIT` `Docker`
- [Frona](https://github.com/fronalabs/frona) - Frona 是一个自托管的  应用。 `MIT` `Docker`
- [Gcopy](https://github.com/llaoj/gcopy) - Gcopy 是一个自托管的  应用。 `MIT` `Docker`
- [Gemini Web2api](https://github.com/Sophomoresty/gemini-web2api) - Gemini Web2api 是一个自托管的  应用。 `MIT` `Docker`
- [Geminicli2api](https://github.com/gzzhongqi/geminicli2api) - Geminicli2api 是一个自托管的  应用。 `MIT` `Docker`
- [Getsomecats](https://github.com/getsomecat/GetSomeCats) - Getsomecats 是一个自托管的  应用。 `MIT` `Docker`
- [Gist](https://github.com/9bingyin/Gist) - Gist 是一个自托管的  应用。 `MIT` `Docker`
- [Git](https://git-scm.com/) - 分布式修订控制和源码管理（SCM），强调速度。 ([源代码](https://github.com/git/git)) `GPL-2.0` `C`
- [Glean](https://github.com/LeslieLeung/glean) - Glean 是一个自托管的  应用。 `MIT` `Docker`
- [Gobang](https://github.com/lihongxun945/gobang) - Gobang 是一个自托管的  应用。 `MIT` `Docker`
- [Gohttpserver](https://github.com/codeskyblue/gohttpserver) - Gohttpserver 是一个自托管的  应用。 `MIT` `Docker`
...
- [Gopeed](https://github.com/GopeedLab/gopeed) - Gopeed 是一个自托管的  应用。 `MIT` `Docker`
- [Greaterwms](https://github.com/GreaterWMS/GreaterWMS) - Greaterwms 是一个自托管的  应用。 `MIT` `Docker`
- [Grimmory](https://grimmory.org) - Grimmory 是一个自托管的  应用。 ([源代码](https://github.com/grimmory-tools/grimmory)) `GPL-3.0` `Docker`
- [Hauk](https://github.com/bilde2910/Hauk) - Hauk 是一个自托管的  应用。 `MIT` `Docker`
- [Hertzbeat](https://github.com/dromara/hertzbeat) - Hertzbeat 是一个自托管的  应用。 `MIT` `Docker`
- [Holyclaude](https://github.com/CoderLuii/HolyClaude) - Holyclaude 是一个自托管的  应用。 `MIT` `Docker`
- [Instantbox](https://github.com/instantbox/instantbox) - Instantbox 是一个自托管的  应用。 `MIT` `Docker`
- [Iperf](https://github.com/esnet/iperf) - Iperf 是一个自托管的  应用。 `MIT` `Docker`
- [Ispy](https://github.com/ispysoftware/iSpy) - 开源 surveillance software。 `MIT` `C#`
...
- [Jellyseerr](https://github.com/Fallenbagel/jellyseerr) - Jellyseerr 是一个自托管的  应用。 `MIT` `Docker`
- [Jotsy](https://github.com/ohsayan/jotsy) - Jotsy is a 自托管, free and 开源 笔记 taking app with a goal of simplicity in mind。 `MIT` `Rust`
- [Jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com) - ✨ Innovative and 开源 可视化 application that transforms various 数据 formats, such as JSON, YAML, XML and CSV into interactive 图表. `MIT` `TypeScript`
- [Jsonhero Web](https://github.com/triggerdotdev/jsonhero-web) - JSON Hero is an 开源, 美观 JSON explorer for the web that lets you browse, 搜索 and navigate your JSON 文件 at 速度. 🚀. Built with 💜 by the Trigger.开发 团队. `MIT` `TypeScript`
- [Jump](https://github.com/daledavies/jump) - Jump is a 自托管 startpage and 实时 status page for your 服务器 designed to be 简单, stylish, 快速 and 安全. `MIT` `PHP/Docker`
- [Kerkerker](https://github.com/unilei/kerkerker) - 🎬 这是壳儿 - 影视聚合平台 - 豆瓣集成/多源切换/智能匹配 | Next.js + TypeScript | Docker 部署 | Vercel 部署。 `MIT` `TypeScript`
...
- [Kokoro Fastapi](https://github.com/remsky/Kokoro-FastAPI) - Dockerized FastAPI wrapper for Kokoro-82M text-to-speech 模型 w/multiplatform CPU, AMD, NVIDIA GPU PyTorch 支持, handling, and auto-stitching。 `MIT` `Python`
- [Kotaemon](https://github.com/Cinnamon/kotaemon) - An 开源 RAG-based 工具 for chatting with your documents. `MIT` `Python`
- [Labby](https://github.com/samuelloranger/labby) - 自托管家庭实验室仪表板。 `MIT` `Docker`
- [Landlord](https://github.com/dwg255/landlord) - 斗地主。 `MIT` `Go`
- [Lanlens](https://github.com/AlexRosbach/LanLens) - LanLens scans your local network, identifies devices by MAC/IP, and gives you a clean web UI to 文档, classify, and 连接 to them. `MIT` `Python/Docker`
- [Legado](https://github.com/gedoor/legado) - Legado 3.0 Book Reader with 强大 controls & full functions❤️阅读3.0, 阅读是一款可以自定义来源阅读网络内容的工具，为广大网络文学爱好者提供一种方便、快捷舒适的试读体验。 `MIT` `Java`
- [Librislog](https://github.com/codebude/librislog) - Just a book tracker. `MIT` `Python`
- [Libva](https://github.com/intel/libva) - Libva is an implementation for VA-API (视频 Acceleration API)。 `MIT` `C`
- [Lookscanned.io](https://github.com/rwv/lookscanned.io) - Lookscanned.io 是一个自托管的  应用。 `MIT` `Docker`
- [Lowcoder](https://www.lowcoder.cloud/) - 🔥 🔥 🔥 The 开源 Retool, Tooljet and Appsmith Alternative。 ([源代码](https://github.com/lowcoder-org/lowcoder)) `Apache-2.0` `HTML`
- [Lsky Pro](https://github.com/wisp-x/lsky-pro) - Lsky Pro 是一个自托管的  应用。 `MIT` `Docker`
- [Lunarr Go](https://github.com/lunarr-app/lunarr-go) - Lunarr Go 是一个自托管的  应用。 `MIT` `Docker`
- [Magicmirror](https://github.com/MichMich/MagicMirror) - 智能镜子平台，显示个性化信息。 `MIT` `Docker`
- [Mango Plugins](https://github.com/hkalexling/mango-plugins) - Mango Plugins 是一个自托管的  应用。 `MIT` `Docker`
- [Markdownxiaoshujiang](https://github.com/suziwen/markdownxiaoshujiang) - Markdownxiaoshujiang 是一个自托管的  应用。 `MIT` `Docker`
- [Markor](https://github.com/gsantner/markor) - Markor 是一个自托管的  应用。 `MIT` `Docker`
- [Masscode](https://github.com/massCodeIO/massCode) - Masscode 是一个自托管的  应用。 `MIT` `Docker`
- [Mcphub](https://github.com/samanhappy/mcphub) - Mcphub 是一个自托管的  应用。 `MIT` `Docker`
- [Md](https://github.com/doocs/md) - Md 是一个自托管的  应用。 `MIT` `Docker`
- [Mercurial](https://www.mercurial-scm.org/) - 分布式源码控制管理工具。 ([源代码](https://repo.mercurial-scm.org/hg/file/tip)) `GPL-2.0` `Python/C/Rust`
- [Mergeable](https://www.usemergeable.dev) - Mergeable 是一个自托管的  应用。 ([源代码](https://github.com/pvcnt/mergeable)) `MIT` `Docker`
- [Messense](https://github.com/messense/messense) - Messense 是一个自托管的  应用。 `MIT` `Docker`
- [Meta Rules Dat](https://github.com/MetaCubeX/meta-rules-dat) - Meta Rules Dat 是一个自托管的  应用。 `MIT` `Docker`
- [Metacubexd](https://github.com/MetaCubeX/metacubexd) - Metacubexd 是一个自托管的  应用。 `MIT` `Docker`
- [Miaomiaowu](https://github.com/iluobei/miaomiaowu) - Miaomiaowu 是一个自托管的  应用。 `MIT` `Docker`
- [Miku Spider](https://github.com/GobinFan/Miku_Spider) - Miku Spider 是一个自托管的  应用。 `MIT` `Docker`
- [Mini QR](https://github.com/lyqht/mini-qr) - Mini QR 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Mirofish](https://github.com/666ghj/MiroFish) - Mirofish 是一个自托管的  应用。 `MIT` `Docker`
- [Mobile Security Framework Mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) - Mobile Security Framework Mobsf 是一个自托管的  应用。 `MIT` `Docker`
- [Models](https://github.com/Sanster/models) - Models 是一个自托管的  应用。 `MIT` `Docker`
- [Moments](https://github.com/kingwrcy/moments) - Moments 是一个自托管的  应用。 `MIT` `Docker`
- [Morphos](https://github.com/danvergara/morphos) - Morphos 是一个自托管的  应用。 `MIT` `Docker`
- [Mtab](https://github.com/tsxcw/mtab) - Mtab 是一个自托管的  应用。 `MIT` `Docker`
- [Mtranserver](https://github.com/xxnuo/MTranServer) - Mtranserver 是一个自托管的  应用。 `MIT` `Docker`
- [Nas Tools](https://github.com/jxxghp/nas-tools) - Nas Tools 是一个自托管的  应用。 `MIT` `Docker`
- [Nav](https://github.com/xjh22222228/nav) - Nav 是一个自托管的  应用。 `MIT` `Docker`
- [Neko Master](https://github.com/foru17/neko-master) - Neko Master 是一个自托管的  应用。 `MIT` `Docker`
- [Neno](https://github.com/openneno/neno) - Neno 是一个自托管的  应用。 `MIT` `Docker`
- [Netv](https://github.com/jvdillon/netv) - Netv 是一个自托管的  应用。 `MIT` `Docker`
- [New Api](https://github.com/Calcium-Ion/new-api) - New Api 是一个自托管的  应用。 `MIT` `Docker`
- [Next Terminal](https://github.com/dushixiang/next-terminal) - Next Terminal 是一个自托管的  应用。 `MIT` `Docker`
- [Nextflux](https://github.com/electh/nextflux) - Nextflux 是一个自托管的  应用。 `MIT` `Docker`
- [Nexus Terminal](https://github.com/Heavrnl/nexus-terminal) - Nexus Terminal 是一个自托管的  应用。 `MIT` `Docker`
- [Nginxconfig.io](https://github.com/digitalocean/nginxconfig.io) - Nginxconfig.io 是一个自托管的  应用。 `MIT` `Docker`
- [Noisedash](https://github.com/kaythomas0/noisedash) - Noisedash 是一个自托管的  应用。 `MIT` `Docker`
- [Novel Plus](https://github.com/201206030/novel-plus) - Novel Plus 是一个自托管的  应用。 `MIT` `Docker`
- [Ntfstool](https://github.com/ntfstool/ntfstool) - Ntfstool 是一个自托管的  应用。 `MIT` `Docker`
- [Ntrace Core](https://github.com/nxtrace/NTrace-core) - Ntrace Core 是一个自托管的  应用。 `MIT` `Docker`
- [Oikos](https://github.com/ulsklyc/oikos) - Oikos 是一个自托管的  应用。 `MIT` `Docker`
- [Oksskolten](https://github.com/babarot/oksskolten) - Oksskolten 是一个自托管的  应用。 `MIT` `Docker`
- [Onelist](https://github.com/msterzhang/onelist) - Onelist 是一个自托管的  应用。 `MIT` `Docker`
- [Open Resume](https://github.com/xitanggg/open-resume) - Open Resume 是一个自托管的  应用。 `MIT` `Docker`
- [Openblocks](https://github.com/openblocks-dev/openblocks) - Openblocks 是一个自托管的  应用。 `MIT` `Docker`
- [Openclinica](https://github.com/OpenClinica/OpenClinica) - Openclinica 是一个自托管的  应用。 `MIT` `Docker`
- [Opencode2api](https://github.com/TiaraBasori/opencode2api) - Opencode2api 是一个自托管的  应用。 `MIT` `Docker`
- [Oshi](https://github.com/oshi/oshi) - Oshi 是一个自托管的  应用。 `MIT` `Docker`
- [Page Assist](https://github.com/n4ze3m/page-assist) - Page Assist 是一个自托管的  应用。 `MIT` `Docker`
- [Palmr](https://github.com/kyantech/Palmr) - Palmr 是一个自托管的  应用。 `MIT` `Docker`
- [Paopao Ce](https://github.com/rocboss/paopao-ce) - Paopao Ce 是一个自托管的  应用。 `MIT` `Docker`
- [Pckd](https://github.com/Just-Moh-it/Pckd) - Pckd 是一个自托管的  应用。 `MIT` `Docker`
- [Perlite](https://github.com/secure-77/Perlite) - Perlite 是一个自托管的  应用。 `MIT` `Docker`
- [Php Dynamic Qr Code](https://github.com/giandonatoinverso/PHP-Dynamic-Qr-code) - Php Dynamic Qr Code 是一个自托管的  应用。 `MIT` `Docker`
- [Pinchtab](https://github.com/pinchtab/pinchtab) - Pinchtab 是一个自托管的  应用。 `MIT` `Docker`
- [Plant It](https://github.com/MDeLuise/plant-it) - Plant It 是一个自托管的  应用。 `MIT` `Docker`
- [Plantuml Server](https://github.com/plantuml/plantuml-server) - Plantuml Server 是一个自托管的  应用。 `MIT` `Docker`
- [Plume](https://github.com/Plume-org/Plume) - Plume 是一个自托管的  应用。 `MIT` `Docker`
- [Pptist](https://github.com/pipipi-pikachu/PPTist) - Pptist 是一个自托管的  应用。 `MIT` `Docker`
- [Pushdeer](https://github.com/easychen/pushdeer) - Pushdeer 是一个自托管的  应用。 `MIT` `Docker`
- [Pønskelisten](https://github.com/aunefyren/poenskelisten) - 分享愿望清单，并协作准备礼物与赠品。 `GPL-3.0` `Docker/Go`
- [Qdirstat](https://github.com/shundhammer/qdirstat) - Qdirstat 是一个自托管的  应用。 `MIT` `Docker`
- [Ralbum](https://github.com/ralbum/ralbum) - Ralbum 是一个自托管的  应用。 `MIT` `Docker`
- [Rawtherapee](https://github.com/Beep6581/RawTherapee) - Rawtherapee 是一个自托管的  应用。 `MIT` `Docker`
- [Reclip](https://github.com/averygan/reclip) - Reclip 是一个自托管的  应用。 `MIT` `Docker`
- [Rediary](https://github.com/aceberg/rediary) - Rediary 是一个自托管的  应用。 `MIT` `Docker`
- [Regex Vis](https://github.com/Bowen7/regex-vis) - Regex Vis 是一个自托管的  应用。 `MIT` `Docker`
- [Reubah](https://github.com/dendianugerah/reubah) - Reubah 是一个自托管的  应用。 `MIT` `Docker`
- [Rocker Versioned2](https://github.com/rocker-org/rocker-versioned2) - Rocker Versioned2 是一个自托管的  应用。 `MIT` `Docker`
- [RunsOn](https://runs-on.com) - RunsOn 是一个自托管的  应用。 ([源代码](https://github.com/runs-on/runs-on)) `GPL-3.0` `Docker`
- [Rustpad](https://rustpad.io) - Rustpad 是一个自托管的  应用。 ([源代码](https://github.com/ekzhang/rustpad)) `MIT` `Docker`
- [Rustscan](https://github.com/RustScan/RustScan) - Rustscan 是一个自托管的  应用。 `MIT` `Docker`
- [Scraperr](https://github.com/jaypyles/Scraperr) - Scraperr 是一个自托管的  应用。 `MIT` `Docker`
- [Screenlite](https://screenlite.org) - Screenlite 是一个自托管的  应用。 ([源代码](https://github.com/screenlite/screenlite)) `Apache-2.0` `Docker`
- [Serge](https://github.com/nsarrazin/serge) - Serge 是一个自托管的  应用。 `MIT` `Docker`
- [Servedash](https://github.com/DestinyJazz/servedash) - Servedash 是一个自托管的  应用。 `MIT` `Docker`
- [Server Bee Backend](https://github.com/ZingerLittleBee/server_bee-backend) - Server Bee Backend 是一个自托管的  应用。 `MIT` `Docker`
- [Servermmon](https://github.com/souying/serverMmon) - Servermmon 是一个自托管的  应用。 `MIT` `Docker`
- [Share Me](https://github.com/Dan6erbond/share-me) - Share Me 是一个自托管的  应用。 `MIT` `Docker`
- [Sharelist](https://github.com/reruin/sharelist) - 网盘挂载和分享工具。 `MIT` `Docker`
- [Sharex](https://github.com/ShareX/ShareX) - Sharex 是一个自托管的  应用。 `MIT` `Docker`
- [Sheetable](https://github.com/SheetAble/SheetAble) - Sheetable 是一个自托管的  应用。 `MIT` `Docker`
- [Sidequests](https://github.com/need4swede/SideQuests) - Sidequests 是一个自托管的  应用。 `MIT` `Docker`
- [Signal](https://github.com/ryohey/signal) - Signal 是一个自托管的  应用。 `MIT` `Docker`
- [Sillytavern](https://github.com/SillyTavern/SillyTavern) - Sillytavern 是一个自托管的  应用。 `MIT` `Docker`
- [Slidev](https://github.com/slidevjs/slidev) - Slidev 是一个自托管的  应用。 `MIT` `Docker`
- [Snapp](https://github.com/urania-dev/snapp) - Snapp 是一个自托管的  应用。 `MIT` `Docker`
- [Snippets Library](https://snippetslibrary.com/) - 代码片段和文本分享工具。 电子书和阅读管理平台。 ([源代码](https://github.com/cojocaru-david/snippetslibrary.com)) `Apache-2.0` `Docker`
- [Soft Serve](https://github.com/charmbracelet/soft-serve) - 基于终端的自托管 Git 服务器。 `GPL-3.0` `Docker`
- [Sokoban](https://github.com/ecyrbe/sokoban) - Sokoban 是一个自托管的  应用。 `MIT` `Docker`
- [Spider Flow](https://github.com/ssssssss-team/spider-flow) - Spider Flow 是一个自托管的  应用。 `MIT` `Docker`
- [Stackedit](https://github.com/benweet/stackedit) - Stackedit 是一个自托管的  应用。 `MIT` `Docker`
- [Stationarr](https://github.com/rroy676/Stationarr) - Stationarr 是一个自托管的  应用。 `MIT` `Docker`
- [Statping](https://github.com/statping/statping) - 自托管状态页面和监控平台。 `MIT` `Docker`
- [Sub Store](https://github.com/sub-store-org/Sub-Store) - Sub Store 是一个自托管的  应用。 `MIT` `Docker`
- [Subs Check Pro](https://github.com/sinspired/subs-check-pro) - Subs Check Pro 是一个自托管的  应用。 `MIT` `Docker`
- [Subs Check](https://github.com/beck-8/subs-check) - Subs Check 是一个自托管的  应用。 `MIT` `Docker`
- [Subversion](https://subversion.apache.org/) - 客户端-服务器修订控制系统。 ([源代码](https://svn.apache.org/repos/asf/subversion/trunk/)) `Apache-2.0` `C`
- [Synctrayzor](https://github.com/canton7/SyncTrayzor) - Synctrayzor 是一个自托管的  应用。 `MIT` `Docker`
- [Synctv](https://github.com/synctv-org/synctv) - Synctv 是一个自托管的  应用。 `MIT` `Docker`
- [Szurubooru](https://github.com/rr-/szurubooru) - Szurubooru 是一个自托管的  应用。 `MIT` `Docker`
- [Tachidesk Server](https://github.com/Suwayomi/Tachidesk-Server) - Tachidesk Server 是一个自托管的  应用。 `MIT` `Docker`
- [Talk](https://github.com/vasanthv/talk) - Talk 是一个自托管的  应用。 `MIT` `Docker`
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) - Tdarr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Teamide](https://github.com/team-ide/teamide) - Teamide 是一个自托管的  应用。 `MIT` `Docker`
- [Tellor](https://github.com/Voldrix/Tellor) - Tellor 是一个自托管的  应用。 `MIT` `Docker`
- [Tillywork](https://github.com/tillywork/tillywork) - Tillywork 是一个自托管的  应用。 `MIT` `Docker`
- [Tini](https://github.com/krallin/tini) - Tini 是一个自托管的  应用。 `MIT` `Docker`
- [Trendradar](https://github.com/sansan0/TrendRadar) - Trendradar 是一个自托管的  应用。 `MIT` `Docker`
- [Tubetube](https://github.com/MattBlackOnly/TubeTube) - Tubetube 是一个自托管的  应用。 `MIT` `Docker`
- [Tv](https://github.com/Guovin/TV) - Tv 是一个自托管的  应用。 `MIT` `Docker`
- [Twake](https://github.com/linagora/Twake) - Twake 是一个自托管的  应用。 `MIT` `Docker`
- [Veloera](https://github.com/Veloera/Veloera) - Veloera 是一个自托管的  应用。 `MIT` `Docker`
- [Vertd](https://github.com/VERT-sh/vertd) - Vertd 是一个自托管的  应用。 `MIT` `Docker`
- [Vrite](https://github.com/vriteio/vrite) - Vrite 是一个自托管的  应用。 `MIT` `Docker`
- [Vscode Drawio](https://github.com/hediet/vscode-drawio) - Vscode Drawio 是一个自托管的  应用。 `MIT` `Docker`
- [Vtracer](https://github.com/visioncortex/vtracer) - Vtracer 是一个自托管的  应用。 `MIT` `Docker`
- [Warracker](https://warracker.com) - 保修期追踪工具，可监控到期日、上传收据/文件，并在保修到期前提醒。 ([源代码](https://github.com/sassanix/Warracker)) `AGPL-3.0` `Docker`
- [Wealth Tracker](https://github.com/nicejade/wealth-tracker) - Wealth Tracker 是一个自托管的  应用。 `MIT` `Docker`
- [Web Clipper](https://github.com/webclipper/web-clipper) - Web Clipper 是一个自托管的  应用。 `MIT` `Docker`
- [Web Code Agent](https://github.com/oldjs/web-code-agent) - Web Code Agent 是一个自托管的  应用。 `MIT` `Docker`
- [Web Portal](https://github.com/enchant97/web-portal) - Web Portal 是一个自托管的  应用。 `MIT` `Docker`
- [Webamp](https://github.com/captbaritone/webamp) - Webamp 是一个自托管的  应用。 `MIT` `Docker`
- [Webos](https://github.com/fs185085781/webos) - Webos 是一个自托管的  应用。 `MIT` `Docker`
- [Webp Server Go](https://github.com/webp-sh/webp_server_go) - Webp Server Go 是一个自托管的  应用。 `MIT` `Docker`
- [Webp2jpg Online](https://github.com/renzhezhilu/webp2jpg-online) - Webp2jpg Online 是一个自托管的  应用。 `MIT` `Docker`
- [Webstack](https://github.com/helloxz/webstack) - Webstack 是一个自托管的  应用。 `MIT` `Docker`
- [Weddingshare](https://github.com/Cirx08/WeddingShare) - Weddingshare 是一个自托管的  应用。 `MIT` `Docker`
- [Weekly Report](https://github.com/guaguaguaxia/weekly_report) - Weekly Report 是一个自托管的  应用。 `MIT` `Docker`
- [Whynotwin11](https://github.com/rcmaehl/WhyNotWin11) - Whynotwin11 是一个自托管的  应用。 `MIT` `Docker`
- [Wikmd](https://github.com/Linbreux/wikmd) - Wikmd 是一个自托管的  应用。 `MIT` `Docker`
- [Wizard](https://github.com/mylxsw/wizard) - Wizard 是一个自托管的  应用。 `MIT` `Docker`
- [Wordscheck](https://github.com/bosnzt/wordscheck) - Wordscheck 是一个自托管的  应用。 `MIT` `Docker`
- [Xiaomi Dafang Hacks](https://github.com/EliasKotlyar/Xiaomi-Dafang-Hacks) - Xiaomi Dafang Hacks 是一个自托管的  应用。 `MIT` `Docker`
- [Xibo](https://xibosignage.com) - Xibo 是一个自托管的  应用。 ([源代码](https://github.com/xibosignage/xibo)) `GPL-3.0` `Docker`
- [YAMLResume](https://yamlresume.dev) - YAMLResume 是一个自托管的  应用。 ([源代码](https://github.com/yamlresume/yamlresume)) `GPL-3.0` `Docker`
- [Yt Dlp](https://github.com/yt-dlp/yt-dlp) - Yt Dlp 是一个自托管的  应用。 `MIT` `Docker`
- [Yulegeyu](https://github.com/liyupi/yulegeyu) - Yulegeyu 是一个自托管的  应用。 `MIT` `Docker`
- [Yyets Flutter](https://github.com/Vove7/yyets_flutter) - Yyets Flutter 是一个自托管的  应用。 `MIT` `Docker`
- [Yyetsbot](https://github.com/tgbot-collection/YYeTsBot) - Yyetsbot 是一个自托管的  应用。 `MIT` `Docker`
- [Zinc](https://github.com/zinclabs/zinc) - Zinc 是一个自托管的  应用。 `MIT` `Docker`
- [Zjson](https://github.com/CN-Tower/zjson) - Zjson 是一个自托管的  应用。 `MIT` `Docker`
- [Zublo](https://github.com/danielalves96/zublo) - Zublo 是一个自托管的  应用。 `MIT` `Docker`
- [Zusam](https://github.com/zusam/zusam) - Zusam 是一个自托管的  应用。 `MIT` `Docker`
...
- [Biblioteca](https://github.com/biblioverse/biblioteca) - 智能家居和物联网设备管理平台。 `MIT` `Docker`
- [BunkerM](https://github.com/bunkeriot/BunkerM) - 物联网设备和智能家居管理平台。 `GPL-3.0` `Docker`
- [diyHue](https://diyhue.org/) - 智能家居和物联网设备管理平台。 ([源代码](https://github.com/diyhue/diyHue)) `GPL-3.0` `Docker`
...
- [ESPHome](https://esphome.io/) - 基于配置的 ESP32/ESP8266 设备控制系统。 ([源代码](https://github.com/esphome/esphome)) `GPL-3.0` `Docker`
...
- [HA Time Machine](https://github.com/saihgupr/HomeAssistantTimeMachine) - HA Time Machine 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Homeassistant Components](https://github.com/yongman/homeassistant-components) - 开源智能家居自动化平台。 `MIT` `Docker`
- [Homebranch](https://github.com/Oghamark/homebranch) - 智能家居和物联网设备管理平台。 `MIT` `Docker`
- [Homechart](https://github.com/candiddev/homechart) - Homechart 是一个自托管的  应用。 `MIT` `Docker`
- [Homelists](https://github.com/aceberg/HomeLists) - Homelists 是一个自托管的  应用。 `MIT` `Docker`
...
- [Meshping](https://github.com/Svedrin/meshping) - 智能家居和物联网设备管理平台。 `GPL-3.0` `Docker`
- [Mosquitto](https://mosquitto.org) - 开源的 MQTT 消息代理实现，适用于物联网场景。 ([源代码](https://github.com/eclipse-mosquitto/mosquitto)) `GPL-3.0` `Docker`
- [MQTT Web Interface](https://github.com/terdia/mqttui) - 物联网设备和智能家居管理平台。 `GPL-3.0` `Docker`
...
- [TypeType](https://typetype.video) - 智能家居和物联网设备管理平台。 ([源代码](https://github.com/TypeType-Video/TypeType)) `GPL-3.0` `Docker`
...
- [Yaade](https://github.com/EsperoTech/yaade) - 智能家居和物联网设备管理平台。 `MIT` `Docker`
- [Zigbee2MQTT](https://www.zigbee2mqtt.io) - 将 Zigbee 设备接入 MQTT 的桥接服务。 ([源代码](https://github.com/Koenkk/zigbee2mqtt)) `GPL-3.0` `Docker`
...
- [Aiaw](https://github.com/NitroRCr/AIaW) - AI as Workspace - An elegant AI 聊天 客户端. Full-featured, 轻量级. 支持 multiple workspaces, 插件 system, 跨平台, local first + 实时 云 同步, Artifacts, MCP | 更好的 AI 客户端。 `MIT` `TypeScript/Docker`
- [Aiclient 2 Api](https://github.com/justlovemaki/AIClient-2-API) - Aiclient 2 Api 是一个自托管的  应用。 `MIT` `Docker`
- [Aingdesk](https://github.com/aingdesk/AingDesk) - AingDesk是一款简单好用的AI助手，支持知识库、模型API、分享、联网搜索、智能体，它还在飞快成长中。 AingDesk is a 简单 and 简单-to-use AI assistant that supports knowledge bases, 模型 APIs, sharing, internet 搜索, and intelligent 智能体. It is still growing rapidly. `MIT` `TypeScript`
- [Airstation](https://github.com/cheatsnake/airstation) - 🎵 Your own online radio station。 `MIT` `Go`
- [Amurex](https://api.amurex.ai) - This is the backend for the entire Amurex 项目. ([源代码](https://github.com/thepersonalaicompany/amurex-backend)) `MIT` `Python`
...
- [Baiduyun](https://github.com/syhyz1990/baiduyun) - 油猴脚本 - 一个免费开源的网盘下载助手。 `MIT` `JavaScript`
- [BirdNET-Analyzer](https://birdnet-team.github.io/BirdNET-Analyzer/) - BirdNET analyzer for scientific 音频 数据 processing. ([源代码](https://github.com/birdnet-team/BirdNET-Analyzer)) `GPL-3.0` `Python`
- [Cherry](https://github.com/haishanh/cherry) - Cherry is a self-hostable bookmark service。 `MIT` `TypeScript`
- [Coai](https://github.com/coaidev/coai) - 🚀 Next Gen Multi-tenant AI One-Stop Solution. Builtin 管理 & 账单 System. 企业-Grade Unified LLM 网关 支持 for 200+ 模型 And 35+ Providers, Load Balacing w/ Priority-base 路由, Cost 管理, 聊天 分享, 云 同步, Credit/Subscription 账单, All 文件 Parsing, Web 搜索, Built-in 模型 缓存. `MIT` `TypeScript`
- [Copaw](https://github.com/agentscope-ai/CoPaw) - Copaw 是一个自托管的  应用。 `MIT` `Docker`
- [Db Gpt](https://github.com/eosphoros-ai/DB-GPT) - 开源 agentic AI 数据 assistant for the next generation of AI + 数据 products. `MIT` `Python`
- [Deepseek Free Api](https://github.com/LLM-Red-Team/deepseek-free-api) - Deepseek Free Api 是一个自托管的  应用。 `MIT` `Docker`
- [Domain Admin](https://github.com/dromara/domain-admin) - Domain Admin 是一个自托管的  应用。 `MIT` `Docker`
...
- [Dootask](https://github.com/kuaifan/dootask) - Dootask 是一个自托管的  应用。 `MIT` `Docker`
- [Drawnix](https://github.com/plait-board/drawnix) - Drawnix 是一个自托管的  应用。 `MIT` `Docker`
- [Fake115](https://github.com/kkHAIKE/fake115) - Fake115 是一个自托管的  应用。 `MIT` `Docker`
- [Fastgpt](https://github.com/labring/FastGPT) - Fastgpt 是一个自托管的  应用。 `MIT` `Docker`
- [Flowise](https://github.com/FlowiseAI/Flowise) - Flowise 是一个自托管的  应用。 `MIT` `Docker`
- [Forsaken Mail](https://github.com/denghongcai/forsaken-mail) - Forsaken Mail 是一个自托管的  应用。 `MIT` `Docker`
- [Garage Webui](https://github.com/khairul169/garage-webui) - 轻量级分布式对象存储。 `MIT` `Docker`
- [Go Proxy Bingai](https://github.com/adams549659584/go-proxy-bingai) - Go Proxy Bingai 是一个自托管的  应用。 `MIT` `Docker`
- [Google Search](https://github.com/web-agent-master/google-search) - Google Search 是一个自托管的  应用。 `MIT` `Docker`
- [Gpt Load](https://github.com/tbphp/gpt-load) - Gpt Load 是一个自托管的  应用。 `MIT` `Docker`
- [Gpt4free](https://github.com/xtekky/gpt4free) - Gpt4free 是一个自托管的  应用。 `MIT` `Docker`
- [Jan](https://jan.ai) - 完全离线的开源 AI 聊天桌面应用（ChatGPT 替代品）。支持本地运行多种 LLM 模型。 ([源代码](https://github.com/janhq/jan)) `AGPL-3.0` `TypeScript/Docker`
- [Kaizoku](https://github.com/oae/kaizoku) - 自托管 manga downloader。 `MIT` `TypeScript`
- [Kanmail](https://github.com/Oxygem/Kanmail) - 📥 Turn your inbox into a kanban board. `MIT` `TypeScript`
...
- [Langflow](https://github.com/langflow-ai/langflow) - Langflow is a 强大 工具 for building and deploying AI-powered 智能体 and 工作流. `MIT` `Python`
...
- [Link Ai](https://github.com/star7th/link-ai) - 保护每一次 AI 调用的隐私安全 — 面向企业和个人的大模型安全接入网关。 `MIT` `TypeScript`
- [Liquor Locker](https://github.com/nguyenjessev/liquor-locker) - A home bar 管理 app to track your bottles and ingredients, with 支持 for AI-powered cocktail recommendations。 `Apache-2.0` `TypeScript`
...
- [Maigret](https://github.com/soxoj/maigret) - Maigret 是一个自托管的  应用。 `MIT` `Docker`
- [MedAssist](https://github.com/njic/medassist) - MedAssist 是一个自托管的  应用。 `MIT` `Docker`
- [Minipaint](https://github.com/viliusle/miniPaint) - Minipaint 是一个自托管的  应用。 `MIT` `Docker`
- [Mumuainovel](https://github.com/xiamuceer-j/MuMuAINovel) - Mumuainovel 是一个自托管的  应用。 `MIT` `Docker`
- [Next Ai Draw Io](https://github.com/DayuanJiang/next-ai-draw-io) - Next Ai Draw Io 是一个自托管的  应用。 `MIT` `Docker`
...
- [OmniPoly](https://github.com/kWeglinski/OmniPoly) - OmniPoly 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Openai Gemini](https://github.com/PublicAffairs/openai-gemini) - Openai Gemini 是一个自托管的  应用。 `MIT` `Docker`
- [Paint Board](https://github.com/LHRUN/paint-board) - Paint Board 是一个自托管的  应用。 `MIT` `Docker`
- [Paperclip](https://github.com/paperclipai/paperclip) - Paperclip 是一个自托管的  应用。 `MIT` `Docker`
- [Pdfmathtranslate](https://github.com/Byaidu/PDFMathTranslate) - Pdfmathtranslate 是一个自托管的  应用。 `MIT` `Docker`
...
- [Scrumboy](https://github.com/markrai/scrumboy) - Scrumboy 是一个自托管的  应用。 `MIT` `Docker`
- [Smart Mermaid](https://github.com/liujuntao123/smart-mermaid) - Smart Mermaid 是一个自托管的  应用。 `MIT` `Docker`
- [Surmai](https://surmai.app/) - Surmai 是一个自托管的  应用。 ([源代码](https://github.com/rohitkumbhar/surmai)) `GPL-3.0` `Docker`
- [Synology Tailscale](https://github.com/nirev/synology-tailscale) - Synology Tailscale 是一个自托管的  应用。 `MIT` `Docker`
- [Tailscale](https://github.com/tailscale/tailscale) - Tailscale 是一个自托管的  应用。 `MIT` `Docker`
- [Tradingagents Cn](https://github.com/hsliuping/TradingAgents-CN) - Tradingagents Cn 是一个自托管的  应用。 `MIT` `Docker`
- [Unraid Guardian](https://github.com/stephondoestech/unraid-config-guardian) - Unraid Guardian 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Vane](https://github.com/ItzCrazyKns/Vane) - AI 驱动的搜索引擎（Perplexity AI 替代品）。 `MIT` `Docker`
- [WhoRang](https://github.com/Beast12/who-rang) - WhoRang 是一个自托管的  应用。 `MIT` `Docker`
- [Willow](https://heywillow.io/) - Willow 是一个自托管的  应用。 ([源代码](https://github.com/HeyWillow/willow)) `GPL-3.0` `Docker`
- [Wuhan 2019 Ncov](https://github.com/canghailan/Wuhan-2019-nCoV) - Wuhan 2019 Ncov 是一个自托管的  应用。 `MIT` `Docker`
...
- [Koffan](https://github.com/PanSalut/Koffan) - 电子商务和在线商店平台。 `GPL-3.0` `Docker`
...
- [Argus](https://release-argus.io) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/release-argus/Argus)) `GPL-3.0` `Docker`
- [Atlas](https://github.com/karam-ajaj/atlas) - 服务器和服务的监控与告警平台。 VPN 和网络安全连接工具。 `GPL-3.0` `Docker`
- [Beszel](https://beszel.dev/) - 轻量级服务器监控平台，支持 Docker 统计、历史数据和告警功能。 ([源代码](https://github.com/henrygd/beszel)) `MIT` `Go`
- [Cachet](https://cachethq.io) - 开源服务状态页面系统。可展示各服务的运行状态，支持组件分组、自动更新和通知订阅。 ([源代码](https://github.com/cachethq/cachet)) `BSD-3-Clause` `PHP/Docker`
...
- [Checkmate](https://checkmate.so/) - 开源服务器监控工具，支持多服务状态检测。 ([源代码](https://github.com/bluewave-labs/Checkmate)) `GPL-3.0` `Docker`
- [checkmk](https://checkmk.com/) - 应用、服务器和网络的综合监控解决方案。 ([源代码](https://github.com/Checkmk/checkmk)) `GPL-2.0` `Python/PHP`
- [ClamAV](https://www.clamav.net/) - 开源防病毒引擎，支持文件扫描、恶意软件检测和实时监控。 ([源代码](https://github.com/Cisco-Talos/clamav)) `GPL-3.0` `Docker`
- [Coolmonitor](https://github.com/star7th/coolmonitor) - 监控系统。 `MIT` `Docker`
- [CoreControl](https://github.com/crocofied/CoreObs) - 服务器和服务的实时监控与状态检测平台。 `GPL-3.0` `Docker`
- [Coroot](https://coroot.com) - 基于 eBPF 的零插桩可观测性平台。集成指标、日志、链路追踪和 AI 根因分析。 ([源代码](https://github.com/coroot/coroot)) `Apache-2.0` `Go/Docker`
- [CrossWatch](https://wiki.crosswatch.app) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/cenodude/CrossWatch)) `GPL-3.0` `Docker`
- [CrowdSec Manager](https://crowdsec-manager.hhf.technology/) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/hhftechnology/crowdsec_manager)) `GPL-3.0` `Docker`
- [CrowdSec](https://crowdsec.net) - 基于社区协作的 IP 信誉和入侵防护系统。 ([源代码](https://github.com/crowdsecurity/crowdsec)) `GPL-3.0` `Docker`
...
- [Dashwise](https://dashwise-next.vercel.app/) - Dashwise, an all-in-one homelab 仪表板。 ([源代码](https://github.com/andreasmolnardev/dashwise)) `GPL-3.0` `TypeScript`
- [Diun](https://crazymax.dev/diun/) - Docker 镜像更新自动检测和通知工具。 ([源代码](https://github.com/crazy-max/diun)) `GPL-3.0` `Docker`
- [docker-php-startpage](https://github.com/loganmarchione/docker-php-startpage) - 服务器和服务的监控与告警平台。 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [Domain Watchdog](https://domainwatchdog.eu) - 服务器和服务的监控与告警平台。 AI 驱动的智能应用和智能体平台。 DNS 管理和域名解析工具。 ([源代码](https://github.com/maelgangloff/domain-watchdog)) `GPL-3.0` `Docker`
- [DynamoDB Dashboard](https://github.com/kritish-dhaubanjar/dynamodb-dashboard) - 数据库管理和查询工具。 `GPL-3.0` `Docker`
- [ExcaliDash](https://github.com/ZimengXiong/ExcaliDash) - ExcaliDash 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Fail2Ban](https://http://www.fail2ban.org) - 入侵防御软件，自动封禁多次认证失败的恶意 IP 地址。 ([源代码](https://github.com/fail2ban/fail2ban)) `GPL-3.0` `Docker`
- [Fitbit Health Dashboard](https://github.com/arpanghosh8453/fitbit-grafana) - 健康和健身追踪管理工具。 `GPL-3.0` `Docker`
...
- [Highlight](https://www.highlight.io) - 开源全栈监控平台。集成会话回放、错误追踪、日志管理和性能监控。 ([源代码](https://github.com/highlight/highlight)) `Apache-2.0` `TypeScript/Go/Docker`
- [Homelab Monitor](https://github.com/SikamikanikoBG/homelab-monitor) - 服务器和服务的实时监控与状态检测平台。 `MIT` `Docker`
- [Icinga](https://www.icinga.com/) - Nagios 分支，功能已超越原版，支持集群监控。 ([源代码](https://github.com/Icinga/icinga2)) `GPL-2.0` `C++`
- [Iso](https://iso.tim.cv) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/Coyenn/iso)) `Apache-2.0` `Docker`
- [Karakeep HomeDash](https://github.com/CodeJawn/karakeep-homedash) - Karakeep HomeDash 是一个自托管的 JavaScript 应用。 `MIT` `JavaScript`
- [Kener](https://kener.ing/) - 带有事件管理功能的状态页面，易于使用和自定义。 ([源代码](https://github.com/rajnandan1/kener)) `MIT` `Node.js/Docker`
- [Kite](https://github.com/kite-org/kite) - 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [Kuma Mieru](https://github.com/Alice39s/kuma-mieru) - 自托管的在线状态监控工具。 `MIT` `Docker`
...
- [Lab Dash](https://github.com/AnthonyGress/lab-dash) - An 开源 仪表板 designed to 管理 your 服务器/homelab applications and services. `GPL-3.0` `TypeScript/Docker`
- [LibreNMS](https://www.librenms.org) - 功能丰富的网络监控系统，支持多种设备。 ([源代码](https://github.com/librenms/librenms)) `GPL-3.0` `PHP`
- [LibreSpeed](https://librespeed.org) - 自托管的网络速度测试工具，无需 JavaScript。 ([源代码](https://github.com/librespeed/speedtest)) `GPL-3.0` `Docker`
- [LogForge](https://www.logforge.dev/) - 服务器和服务的监控与告警平台。 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/log-forge/logforge)) `GPL-3.0` `Docker`
- [Lunalytics](https://lunalytics.xyz) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/KSJaay/Lunalytics)) `GPL-3.0` `Docker`
- [Maintenant](https://maintenant.dev) - 服务器和服务的监控与告警平台。 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/kOlapsis/maintenant)) `GPL-3.0` `Docker`
- [Mantium](https://github.com/diogovalentte/mantium) - Mantium 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Monit](https://mmonit.com/monit/#home) - 管理和监控 Unix 系统的小工具。 ([源代码](https://bitbucket.org/tildeslash/monit/src/master/)) `AGPL-3.0` `C`
- [Monitarr](https://github.com/nickshanks347/monitarr) - 服务器和服务的监控与告警平台。 `GPL-3.0` `Docker`
...
- [Music Service](https://thijstakken.github.io/MusicService/) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/thijstakken/MusicService)) `GPL-3.0` `Docker`
...
- [Netdata](https://www.netdata.cloud) - 实时基础设施监控平台。支持数百种指标的自动检测、可视化和告警。 ([源代码](https://github.com/netdata/netdata)) `GPL-3.0` `C/Go/Docker`
...
- [Nightingale](https://n9e.github.io) - 开源告警监控平台，兼容 Prometheus、VictoriaMetrics、Elasticsearch 等数据源。支持告警管理和可视化。 ([源代码](https://github.com/ccfos/nightingale)) `Apache-2.0` `Go/Docker`
- [Notifiarr](https://notifiarr.wiki) - 服务器和服务的监控与告警平台。 即时通讯和社交平台。 ([源代码](https://github.com/Notifiarr/notifiarr)) `GPL-3.0` `Docker`
- [Nutify](https://github.com/DartSteven/Nutify) - 服务器和服务的监控与告警平台。 `GPL-3.0` `Docker`
...
- [Open DroneLog](https://www.opendronelog.com) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/arpanghosh8453/open-dronelog)) `GPL-3.0` `Docker`
...
- [OpenReplay](https://openreplay.com) - 开源会话回放和产品分析平台（FullStory 替代品）。支持用户行为追踪、错误监控和性能分析。 ([源代码](https://github.com/openreplay/openreplay)) `AGPL-3.0` `TypeScript/Docker`
...
- [PatchMon](https://patchmon.net) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/PatchMon/PatchMon)) `GPL-3.0` `Docker`
- [PeaNUT](https://github.com/Brandawg93/PeaNUT) - VPN 和网络安全连接工具。 `GPL-3.0` `Docker`
- [Peekaping](https://github.com/0xfurai/peekaping) - 服务器和服务的监控与告警平台。 `GPL-3.0` `Docker`
- [Perfice](https://perfice.adoe.dev) - Perfice 是一个自托管的  应用。 ([源代码](https://github.com/p0lloc/perfice)) `GPL-3.0` `Docker`
- [Performance Co-Pilot](http://pcp.io) - 轻量级、分布式系统性能分析框架。 ([源代码](https://github.com/performancecopilot/pcp)) `LGPL-2.1/GPL-2.0` `C`
- [Perses](https://perses.dev) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/perses/perses)) `GPL-3.0` `Docker`
...
- [Pi.alert](https://github.com/jokob-sk/Pi.Alert) - 服务器和服务的实时监控与状态检测平台。 `MIT` `Docker`
- [PoeticMetric](https://poeticmetric.com) - PoeticMetric 是一个自托管的  应用。 ([源代码](https://github.com/th0th/poeticmetric)) `GPL-3.0` `Docker`
- [PortChecker](https://portchecker.io) - 端口检查工具。 ([源代码](https://github.com/dsgnr/portchecker.io)) `GPL-3.0` `Docker`
- [portracker](https://github.com/mostafa-wahied/portracker) - 服务器和服务的监控与告警平台。 `GPL-3.0` `Docker`
- [Prometheus](https://prometheus.io/) - 服务监控系统与时序数据库。 ([源代码](https://github.com/prometheus/prometheus)) `Apache-2.0` `Go`
- [Pulsarr](https://jamcalli.github.io/Pulsarr/) - 服务器和服务的监控与告警平台。 ([源代码](https://github.com/jamcalli/Pulsarr)) `GPL-3.0` `Docker`
- [Pulse](https://pulserelay.pro) - 服务器性能监控和告警平台。 ([源代码](https://github.com/rcourtman/Pulse)) `GPL-3.0` `Docker`
...
- [Scanopy](https://scanopy.net) - Web 应用安全扫描平台。 ([源代码](https://github.com/scanopy/scanopy)) `GPL-3.0` `Docker`
- [Scrutiny](https://github.com/AnalogJ/scrutiny) - 硬盘 S.M.A.R.T 监控 Web UI，支持历史趋势与真实故障阈值。 `MIT` `Go`
- [Self-Hosted Metrics](https://self-hosted-metrics.com) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/kOlapsis/shm)) `GPL-3.0` `Docker`
- [selfh.st/icons](https://selfh.st/icons) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/selfhst/icons)) `GPL-3.0` `Docker`
- [Sensu](https://sensu.io/) - 针对弹性基础设施和分布式应用的监控工具。 ([源代码](https://github.com/sensu/sensu-go)) `MIT` `Go`
- [SigNoz](https://signoz.io) - 开源应用可观测性平台（DataDog/NewRelic 替代品）。支持分布式追踪、指标和日志管理。 ([源代码](https://github.com/SigNoz/signoz)) `MIT` `TypeScript/Go/Docker`
- [SoFE](https://github.com/chkpwd/sofe) - 服务器和服务的监控与告警平台。 `GPL-3.0` `Docker`
- [Speedtest Cli](https://github.com/sivel/speedtest-cli) - 自托管网络速度测试工具。 `MIT` `Docker`
- [Statping-ng](https://statping-ng.github.io) - 自托管状态页面和监控平台。 ([源代码](https://github.com/statping-ng/statping-ng)) `MIT` `Docker`
...
- [Synology Monitoring](https://github.com/kernelkaribou/synology-monitoring) - 服务器和服务的实时监控与状态检测平台。 `MIT` `Docker`
- [TestFlight Watcher](https://github.com/MaximilianGT500/testflight-watcher) - 服务器和服务的监控与告警平台。 AI 驱动的智能应用和智能体平台。 `MIT` `Docker`
- [Thruk](https://www.thruk.org/) - 多后端监控 Web 界面，支持 Naemon、Nagios、Icinga 和 Shinken。 ([源代码](https://github.com/sni/Thruk)) `GPL-1.0` `Perl`
- [Tianji](https://tianji.dev) - 一体化的网站分析、在线监控和服务状态面板（Umami + Uptime Kuma 的结合替代品）。 ([源代码](https://github.com/msgbyte/tianji)) `Apache-2.0` `TypeScript/Docker`
...
- [Traefik Log Dashboard](https://github.com/hhftechnology/traefik-log-dashboard) - 现代化反向代理和负载均衡器。 `GPL-3.0` `Docker`
- [TraLa](https://www.trala.fyi/) - 服务器和服务的实时监控与状态检测平台。 ([源代码](https://github.com/dannybouwers/trala)) `GPL-3.0` `Docker`
- [Unblink](https://github.com/zapdos-labs/unblink) - 服务器和服务的监控与告警平台。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [Uptime Kuma](https://uptime.kuma.pet/) - 现代化自托管监控工具，界面简洁，支持丰富的通知方式。 ([源代码](https://github.com/louislam/uptime-kuma)) `MIT` `Node.js`
- [Vigil](https://github.com/pineappledr/vigil) - 轻量级服务器和硬盘监控系统。 `MIT` `Docker`
- [Watchyourports](https://github.com/aceberg/WatchYourPorts) - 端口监控工具。 `MIT` `Docker`
- [Wazuh](https://wazuh.com/) - 统一 XDR 与 SIEM，保护终端和云工作负载。 ([源代码](https://github.com/wazuh/wazuh)) `GPL-2.0` `C`
- [Webmonitor](https://github.com/LogicJake/WebMonitor) - 服务器和服务的实时监控与状态检测平台。 `MIT` `Docker`
- [WGDashboard](https://github.com/WGDashboard/WGDashboard) - WGDashboard 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [World Monitor](https://github.com/koala73/worldmonitor) - 实时全球情报监控仪表板，聚合多源信息。 `GPL-3.0` `Docker`
...
- [Bibliotheca](https://github.com/pickles4evaaaa/bibliotheca) - 照片管理和相册展示平台。 `MIT` `Docker`
...
- [Cupdate](https://alexgustafsson.github.io/cupdate/) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/AlexGustafsson/cupdate)) `GPL-3.0` `Docker`
...
- [docker-staticmaps](https://dietrichmax.github.io/docker-staticmaps/) - 容器化部署和管理工具。 地图和地理位置服务平台。 ([源代码](https://github.com/dietrichmax/docker-staticmaps)) `GPL-3.0` `Docker`
- [Ente](https://ente.com/) - 一个端到端加密的照片分享平台（Google Photos 和 Apple Photos 的替代品）。 ([源代码](https://github.com/ente/ente)) `AGPL-3.0` `Docker/Node.js/Go`
...
- [Foldergram](https://foldergram.github.io) - 照片管理和相册展示平台。 ([源代码](https://github.com/foldergram/foldergram)) `GPL-3.0` `Docker`
- [Hivisionidphotos](https://github.com/Zeyi-Lin/HivisionIDPhotos) - 照片管理和相册展示平台。 `MIT` `Docker`
...
- [Imagor Studio](https://imagor.net) - 照片管理和相册展示平台。 ([源代码](https://github.com/cshum/imagor-studio)) `GPL-3.0` `Docker`
- [Immich-Frame](https://github.com/immichFrame/ImmichFrame) - 高性能自托管照片和视频备份方案，支持 AI 识别。 `GPL-3.0` `Docker`
- [Immich Kiosk](https://github.com/damongolding/immich-kiosk) - 轻量级幻灯片放映工具，可在自助终端设备和浏览器上运行，并使用 Immich 作为数据源。 `GPL-3.0` `Docker/Go`
- [Immich Power Tools](https://immich-power-tools.featureos.app/) - 高性能自托管照片和视频备份方案，支持 AI 识别。 ([源代码](https://github.com/immich-power-tools/immich-power-tools)) `GPL-3.0` `Docker`
...
- [Kriti Images](https://kritiimages.com) - 照片管理和相册展示平台。 ([源代码](https://github.com/kritihq/kriti-images)) `Apache-2.0` `Docker`
...
- [Mazanoke](https://MAZANOKE.com) - 照片管理和相册展示平台。 ([源代码](https://github.com/civilblur/mazanoke)) `GPL-3.0` `Docker`
...
- [Morss](https://github.com/pictuga/morss) - 照片管理和相册展示平台。 `MIT` `Docker`
...
- [Photonix](https://github.com/photonixapp/photonix) - 照片管理和相册展示平台。 `MIT` `Docker`
- [Photopea](https://github.com/photopea/photopea) - 照片管理和相册展示平台。 `MIT` `Docker`
...
- [Photoshow](https://github.com/thibaud-rohmer/PhotoShow) - 照片管理和相册展示平台。 `MIT` `Docker`
...
- [Pichome](https://github.com/zyx0814/Pichome) - 照片管理和相册展示平台。 `MIT` `Docker`
- [Picx](https://github.com/XPoet/picx) - 照片管理和相册展示平台。 `MIT` `Docker`
...
- [PruneMate](https://prunemate.org) - 容器化部署和管理工具。 ([源代码](https://github.com/anoniemerd/PruneMate)) `GPL-3.0` `Docker`
- [Rgallery](https://github.com/robbymilo/rgallery) - 照片管理和相册展示平台。 `MIT` `Docker`
- [ShotShare](https://github.com/mdshack/shotshare) - 照片管理和相册展示平台。 `MIT` `Docker`
- [sigal](https://github.com/saimn/sigal) - 又一个简单的静态图库生成器。 `MIT` `Python`
- [SnapOtter](https://snapotter.com) - 照片管理和相册展示平台。 ([源代码](https://github.com/snapotter-hq/SnapOtter)) `GPL-3.0` `Docker`
...
- [Unregistry](https://github.com/psviderski/unregistry) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 `GPL-3.0` `Docker`
- [withoutbg](https://github.com/withoutbg/withoutbg-inference) - withoutbg 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [WoLi WebGUI](https://github.com/RemyFV/WoLi-webgui) - 文件传输和共享工具。 `MIT` `Docker`
- [WUD](https://getwud.github.io/wud/) - 容器化部署和管理工具。 ([源代码](https://github.com/getwud/wud)) `GPL-3.0` `Docker`
...
_相关: [笔记工具](#笔记工具), [维基](#维基), [数据库管理](#数据库管理)_

- [Ackify](https://ackify.eu) - 🔏 Proof of Read. 合规 made 简单. ([源代码](https://github.com/kOlapsis/ackify)) `GPL-3.0` `Go`
...
- [Alexandrie](https://alexandrie-hub.fr) - 📚 The 开源, offline-first Notion, Obsidian & Confluence alternative. Advanced Markdown, multi-tenant 团队, OIDC/SSO, and local S3 backups. 部署 in one command. ([源代码](https://github.com/Smaug6739/Alexandrie)) `GPL-3.0` `TypeScript/Docker`
- [Anchor](https://github.com/ZhFahim/anchor) - Offline first, self hostable 笔记 taking application。 `GPL-3.0` `TypeScript`
- [Atlantis](https://github.com/Fantastic-Computing-Machine/atlantis) - 知识库和文档管理平台。 `MIT` `Docker`
...
- [Cryptgeon](https://cryptgeon.org/) - 知识管理和文档协作平台。 地图和地理位置服务平台。 ([源代码](https://github.com/cupcakearmy/cryptgeon)) `GPL-3.0` `Docker`
...
- [Docusaurus](https://docusaurus.io) - Docusaurus 是一个自托管的  应用。 ([源代码](https://github.com/facebook/docusaurus)) `GPL-3.0` `Docker`
- [DumbPad](https://github.com/DumbWareio/DumbPad) - DumbPad 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [EteSync](https://www.etesync.com) - 知识管理和文档协作平台。 日历和日程管理服务。 ([源代码](https://github.com/etesync/server)) `MIT` `Docker`
- [eziwiki](https://github.com/i3months/eziwiki) - eziwiki 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Glass Keep](https://github.com/nikunjsingh93/react-glass-keep) - Glass Keep 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Haptic](https://haptic.md) - Haptic 是一个自托管的  应用。 ([源代码](https://github.com/chroxify/haptic)) `Apache-2.0` `Docker`
...
- [Minne](https://github.com/perstarkse/minne) - 知识管理和文档协作平台。 电子书和阅读管理平台。 `GPL-3.0` `Docker`
- [MkDocs](https://www.mkdocs.org) - 基于 Markdown 的项目文档生成器，简洁快速。 ([源代码](https://github.com/mkdocs/mkdocs)) `Apache-2.0` `Docker`
- [Nanote](https://github.com/omarmir/nanote) - Nanote 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [NoteDiscovery](https://www.notediscovery.com) - NoteDiscovery 是一个自托管的  应用。 ([源代码](https://github.com/gamosoft/NoteDiscovery)) `GPL-3.0` `Docker`
- [Owlistic](https://owlistic-notes.github.io/owlistic/) - Owlistic 是一个自托管的  应用。 ([源代码](https://github.com/owlistic-notes/owlistic)) `MIT` `Docker`
- [Pepperminty Wiki](https://peppermint.mooncarrot.space/) - 知识管理和文档协作平台。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/sbrl/Pepperminty-Wiki)) `GPL-3.0` `Docker`
- [PortNote](https://github.com/crocofied/PortNote) - 知识管理和文档协作平台。 网站统计和数据分析平台。 `MIT` `Docker`
- [Poznote](https://poznote.com) - Poznote 是一个自托管的  应用。 ([源代码](https://github.com/timothepoznanski/poznote)) `GPL-3.0` `Docker`
- [Project N.O.M.A.D.](https://github.com/Crosstalk-Solutions/project-nomad) - Project N.O.M.A.D. 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [ProperDocs](https://properdocs.org/) - 知识库和文档管理平台。 ([源代码](https://github.com/ProperDocs/properdocs)) `GPL-3.0` `Docker`
- [Silicon Notes](https://github.com/cu/silicon) - Silicon Notes 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [SkySend](https://skysend.app) - 知识管理和文档协作平台。 文件传输和共享工具。 ([源代码](https://github.com/Skyfay/SkySend)) `GPL-3.0` `Docker`
- [Speakr](https://github.com/murtaza-nasir/speakr) - Speakr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Sticky](https://www.sticky.today) - Sticky 是一个自托管的  应用。 ([源代码](https://github.com/hamzasaleem2/sticky)) `GPL-3.0` `Docker`
...
- [Zen Notes](https://www.sheshbabu.com/zen/) - Zen Notes 是一个自托管的  应用。 ([源代码](https://github.com/sheshbabu/zen)) `GPL-3.0` `Docker`
- [ZenNotes](https://zennotes.org) - ZenNotes 是一个自托管的  应用。 ([源代码](https://github.com/ZenNotes/zennotes)) `GPL-3.0` `Docker`
...
- [AFFiNE](https://affine.pro) - 下一代知识库，融合文档、白板和数据库，Notion 和 Miro 的开源替代品。 ([源代码](https://github.com/toeverything/AFFiNE)) `MIT` `TypeScript/Docker`
- [Audiodock](https://github.com/NasDock/AudioDock) - 声仓（AudioDock）一款音乐和有声书一体的本地化播放器，支持多端同步。 `MIT` `TypeScript/Docker`
- [Benotes](https://github.com/fr0tt/benotes) - An 开源 自托管 笔记 and bookmarks taking web app. `MIT` `PHP/Docker`
- [Blinko](https://blinko.space/) - 一款带有 AI 功能的个人笔记工具。 ([源代码](https://github.com/blinkospace/blinko)) `AGPL-3.0` `Docker`
- [Codex.docs](https://github.com/codex-team/codex.docs) - Free 文档 app powered by Editor.js ecosystem。 `MIT` `TypeScript`
- [Crumbs](https://github.com/bretzel-app/crumbs) - Crumbs by Bretzel - a 自托管, 隐私-first Google Keep alternative. Capture your thoughts, ideas and 笔记. Built with SvelteKit. `MIT` `TypeScript`
- [Dailynotes](https://github.com/m0ngr31/DailyNotes) - Dailynotes 是一个自托管的  应用。 `MIT` `Docker`
- [DailyTxT](https://github.com/PhiTux/DailyTxT) - 加密日记Web应用，可保存每天的个人记忆。包括搜索功能和加密文件上传。 ([演示](https://dailytxt.phitux.de)) `MIT` `Docker`
- [Dnote](https://github.com/dnote/dnote) - Dnote 是一个自托管的  应用。 `MIT` `Docker`
- [Dockdash](https://github.com/dougmaitelli/DockDash) - Dockdash 是一个自托管的  应用。 `MIT` `Docker`
- [Docling](https://github.com/docling-project/docling) - Docling 是一个自托管的  应用。 `MIT` `Docker`
- [Docs Scraper](https://github.com/meilisearch/docs-scraper) - Docs Scraper 是一个自托管的  应用。 `MIT` `Docker`
...
- [Drydock](https://github.com/CodesWhat/drydock) - Drydock 是一个自托管的  应用。 `MIT` `Docker`
...
- [Gitnote Extensions](https://github.com/zhaopengme/gitnote-extensions) - Gitnote Extensions 是一个自托管的  应用。 `MIT` `Docker`
...
- [Mindoc](https://github.com/mindoc-org/mindoc) - Mindoc 是一个自托管的  应用。 `MIT` `Docker`
- [Mindwtr](https://mindwtr.app) - Mindwtr 是一个自托管的  应用。 ([源代码](https://github.com/dongdongbh/Mindwtr)) `GPL-3.0` `Docker`
- [Minimamemosa](https://github.com/niteenautade/minimamemosa) - Minimamemosa 是一个自托管的  应用。 `MIT` `Docker`
- [Moredoc](https://github.com/mnt-ltd/moredoc) - Moredoc 是一个自托管的  应用。 `MIT` `Docker`
...
- [Notea](https://github.com/notea-org/notea) - Notea 是一个自托管的  应用。 `MIT` `Docker`
- [Noteflow](https://github.com/Xafloc/NoteFlow) - Noteflow 是一个自托管的  应用。 `MIT` `Docker`
- [Notepad](https://github.com/Athlon1600/notepad) - Notepad 是一个自托管的  应用。 `MIT` `Docker`
- [Notes](https://github.com/TriliumNext/Notes) - Notes 是一个自托管的  应用。 `MIT` `Docker`
...
- [Nowen Note](https://github.com/cropflre/nowen-note) - Nowen Note 是一个自托管的  应用。 `MIT` `Docker`
- [Obsidian LiveSync](https://github.com/vrtmrz/obsidian-livesync) - Obsidian 笔记的社区同步插件，支持自托管。 `GPL-3.0` `Docker`
- [Obsidian Releases](https://github.com/obsidianmd/obsidian-releases) - 本地优先的笔记和知识管理平台。 `MIT` `Docker`
- [Obsidian](https://github.com/Jackiexiao/obsidian) - 本地优先的笔记和知识管理平台。 `MIT` `Docker`
- [Onenvr](https://github.com/cyb3rdoc/onenvr) - Onenvr 是一个自托管的  应用。 `MIT` `Docker`
- [Open Notebook](https://github.com/lfnovo/open-notebook) - Open Notebook 是一个自托管的  应用。 `MIT` `Docker`
- [Overleaf](https://www.overleaf.com/) - 基于Web的协作LaTeX编辑器。 ([源代码](https://github.com/overleaf/overleaf)) `AGPL-3.0` `Ruby`
- [Pandawiki](https://github.com/chaitin/PandaWiki) - Pandawiki 是一个自托管的  应用。 `MIT` `Docker`
...
- [Showdoc](https://github.com/star7th/showdoc) - Showdoc 是一个自托管的  应用。 `MIT` `Docker`
...
- [Standalone](https://github.com/standardnotes/standalone) - Standalone 是一个自托管的  应用。 `MIT` `Docker`
...
- [Streamdock](https://github.com/limmer55/streamdock) - Streamdock 是一个自托管的  应用。 `MIT` `Docker`
- [Tiddlywiki5](https://github.com/Jermolene/TiddlyWiki5) - Tiddlywiki5 是一个自托管的  应用。 `MIT` `Docker`
- [Tolaria](https://github.com/refactoringhq/tolaria) - Tolaria 是一个自托管的  应用。 `MIT` `Docker`
- [Trilium](https://github.com/zadam/trilium) - Trilium 是一个自托管的  应用。 `MIT` `Docker`
...
- [Vscode Memo](https://github.com/svsool/vscode-memo) - Vscode Memo 是一个自托管的  应用。 `MIT` `Docker`
...
- [Wxpusher Docs](https://github.com/wxpusher/wxpusher-docs) - Wxpusher Docs 是一个自托管的  应用。 `MIT` `Docker`
- [Xnote](https://github.com/xupingmao/xnote) - Xnote 是一个自托管的  应用。 `MIT` `Docker`
...
_相关: [笔记工具](#笔记工具), [静态网站生成器](#静态网站生成器), [知识管理](#知识管理)_
...
- [docmost Community Edition](https://docmost.com/) - 协作型 Wiki 和文档软件（Confluence、Notion 的替代品）。 ([源代码](https://github.com/docmost/docmost)) `AGPL-3.0` `Docker/Node.js`
- [Docmost](https://docmost.com) - 开源协作维基和文档平台，Notion 和 Confluence 的替代品，支持实时协作和 Markdown。 ([源代码](https://github.com/docmost/docmost)) `AGPL-3.0` `TypeScript/Docker`
...
- [DumbWhoIs](https://dumbwhois.dumbware.io/) - 域名 WHOIS 信息查询工具。 ([源代码](https://github.com/DumbWareio/DumbWhoIs)) `GPL-3.0` `Docker`
...
- [Web-Check](https://web-check.xyz) - 全面的网站情报分析工具，一键获取网站信息。 ([源代码](https://github.com/lissy93/web-check)) `GPL-3.0` `Docker`
...
- [autobrr](https://autobrr.com/introduction) - IRC 频道自动监控和种子下载工具。 ([源代码](https://github.com/autobrr/autobrr)) `GPL-3.0` `Docker`
- [AutoKitteh](https://autokitteh.com) - Durable 工作流 自动化 in just a few lines of code。 ([源代码](https://github.com/autokitteh/autokitteh)) `GPL-3.0` `Go`
...
- [Boxarr](https://github.com/iongpt/boxarr) - Boxarr is an automated box office tracking application that integrates with Radarr to 监控, add, and 管理 the latest theatrical 发布. It provides a 美观 仪表板 showing the current box office top 10, their status in your Radarr 库, and allows 质量 个人资料 管理. `GPL-3.0` `Python`
- [Canine](https://canine.sh) - 容器化部署和管理工具。 ([源代码](https://github.com/CanineHQ/canine)) `GPL-3.0` `Docker`
...
- [Convoy](https://getconvoy.io) - Webhook 网关和事件通知转发服务。 ([源代码](https://github.com/frain-dev/convoy)) `GPL-3.0` `Docker`
...
- [Decypharr](https://github.com/sirrobot01/decypharr) - Decypharr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Deployrr](https://www.deployrr.app) - 容器化部署和管理工具。 ([源代码](https://github.com/SimpleHomelab/Deployrr)) `GPL-3.0` `Docker`
...
- [Doco-CD](https://github.com/kimdre/doco-cd) - 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [Dynacat](https://dynacat.artur.zone/) - Dynacat 是一个自托管的  应用。 ([源代码](https://github.com/Panonim/dynacat)) `GPL-3.0` `Docker`
...
- [Figranium](https://figranium.dev) - Figranium 是一个自托管的  应用。 ([源代码](https://github.com/figranium/figranium)) `GPL-3.0` `Docker`
- [Flow-Like](https://flow-like.com) - Flow-Like 是一个自托管的  应用。 ([源代码](https://github.com/Rheosoph/flow-like)) `GPL-3.0` `Docker`
...
- [Gisia](https://gisia.dev) - 自托管的个人 DevOps 平台，集成项目管理、CI/CD 和环境部署。 ([源代码](https://github.com/gisiahq/gisia)) `AGPL-3.0` `Ruby/Docker`
...
- [GrowChief](https://growchief.com) - GrowChief 是一个自托管的  应用。 ([源代码](https://github.com/growchief/growchief)) `Apache-2.0` `Docker`
- [Habitat](https://gethabitat.org) - Habitat 是一个自托管的  应用。 ([源代码](https://github.com/carlnewton/habitat)) `GPL-3.0` `Docker`
- [HabitSync](https://github.com/jofoerster/habitsync) - HabitSync 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Invio](https://invio.dev) - Invio 是一个自托管的  应用。 ([源代码](https://github.com/kittendevv/Invio)) `GPL-3.0` `Docker`
- [Invoicerr](https://docs.invoicerr.app/) - Invoicerr 是一个自托管的  应用。 ([源代码](https://github.com/invoicerr-app/invoicerr)) `GPL-3.0` `Docker`
...
- [Maxun](https://maxun.dev) - 开源无代码网页抓取平台。支持可视化创建爬虫、数据提取和定时采集任务。 ([源代码](https://github.com/getmaxun/maxun)) `AGPL-3.0` `TypeScript/Docker`
- [Mylar3](https://mylarcomics.com/) - 自动漫画书(cbr/cbz)下载程序，用于NZB和种子下载。 ([源代码](https://github.com/mylar3/mylar3)) `GPL-3.0` `Python/Docker`
- [Nixopus](https://nixopus.com) - Nixopus 是一个自托管的  应用。 ([源代码](https://github.com/nixopus/nixopus)) `GPL-3.0` `Docker`
- [Norish](https://github.com/norish-recipes/norish) - 食谱管理和餐食规划平台。 `GPL-3.0` `Docker`
...
- [Rachoon](https://github.com/ad-on-is/rachoon) - Rachoon 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Rake](https://ruby.github.io/rake/) - 类似于 Make 的构建自动化工具，用 Ruby 编写并可扩展。 ([源代码](https://github.com/ruby/rake)) `MIT` `Ruby`
- [Rangarr](https://github.com/JudoChinX/rangarr) - Rangarr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Rundeck](https://http://rundeck.org) - 跨多服务器的作业调度和自动化运维平台。 ([源代码](https://github.com/rundeck/rundeck)) `GPL-3.0` `Docker`
- [Scraparr](https://github.com/thecfu/scraparr) - Scraparr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [seelf](https://yuukanoo.github.io/seelf/) - seelf 是一个自托管的  应用。 ([源代码](https://github.com/YuukanOO/seelf)) `MIT` `Docker`
- [Shared Moments](https://github.com/tech-kev/SharedMoments) - Shared Moments 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Sonobarr](https://github.com/Dodelidoo-Labs/sonobarr) - Sonobarr 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [Sortarr](https://github.com/Jaredharper1/Sortarr) - Sortarr 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [StencilBox](https://jamesread.github.io/StencilBox/) - StencilBox 是一个自托管的  应用。 ([源代码](https://github.com/jamesread/StencilBox)) `GPL-3.0` `Docker`
- [Temporal](https://temporal.io) - 持久化工作流引擎，用于编排微服务和分布式任务。支持故障恢复、超时重试和工作流追踪。 ([源代码](https://github.com/temporalio/temporal)) `MIT` `Go/Docker`
- [traefik-kop](https://github.com/jittering/traefik-kop) - 容器化部署和管理工具。 `GPL-3.0` `Docker`
- [Trigger.dev](https://trigger.dev) - 开源后台任务和 AI Agent 编排平台。支持定时任务、Webhook 触发和长时间运行的工作流。 ([源代码](https://github.com/triggerdotdev/trigger.dev)) `Apache-2.0` `TypeScript/Node.js/Docker`
- [Vito](https://vitodeploy.com) - Vito 是一个自托管的  应用。 ([源代码](https://github.com/vitodeploy/vito)) `GPL-3.0` `Docker`
- [WagmiOS](https://http://wiki.wagmilabs.fun/) - 容器化部署和管理工具。 AI 驱动的智能应用和智能体平台。 ([源代码](https://github.com/mentholmike/wagmios)) `GPL-3.0` `Docker`
- [Webhook](https://github.com/adnanh/webhook) - 轻量级 Webhook 服务器，通过 HTTP 请求触发 Shell 命令。 `GPL-3.0` `Docker`
- [Windmill](https://www.windmill.dev) - 开源开发者平台，可将脚本转换为工作流和 UI。支持低代码应用构建和定时任务调度。 ([源代码](https://github.com/windmill-labs/windmill)) `AGPL-3.0` `Rust/TypeScript/Docker`
- [wol](https://github.com/Trugamr/wol) - wol 是一个自托管的  应用。 `GPL-3.0` `Docker`
- [xyOps](https://github.com/pixlcore/xyops) - 服务器和服务的监控与告警平台。 `GPL-3.0` `Docker`
- [ytdl-sub](https://ytdl-sub.readthedocs.io) - 自动订阅和下载 YouTube 等平台的视频和音频。 ([源代码](https://github.com/jmbannon/ytdl-sub)) `GPL-3.0` `Docker`
- [ZaneOps](https://zaneops.dev) - 数据库管理和查询工具。 ([源代码](https://github.com/zane-ops/zane-ops)) `GPL-3.0` `Docker`
...
- [Honey](https://demos-honey.djank.me/) - 自托管的 Web 应用和服务平台。 ([源代码](https://github.com/dani3l0/honey)) `GPL-3.0` `Docker`
...
- [Runtipi](https://runtipi.io) - 家庭服务器面板，支持一键安装管理各类自托管应用。提供简洁的 Web 界面。 ([源代码](https://github.com/runtipi/runtipi)) `GPL-3.0` `TypeScript/Docker`
...
- [StartOS](https://start9.com) - 基于浏览器的图形操作系统（OS），使运行个人服务器变得像运行个人电脑一样简单。 ([源代码](https://github.com/Start9Labs/start-technologies)) `MIT` `Rust`
...
- [Amnezia](https://amnezia.org) - 开源 VPN 协议封装工具，支持自托管部署。 ([源代码](https://github.com/amnezia-vpn/amnezia-client)) `GPL-3.0` `Docker`
- [Atria](https://atria.gg) - VPN 和网络安全连接工具。 ([源代码](https://github.com/thesubtleties/atria)) `Apache-2.0` `Docker`
- [DefGuard](https://defguard.net/) - 真正的企业级 WireGuard，支持 MFA/2FA 和 SSO。 ([源代码](https://github.com/DefGuard)) `Apache-2.0` `Rust`
- [DockFlare](https://dockflare.app) - VPN 和网络安全连接工具。 ([源代码](https://github.com/ChrispyBacon-dev/DockFlare)) `GPL-3.0` `Docker`
...
- [Dsm Reverse Proxy Websocket](https://github.com/orobardet/dsm-reverse-proxy-websocket) - VPN 连接和网络安全隧道工具。 `MIT` `Docker`
...
- [Frp](https://github.com/fatedier/frp) - VPN 连接和网络安全隧道工具。 `MIT` `Docker`
...
- [Goaccess For Nginxproxymanager](https://github.com/xavier-hernandez/goaccess-for-nginxproxymanager) - VPN 连接和网络安全隧道工具。 `MIT` `Docker`
...
- [Netbird](https://netbird.io) - 基于 WireGuard 的零信任网络组网平台。支持 SSO、MFA 和自动密钥轮换。 ([源代码](https://github.com/netbirdio/netbird)) `BSD-3-Clause` `Go/Docker`
- [Nps](https://github.com/cnlh/nps) - VPN 连接和网络安全隧道工具。 `MIT` `Docker`
...
- [Streamshield Proxy](https://github.com/pppyyyccc/streamshield-proxy) - VPN 连接和网络安全隧道工具。 `MIT` `Docker`
- [strongSwan](https://www.strongswan.org/) - Linux 下完整的 IPsec 实现。 ([源代码](https://github.com/strongswan/strongswan)) `GPL-2.0` `C`
- [TapMap](https://olalie.github.io/tapmap/) - VPN 和网络安全连接工具。 地图和地理位置服务平台。 ([源代码](https://github.com/olalie/tapmap)) `GPL-3.0` `Docker`
- [UniFi Voucher Site](https://github.com/glenndehaan/unifi-voucher-site) - VPN 和网络安全连接工具。 `GPL-3.0` `Docker`
- [wg-easy](https://wg-easy.github.io/wg-easy/latest/) - 带 Web 管理界面的 WireGuard VPN 一键部署方案。 ([源代码](https://github.com/wg-easy/wg-easy)) `GPL-3.0` `Docker`
- [Wiredoor](https://www.wiredoor.net) - VPN 和网络安全连接工具。 ([源代码](https://github.com/wiredoor/wiredoor)) `GPL-3.0` `Docker`
- [WireGuard](https://www.wireguard.com/) - 基于椭圆曲线和公钥加密的高速 VPN。 ([源代码](https://www.wireguard.com/repositories/)) `GPL-2.0` `C`
- [ZTNET](https://ztnet.network) - VPN 和网络安全连接工具。 ([源代码](https://github.com/sinamics/ztnet)) `GPL-3.0` `Docker`
...
- [Scrypted](https://scrypted.app) - IP 摄像头视频管理平台，支持 HomeKit 和多种协议。 ([源代码](https://github.com/koush/scrypted)) `GPL-3.0` `Docker`
...
_相关: [库存管理](#库存管理), [企业资源规划（ERP）](#企业资源规划（erp）)_
...
- [Beancount Gs](https://github.com/BaoXuebin/beancount-gs) - 个人或企业财务与预算管理工具。 `MIT` `Docker`
...
- [Budget Board](https://budgetboard.net/) - 用于追踪月度支出并实现财务目标的简单应用。 ([源代码](https://github.com/teelur/budget-board)) `GPL-3.0` `Docker`
- [BudgetBee](https://budgetbee.github.io/budgetbee/) - 个人或企业财务管理和预算工具。 ([源代码](https://github.com/budgetbee/budgetbee)) `GPL-3.0` `Docker`
...
- [DumbBudget](https://github.com/DumbWareio/DumbBudget) - 个人或企业财务管理和预算工具。 `Apache-2.0` `Docker`
...
- [Firefly Ios Shortcuts](https://github.com/tmytro/firefly-ios-shortcuts) - 个人或企业财务与预算管理工具。 `MIT` `Docker`
...
- [Ignidash](https://ignidash.com) - 个人或企业财务管理和预算工具。 ([源代码](https://github.com/schelskedevco/ignidash)) `GPL-3.0` `Docker`
...
- [Invoice Builder](https://github.com/piratuks/invoice-builder) - 个人或企业财务与预算管理工具。 `GPL-3.0` `Docker`
...
- [Piglet](https://github.com/k3nd0x/piglet) - 个人或企业财务管理和预算工具。 `MIT` `Docker`
...
- [SparkyBudget](https://github.com/CodeWithCJ/SparkyBudget) - 个人或企业财务管理和预算工具。 `GPL-3.0` `Docker`
- [Spliit](https://spliit.app) - 朋友间的费用分摊和账单管理工具。 ([源代码](https://github.com/spliit-app/spliit)) `Apache-2.0` `Docker`
- [Subscription Manager](https://github.com/dh1011/subscription-manager) - 个人或企业财务与预算管理工具。 `GPL-3.0` `Docker`
- [Subtrackr](https://subtrackr.xyz/) - 个人或企业财务与预算管理工具。 ([源代码](https://github.com/bscott/subtrackr)) `GPL-3.0` `Docker`
- [Sure](https://github.com/we-promise/sure) - 面向所有人的个人财务应用（Maybe 的分支）。 `AGPL-3.0` `Docker`
- [TaxHacker](https://taxhacker.app) - 个人所得税计算和规划工具。 ([源代码](https://github.com/vas3k/TaxHacker)) `GPL-3.0` `Docker`
...
- [GLAuth](https://github.com/glauth/glauth) - 轻量级 LDAP 认证服务器，支持多种后端。 `GPL-3.0` `Docker`
...
- [8mb.local](https://8mb.campuscal.tech/) - 身份认证和访问控制解决方案。 ([源代码](https://github.com/JMS1717/8mb.local)) `GPL-3.0` `Docker`
...
- [Authgear](https://www.authgear.com) - 身份认证和访问控制解决方案。 ([源代码](https://github.com/authgear/authgear-server)) `GPL-3.0` `Docker`
- [Blossom](https://github.com/blossom-editor/blossom) - 集中式身份认证和单点登录平台。 `MIT` `Docker`
...
- [Cerbos](https://cerbos.dev) - 基于策略的声明式访问控制引擎。 ([源代码](https://github.com/cerbos/cerbos)) `GPL-3.0` `Docker`
...
- [Kanidm](https://kanidm.com) - 开源身份管理平台，支持 OAuth 2.0、WebAuthn 和 LDAP。 ([源代码](https://github.com/kanidm/kanidm)) `GPL-3.0` `Docker`
...
- [Melody Auth](https://auth.valuemelody.com/) - 身份认证和访问控制解决方案。 ([源代码](https://github.com/ValueMelody/melody-auth)) `GPL-3.0` `Docker`
- [nforwardauth](https://github.com/nosduco/nforwardauth) - 身份认证和访问控制解决方案。 `GPL-3.0` `Docker`
...
- [Rauthy](https://sebadob.github.io/rauthy/) - 身份认证和访问控制解决方案。 ([源代码](https://github.com/sebadob/rauthy)) `GPL-3.0` `Docker`
...
- [Tinyauth](https://tinyauth.app) - 基于通行密钥的轻量级身份验证中间件。 ([源代码](https://github.com/tinyauthapp/tinyauth)) `GPL-3.0` `Docker`
- [VoidAuth](https://http://voidauth.app) - 身份认证和访问控制解决方案。 ([源代码](https://github.com/voidauth/voidauth)) `GPL-3.0` `Docker`
...
- [Private Captcha](https://privatecaptcha.com) - 身份管理系统的工具和 Web 界面。 ([源代码](https://github.com/PrivateCaptcha/PrivateCaptcha)) `GPL-3.0` `Docker`
...
- [Crontab Guru](https://github.com/cronitorio/cronitor-cli) - 在线 Cron 表达式生成和验证工具。 `GPL-3.0` `Docker`
...
- [GiftManager](https://github.com/icbestCA/giftmanager) - 礼物管理和赠送规划工具。 `GPL-3.0` `Docker`
...
- [MiMo Code](https://mimo.xiaomi.com/coder) - 小米推出的终端 AI 编程助手（OpenCode 分支）。支持无限上下文、持久记忆、多代理协作和 Compose 开发模式。 ([源代码](https://github.com/XiaomiMiMo/MiMo-Code)) `MIT` `TypeScript/Node.js`
- [OpenCode](https://opencode.ai) - 终端、IDE 和桌面端的开源 AI 编程代理。支持多会话并行、多种 LLM 提供商，内置 LSP 和文件编辑能力。 ([源代码](https://github.com/anomalyco/opencode)) `MIT` `TypeScript/Node.js/Docker`
- [Plandex](https://plandex.ai) - 面向大型项目和实际任务的终端 AI 编程代理，支持多文件编辑和上下文管理。 ([源代码](https://github.com/plandex-ai/plandex)) `MIT` `Go/Docker`
...
- [Reasonix](https://reasonix.io) - 面向 DeepSeek 模型优化的 AI 编程代理，基于 prefix-cache 稳定性设计。支持长会话缓存命中 90%+，提供终端和浏览器 UI。 ([源代码](https://github.com/esengine/deepseek-reasonix)) `MIT` `Go/TypeScript`
...
- [Stormkit](https://app.stormkit.io) - 应用部署和基础设施管理平台。 ([源代码](https://github.com/stormkit-io/app-stormkit-io)) `Apache-2.0` `Docker`
- [string.is](https://string.is/) - 面向开发人员的开源、注重隐私的在线字符串工具包。 ([源代码](https://github.com/recurser/string-is)) `AGPL-3.0` `Node.js`
- [Tabby](https://tabby.tabbyml.com) - 自托管的 AI 编程助手，提供代码补全和对话功能。支持多种 LLM 后端本地部署。 ([源代码](https://github.com/TabbyML/tabby)) `Apache-2.0` `Rust/Docker`
...
- [NocoBase](https://www.nocobase.com) - 开源无代码开发平台，支持可视化搭建企业级业务系统、数据管理和自动化工作流。 ([源代码](https://github.com/nocobase/nocobase)) `AGPL-3.0` `TypeScript/Docker`
...
- [SonarQube](https://http://www.sonarqube.org) - 持续代码质量检查和安全性分析的自动化平台。 ([源代码](https://github.com/SonarSource/sonarqube)) `GPL-3.0` `Docker`
...
- [Worklenz](https://worklenz.com) - 团队项目管理和任务协作平台。 ([源代码](https://github.com/Worklenz/worklenz)) `GPL-3.0` `Docker`
...
- [Intellissh](https://github.com/clusterzx/intellissh) - 远程桌面和服务器访问工具。 `MIT` `Docker`
...
- [Nexterm](https://nexterm.dev) - 远程桌面和服务器访问工具。 ([源代码](https://github.com/gnmyt/Nexterm)) `GPL-3.0` `Docker`
- [RustDesk](https://rustdesk.com) - 开源远程桌面软件（TeamViewer 替代品）。支持自建中继服务器、端到端加密和多平台客户端。 ([源代码](https://github.com/rustdesk/rustdesk)) `AGPL-3.0` `Rust/Docker`
...
- [Warpgate](https://github.com/warp-tech/warpgate) - 全透明的SSH、HTTPS、Kubernetes、MySQL和Postgres堡垒/PAM，无需额外的客户端软件。 `Apache-2.0` `Rust/Docker`
- [WeTTY](https://butlerx.github.io/wetty/#/) - 通过http/https在浏览器中使用的终端。 ([源代码](https://github.com/butlerx/wetty)) `MIT` `Docker/Node.js`
- [XPipe](https://xpipe.io) - 远程桌面和服务器访问工具。 ([源代码](https://github.com/xpipe-io/xpipe)) `GPL-3.0` `Docker`
...
- [Fizzy](https://fizzy.do) - 轻量级即时通讯平台。 ([源代码](https://github.com/basecamp/fizzy)) `GPL-3.0` `Docker`
- [Fluxer](https://docs.fluxer.app/operator/get-started/) - 即时消息和 VoIP 通信平台。 ([源代码](https://github.com/fluxerapp/fluxer)) `GPL-3.0` `Docker`
...
- [BBYEN](https://github.com/MarcelRobitaille/bbyen) - Bring Back YouTube Email Notifications! YouTube 上传 email 通知 replacement。 `MIT` `TypeScript`
- [Bulwark](https://bulwarkmail.org) - JMAP Webmail built for the 21st Century. A 现代化, 自托管 email 客户端 for Stalwart Mail 服务器 powered by the JMAP protocol. Email, 日历, contacts and 文件. 快速, 私有, and 开源. ([源代码](https://github.com/bulwarkmail/webmail)) `GPL-3.0` `TypeScript`
...
- [Geoposler](https://github.com/garanda21/geoposler) - AI 驱动的智能应用和智能体平台。 地图和地理位置服务平台。 `GPL-3.0` `Docker`
- [Gmail Cleaner](https://gururagavendra.github.io/gmail-cleaner/) - Gmail Cleaner 是一个自托管的  应用。 ([源代码](https://github.com/Gururagavendra/gmail-cleaner)) `GPL-3.0` `Docker`
- [Hyvor Relay](https://relay.hyvor.com) - Hyvor Relay 是一个自托管的  应用。 ([源代码](https://github.com/hyvor/relay)) `GPL-3.0` `Docker`
...
- [MailFlow](https://mailflow.sh) - MailFlow 是一个自托管的  应用。 ([源代码](https://github.com/maathimself/mailflow)) `GPL-3.0` `Docker`
- [Mailpit](https://mailpit.axllent.org) - 面向开发者的电子邮件测试和调试工具。 ([源代码](https://github.com/axllent/mailpit)) `GPL-3.0` `Docker`
...
- [Nortix Mail](https://github.com/Zhoros/NortixMail) - Nortix Mail 是一个自托管的  应用。 `GPL-3.0` `Docker`
...
- [Chat Ollama](https://github.com/sugarforever/chat-ollama) - ChatOllama is an 开源 AI chatbot that brings cutting-edge language 模型 to your fingertips while keeping your 数据 私有 and 安全. `MIT` `TypeScript`
- [Chatbot Ui](https://github.com/mckaywrigley/chatbot-ui) - AI 聊天 for any 模型. `MIT` `TypeScript`
- [Chatgpt Next Web](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web) - Chatgpt Next Web 是一个自托管的  应用。 `MIT` `Docker`
- [Chatgpt Shortcut](https://github.com/rockbenben/ChatGPT-Shortcut) - 🚀💪Maximize your 效率 and 生产力. The ultimate hub to 管理, 自定义, and 分享 提示. (English/中文/Español/العربية). 让生产力加倍的 AI 快捷指令。更高效地管理提示词，在分享社区中发现适用于不同场景的灵感。 `MIT` `TypeScript`
- [Chatgpt Web](https://github.com/Chanzhaoyu/chatgpt-web) - 用 Express 和  Vue3 搭建的 ChatGPT 演示网页。 `MIT` `TypeScript`
- [Chatto](https://chatto.run) - 即时通讯和社交平台。 ([源代码](https://github.com/chattocorp/chatto)) `GPL-3.0` `Docker`
...
- [Cially](https://cially.org) - 即时通讯和社交平台。 网站统计和数据分析平台。 ([源代码](https://github.com/cially/cially)) `GPL-3.0` `Docker`
- [circled.me](https://circled.me) - 即时通讯和社交平台。 ([源代码](https://github.com/circled-me/server)) `GPL-3.0` `Docker`
- [Convos](https://http://convos.chat) - 即时通讯和社交平台。 ([源代码](https://github.com/convos-chat/convos)) `GPL-3.0` `Docker`
- [Coral](https://coralproject.net/) - Vox Media提供的更好的评论体验。 ([源代码](https://github.com/coralproject/talk)) `Apache-2.0` `Docker/Node.js`
- [Crproxy](https://github.com/wzshiming/crproxy) - Crproxy 是一个自托管的  应用。 `MIT` `Docker`
- [Dailyhot](https://github.com/imsyy/DailyHot) - DailyHot 今日热榜前端页面 | API：https://GitHub.com/imsyy/DailyHotApi。 `MIT` `TypeScript`
...
- [Dribdat](https://dribdat.cc) - Dribdat 是一个自托管的  应用。 ([源代码](https://github.com/dribdat/dribdat)) `GPL-3.0` `Docker`
- [Easyimages2.0](https://github.com/icret/EasyImages2.0) - Easyimages2.0 是一个自托管的  应用。 `MIT` `Docker`
- [Element Web](https://github.com/vector-im/element-web) - Element Web 是一个自托管的  应用。 `MIT` `Docker`
...
- [Focalboard](https://github.com/mattermost/focalboard) - Focalboard 是一个自托管的  应用。 `MIT` `Docker`
- [Foxel](https://github.com/DrizzleTime/Foxel) - Foxel 是一个自托管的  应用。 `MIT` `Docker`
- [Friendica](https://friendi.ca/) - 社交通讯服务器。 ([源代码](https://github.com/friendica/friendica)) `AGPL-3.0` `PHP`
- [Full Text Rss](https://github.com/timothytylee/full-text-rss) - Full Text Rss 是一个自托管的  应用。 `MIT` `Docker`
- [Gaga](https://github.com/duckchat/gaga) - Gaga 是一个自托管的  应用。 `MIT` `Docker`
- [Gemini Next Chat](https://github.com/u14app/gemini-next-chat) - Gemini Next Chat 是一个自托管的  应用。 `MIT` `Docker`
- [Glimpse](https://github.com/jeremehancock/Glimpse) - Glimpse 是一个自托管的  应用。 `MIT` `Docker`
...
- [Heimdallr](https://github.com/AMEST/Heimdallr) - 应用仪表板和起始页。 `MIT` `Docker`
- [Hivechat](https://github.com/HiveNexus/HiveChat) - Hivechat 是一个自托管的  应用。 `MIT` `Docker`
...
- [Imgurl](https://github.com/helloxz/imgurl) - Imgurl 是一个自托管的  应用。 `MIT` `Docker`
- [Iptv Checker](https://github.com/zhimin-dev/iptv-checker) - IPTV checker 工具 for Docker && CMD, check your playlist is available。 `MIT` `TypeScript`
...
- [Kimi Free Api](https://github.com/LLM-Red-Team/kimi-free-api) - 社交网络和论坛社区平台。 `MIT` `Docker`
- [Ktistec](https://github.com/toddsundsted/ktistec) - ActivityPub (https://www.w3.org/TR/activitypub/) 服务器 for individual 用户 and small groups. `GPL-3.0` `Crystal`
...
- [Lobe Chat](https://github.com/lobehub/lobe-chat) - Lobe Chat 是一个自托管的  应用。 `MIT` `Docker`
...
- [Mattermost Mobile](https://github.com/mattermost/mattermost-mobile) - Mattermost Mobile 是一个自托管的  应用。 `MIT` `Docker`
- [Mimo Proxy](https://github.com/myflavor/mimo-proxy) - Mimo Proxy 是一个自托管的  应用。 `MIT` `Docker`
- [Miniboard](https://github.com/aceberg/miniboard) - Miniboard 是一个自托管的  应用。 `MIT` `Docker`
...
- [Mixpost](https://mixpost.app) - 社交媒体内容排期和发布管理平台。 ([源代码](https://github.com/inovector/mixpost)) `GPL-3.0` `Docker`
- [Moltbot](https://github.com/moltbot/moltbot) - Moltbot 是一个自托管的  应用。 `MIT` `Docker`
- [Moltis](https://github.com/moltis-org/moltis) - Moltis 是一个自托管的  应用。 `MIT` `Docker`
- [Movim](https://movim.eu/) - 现代化的联邦社交网络，基于 XMPP，具有完整的群聊、订阅和微博功能。 ([源代码](https://github.com/movim/movim)) `AGPL-3.0` `PHP/Docker`
- [Muximux](https://github.com/mescon/Muximux) - Muximux 是一个自托管的  应用。 `MIT` `Docker`
...
- [Oasis](https://github.com/machengim/oasis) - Oasis 是一个自托管的  应用。 `MIT` `Docker`
- [Oriontv](https://github.com/zimplexing/OrionTV) - Oriontv 是一个自托管的  应用。 `MIT` `Docker`
...
- [pad.ws](https://github.com/coderamp-labs/pad.ws) - pad.ws 是一个自托管的  应用。 `MIT` `Docker`
- [phpBB](https://www.phpbb.com/) - 一款平面论坛公告板软件解决方案，可用于与一群人保持联系，也可以为整个网站提供支持。 ([源代码](https://github.com/phpbb/phpbb)) `GPL-2.0` `PHP`
- [Picgo Plugin Cloudimgs Uploader](https://github.com/qazzxxx/picgo-plugin-cloudimgs-uploader) - Picgo Plugin Cloudimgs Uploader 是一个自托管的  应用。 `MIT` `Docker`
...
- [positive-intentions Chat](https://github.com/positive-intentions/chat) - 即时通讯和社交平台。 `GPL-3.0` `Docker`
- [Priviblur](https://github.com/syeopite/priviblur) - Priviblur 是一个自托管的  应用。 `Apache-2.0` `Docker`
- [Prompt Optimizer](https://github.com/linshenkx/prompt-optimizer) - Prompt Optimizer 是一个自托管的  应用。 `MIT` `Docker`
- [Prompts.chat](https://github.com/f/prompts.chat) - Prompts.chat 是一个自托管的  应用。 `MIT` `Docker`
- [Qm Music](https://github.com/chenqimiao/qm-music) - Qm Music 是一个自托管的  应用。 `MIT` `Docker`
- [qpixel](https://codidact.com/) - 基于问答的社区知识共享软件。 ([源代码](https://github.com/codidact/qpixel)) `AGPL-3.0` `Ruby`
- [Quetre](https://quetre.iket.me) - Quetre 是一个自托管的  应用。 ([源代码](https://github.com/zyachel/quetre)) `Apache-2.0` `Docker`
...
- [Rocket.chat.reactnative](https://github.com/RocketChat/Rocket.Chat.ReactNative) - Rocket.chat.reactnative 是一个自托管的  应用。 `MIT` `Docker`
...
- [Self Hosted](https://github.com/revoltchat/self-hosted) - Self Hosted 是一个自托管的  应用。 `MIT` `Docker`
- [Shoebox](https://github.com/slackspace-io/shoebox) - Shoebox 是一个自托管的  应用。 `MIT` `Docker`
...
- [Simpledash](https://github.com/securemindorg/SimpleDash) - Simpledash 是一个自托管的  应用。 `MIT` `Docker`
...
- [Spacebar](https://spacebar.chat) - 自托管的 Discord 兼容聊天平台。 ([源代码](https://github.com/spacebarchat/spacebarchat)) `GPL-3.0` `Docker`
- [Splayer](https://github.com/imsyy/SPlayer) - Splayer 是一个自托管的  应用。 `MIT` `Docker`
- [Sqlchat](https://github.com/sqlchat/sqlchat) - Sqlchat 是一个自托管的  应用。 `MIT` `Docker`
- [Storyden](https://www.storyden.org/) - Storyden 是一个自托管的  应用。 ([源代码](https://github.com/Southclaws/storyden)) `GPL-3.0` `Docker`
...
- [Touitomamout](https://github.com/louisgrasset/touitomamout) - Touitomamout 是一个自托管的  应用。 `MIT` `Docker`
- [Twikoo](https://twikoo.js.org) - 简洁、安全、免费的静态网站评论系统，支持云函数和自托管部署。 ([源代码](https://github.com/twikoojs/twikoo)) `MIT` `Node.js/Docker`
- [Uniboard](https://github.com/Coooolfan/UniBoard) - Uniboard 是一个自托管的  应用。 `MIT` `Docker`
- [VerneMQ](https://vernemq.com) - 即时通讯和社交平台。 物联网设备和智能家居管理平台。 ([源代码](https://github.com/vernemq/vernemq)) `GPL-3.0` `Docker`
- [Vue Salt Rim](https://github.com/karlomikus/vue-salt-rim) - Vue Salt Rim 是一个自托管的  应用。 `MIT` `Docker`
...
- [Web Llm Chat](https://github.com/mlc-ai/web-llm-chat) - Web Llm Chat 是一个自托管的  应用。 `MIT` `Docker`
- [Wechat Article Exporter](https://github.com/wechat-article/wechat-article-exporter) - Wechat Article Exporter 是一个自托管的  应用。 `MIT` `Docker`
- [Wechattweak Macos](https://github.com/Sunnyyoung/WeChatTweak-macOS) - Wechattweak Macos 是一个自托管的  应用。 `MIT` `Docker`
- [Yal](https://github.com/timo-reymann/yal) - Yal 是一个自托管的  应用。 `MIT` `Docker`
...
- [Lib Jitsi Meet](https://github.com/jitsi/lib-jitsi-meet) - 视频会议和远程协作平台。 `MIT` `Docker`
...
- [Nettu Meet](https://github.com/fmeringdal/nettu-meet) - 视频会议和远程协作平台。 `MIT` `Docker`
...
- [Spacepad](https://spacepad.io) - 视频会议和远程协作平台。 ([源代码](https://github.com/magweter/spacepad)) `GPL-3.0` `Docker`
...
- [Dockge](https://dockge.kuma.pet) - 精美、易用的 Docker Compose 堆栈管理面板，支持创建、编辑、部署和监控 compose 文件。 ([源代码](https://github.com/louislam/dockge)) `MIT` `TypeScript/Docker`
...
- [Nametag](https://github.com/mattogodoy/nametag) - 域名管理和 DNS 记录工具。 `GPL-3.0` `Docker`
...
- [Relaticle](https://relaticle.com) - 应用发布和更新通知平台。 ([源代码](https://github.com/relaticle/relaticle)) `GPL-3.0` `Docker`
- [Semaphore](https://semaphoreui.com) - Ansible、Terraform 和 Shell 脚本的现代化 Web UI。支持运行任务、环境管理和访问控制。 ([源代码](https://github.com/semaphoreui/semaphore)) `MIT` `Go/Docker`
...
- [Cook](https://github.com/YunYouJun/cook) - 食谱管理和餐食规划工具。 `MIT` `Docker`
...
- [KitchenOwl](https://kitchenowl.org/) - 家庭食谱管理和餐食规划工具。 ([源代码](https://github.com/TomBursch/kitchenowl)) `GPL-3.0` `Docker`
...
- [Moocup](https://github.com/jellydeck/moocup) - 食谱管理和餐食规划工具。 `GPL-3.0` `Docker`
