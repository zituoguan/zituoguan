...
- [Homarr iFrames](https://github.com/diogovalentte/homarr-iframes) - iFrames designed for Homarr dashboards `GPL-3.0` `Docker`
...
- [Workout Challenge](https://github.com/vanalmsick/workout_challenge) - Workout challenges for friends and colleagues `GPL-3.0` `Docker`
...
- [Posterizarr](https://github.com/fscorrupt/posterizarr) - Automate the creation of posters for media libraries `GPL-3.0` `Docker`
...
- [Replex](https://github.com/lostb1t/replex) - Proxy for transforming the communication between a Plex server and clients `MIT` `Docker`
...
- [13ft Ladder](https://13ft-ladder.vercel.app/) - Web interface for blocking ads and paywalls ([源代码](https://github.com/wasi-master/13ft)) `GPL-3.0` `Docker`
- [2FAuth](https://github.com/Bubka/2FAuth) - 管理您的双因素认证 (2FA) 账户并生成其安全码。 ([演示](https://demo.2fauth.app/)) `AGPL-3.0` `PHP/Docker`
- [8mb.local](https://8mb.campuscal.tech/) - Browser-based video compressor ([源代码](https://github.com/JMS1717/8mb.local)) `GPL-3.0` `Docker`
- [Ackify](https://ackify.eu) - Proof of read platform for internal documents ([源代码](https://github.com/kOlapsis/ackify)) `GPL-3.0` `Docker`
- [AdGuardHome Sync](https://github.com/bakito/adguardhome-sync) - Sync AdGuard Home configs across instances `GPL-3.0` `Docker`
...
- [Agregarr](https://github.com/agregarr/agregarr) - Sync Plex Home and Recommended with various sources `GPL-3.0` `Docker`
- [AirPipe](https://airpipe.sanyamgarg.com) - P2P file transfers between devices ([源代码](https://github.com/Sanyam-G/Airpipe)) `GPL-3.0` `Docker`
- [Alexandrie](https://alexandrie-hub.fr) - Modern and elegant note-taking app ([源代码](https://github.com/Smaug6739/Alexandrie)) `GPL-3.0` `Docker`
- [Amurex](https://api.amurex.ai) - Simple yet powerful AI meeting assistant ([源代码](https://github.com/thepersonalaicompany/amurex-backend)) `MIT` `Docker`
- [Anchor](https://github.com/ZhFahim/anchor) - Offline-first note-taking app `GPL-3.0` `Docker`
- [Anchr](https://anchr.io) - 用于互联网小型任务的工具箱，包括书签收集、URL 缩短和（加密）图片上传。 ([源代码](https://github.com/muety/anchr)) `GPL-3.0` `Node.js`
- [AniBridge](https://http://anibridge.eliasbenb.dev) - Sync anime watch activity across platforms ([源代码](https://github.com/anibridge/anibridge)) `GPL-3.0` `Docker`
- [Anonymous Overflow](https://aohub.httpjames.space) - Privacy frontend for StackOverflow ([源代码](https://github.com/httpjamesm/AnonymousOverflow)) `GPL-3.0` `Docker`
- [Anubis](https://anubis.techaro.lol/) - 网络人工智能防火墙实用程序，保护上游资源免受爬虫机器人的侵害。 ([源代码](https://github.com/TecharoHQ/anubis)) `MIT` `Docker/deb/Go`
- [AnyAppStart](https://github.com/aceberg/AnyAppStart) - Basic control panel for Docker, Systemd, VMs, and everything else `Apache-2.0` `Docker`
- [ARA](https://ara.recordsansible.org) - Ansible reporting via command recording ([源代码](https://github.com/ansible-community/ara)) `GPL-3.0` `Docker`
...
- [Astuto](https://github.com/astuto/astuto) - Open source customer feedback tool `Apache-2.0` `Docker`
- [Atlas CMMS](https://atlas-cmms.com) - Powerful maintenance management system ([源代码](https://github.com/Grashjs/cmms)) `GPL-3.0` `Docker`
- [Atlas](https://github.com/karam-ajaj/atlas) - Network discovery, visualization, and monitoring `GPL-3.0` `Docker`
- [Atomic CRM](https://http://marmelab.com/atomic-crm/) - Full-featured customer relationship manager ([源代码](https://github.com/marmelab/atomic-crm)) `GPL-3.0` `Docker`
- [Atria](https://atria.gg) - Professional event management and networking ([源代码](https://github.com/thesubtleties/atria)) `Apache-2.0` `Docker`
- [Atuin](https://atuin.sh) - Sync shell history across devices ([源代码](https://github.com/atuinsh/atuin)) `GPL-3.0` `Docker`
- [AudioBookRequest](https://github.com/markbeep/AudioBookRequest/wiki/) - Audiobook request management ([源代码](https://github.com/markbeep/AudioBookRequest)) `GPL-3.0` `Docker`
- [Aurral](https://aurral.org) - Streamlined artists requests for Lidarr ([源代码](https://github.com/lklynet/aurral)) `GPL-3.0` `Docker`
- [Authgear](https://www.authgear.com) - Turnkey solution for consumer authentication needs ([源代码](https://github.com/authgear/authgear-server)) `GPL-3.0` `Docker`
- [Authman](https://github.com/simular/authman-server) - Cross-platform 2FA TOTP server with mobile and desktop apps `MIT` `Docker`
- [AuthPortal](https://github.com/modom-ofn/auth-portal) - Authentication gateway for Plex, Jellyfin, or Emby `GPL-3.0` `Docker`
- [Autocaliweb](https://codeberg.org/gelbphoenix/autocaliweb) - Clean web interface for Calibre ([源代码](https://github.com/gelbphoenix/autocaliweb)) `GPL-3.0` `Docker`
- [AutoKitteh](https://autokitteh.com) - Developer platform for workflow automation ([源代码](https://github.com/autokitteh/autokitteh)) `GPL-3.0` `Docker`
...
- [BackupPC](https://github.com/backuppc/backuppc) - High-performance backups to a server `GPL-3.0` `Docker`
- [Bazarr](https://www.bazarr.media) - Subtitle manager and downloader with *arr integration ([源代码](https://github.com/morpheus65535/bazarr)) `GPL-3.0` `Docker`
- [BBYEN](https://github.com/MarcelRobitaille/bbyen) - YouTube subscription e-mail notifications `MIT` `Docker`
- [Beatbump](https://beatbump.io/) - Privacy-respecting alternative frontend for YouTube Music ([源代码](https://github.com/snuffyDev/Beatbump)) `Apache-2.0` `Docker`
- [BiblioReads](https://biblioreads.eu.org) - Goodreads frontend focused on privacy ([源代码](https://github.com/nesaku/BiblioReads)) `GPL-3.0` `Docker`
- [BirdNET-Analyzer](https://birdnet-team.github.io/BirdNET-Analyzer/) - Analyze bird calls with machine learning models ([源代码](https://github.com/birdnet-team/BirdNET-Analyzer)) `GPL-3.0` `Docker`
- [bknd](https://bknd.io) - Lightweight Firebase/Supabase alternative ([源代码](https://github.com/bknd-io/bknd)) `GPL-3.0` `Docker`
- [BookHaven](https://github.com/HrBingR/BookHaven) - Browser-based ePub reader `Apache-2.0` `Docker`
- [BookHeaven](https://bookheaven.ggarrido.dev/) - eBook management and reading platform ([源代码](https://github.com/BookHeaven/BookHeaven.Server)) `GPL-3.0` `Docker`
- [BookOrbit](https://bookorbit.app) - Library management and reading platform ([源代码](https://github.com/bookorbit/bookorbit)) `GPL-3.0` `Docker`
- [Borg Backup Server](https://www.borgbackupserver.com) - Centrally manage BorgBackup across endpoints ([源代码](https://github.com/marcpope/borgbackupserver)) `GPL-3.0` `Docker`
- [Borg UI](https://docs.borgui.com) - Modern web interface for Borg Backup ([源代码](https://github.com/karanhudia/borg-ui)) `GPL-3.0` `Docker`
- [Briefing](https://brie.fi/ng) - Secure direct video group chat ([源代码](https://github.com/holtwick/briefing)) `Apache-2.0` `Docker`
- [BroadcastChannel](https://memo.miantiao.me) - Convert a Telegram channel into a microblog ([源代码](https://github.com/miantiao-me/BroadcastChannel)) `GPL-3.0` `Docker`
- [BudgetBee](https://budgetbee.github.io/budgetbee/) - Personal finance management system ([源代码](https://github.com/budgetbee/budgetbee)) `GPL-3.0` `Docker`
- [Bulwark](https://bulwarkmail.org) - Webmail client for Stalwart Mail ([源代码](https://github.com/bulwarkmail/webmail)) `GPL-3.0` `Docker`
- [BunkerM](https://github.com/bunkeriot/BunkerM) - All-in-one Mosquitto (MQTT) broker with web UI `GPL-3.0` `Docker`
- [CaddyManager](https://github.com/caddymanager/caddymanager) - Web interface for managing Caddy `Apache-2.0` `Docker`
- [Calorific](https://github.com/xdpirate/calorific) - Simple self-hosted calorie tracking `Apache-2.0` `Docker`
- [Canine](https://canine.sh) - Easy-to-use and intuitive deployment platform for Kubernetes ([源代码](https://github.com/CanineHQ/canine)) `GPL-3.0` `Docker`
- [Cert Warden](https://www.certwarden.com/) - Centralized certificate management ([源代码](https://github.com/gregtwallace/certwarden)) `GPL-3.0` `Docker`
- [Chatto](https://chatto.run) - Chat app for teams and communities ([源代码](https://github.com/chattocorp/chatto)) `GPL-3.0` `Docker`
- [Chocolatey](https://chocolatey.org/) - Windows 的包管理器。 ([源代码](https://github.com/chocolatey/choco)) `Apache-2.0` `C#/PowerShell`
- [Cially](https://cially.org) - In-depth insights and analytics for Discord servers ([源代码](https://github.com/cially/cially)) `GPL-3.0` `Docker`
- [Cinephage](https://github.com/MoldyTaint/Cinephage) - All-in-one media management app `GPL-3.0` `Docker`
- [circled.me](https://circled.me) - Photo, chat, and sharing community server ([源代码](https://github.com/circled-me/server)) `GPL-3.0` `Docker`
- [Civitai Data Manager](https://github.com/jmsltnv/civitai-data-manager) - Civitai model metadata backups and management `Apache-2.0` `Docker`
- [ClamAV](https://www.clamav.net/) - 开源防病毒引擎，支持文件扫描、恶意软件检测和实时监控。 ([源代码](https://github.com/Cisco-Talos/clamav)) `GPL-3.0` `Docker`
- [Clean Slate](https://cleanslate.sh) - Calorie tracking without judgement ([源代码](https://github.com/successible/cleanslate)) `GPL-3.0` `Docker`
- [Cleanuparr](https://github.com/Cleanuparr/Cleanuparr) - Automated cleanup of unwanted or blocked media files `GPL-3.0` `Docker`
...
- [Cloud Commander](https://cloudcmd.io) - File manager and console for the web ([源代码](https://github.com/coderaiser/cloudcmd)) `GPL-3.0` `Docker`
- [Cloudlog](https://magicbug.co.uk/cloudlog/) - 随时随地记录你的业余无线电联络。 ([源代码](https://github.com/magicbug/cloudlog)) `MIT` `PHP/Docker`
- [Comic Library Utilities](https://clucomics.org) - Toolset for managing large comic libraries ([源代码](https://github.com/allaboutduncan/clu-comics)) `GPL-3.0` `Docker`
- [Compose Craft](https://composecraft.com) - Interface for managing, editing, and sharing Docker Compose files ([源代码](https://github.com/composecraft/composecraft)) `Apache-2.0` `Docker`
- [Configarr](https://configarr.de/) - Simplified config sync for Radarr and Sonarr ([源代码](https://github.com/raydak-labs/configarr)) `GPL-3.0` `Docker`
- [Container Hub](https://github.com/eznix86/docker-registry-ui) - Simple, lightweight UI for container registries `GPL-3.0` `Docker`
- [Convert to it!](https://github.com/p2r3/convert) - Universal online file converter `GPL-3.0` `Docker`
- [ConvertX](https://github.com/C4illin/ConvertX) - 支持超过一千种不同格式的在线文件转换器。 `AGPL-3.0` `Docker`
- [Convos](https://http://convos.chat) - Multi-user IRC client in the browser ([源代码](https://github.com/convos-chat/convos)) `GPL-3.0` `Docker`
- [CoreControl](https://github.com/crocofied/CoreObs) - Server infrastructure management dashboard `GPL-3.0` `Docker`
- [CouchTube](https://couchtube.fly.dev/) - Live TV simulated YouTube frontend ([源代码](https://github.com/ozencb/couchtube)) `GPL-3.0` `Docker`
- [Crontab Guru](https://github.com/cronitorio/cronitor-cli) - Web and CLI-based cron job management `GPL-3.0` `Docker`
- [CrossWatch](https://wiki.crosswatch.app) - Sync media watch statuses across platforms ([源代码](https://github.com/cenodude/CrossWatch)) `GPL-3.0` `Docker`
- [CrowdSec Manager](https://crowdsec-manager.hhf.technology/) - Web-based management interface for CrowdSec ([源代码](https://github.com/hhftechnology/crowdsec_manager)) `GPL-3.0` `Docker`
- [Cryptgeon](https://cryptgeon.org/) - Open source note and file sharing service ([源代码](https://github.com/cupcakearmy/cryptgeon)) `GPL-3.0` `Docker`
- [Cup](https://cup.sergi0g.dev) - Docker container updates made easy ([源代码](https://github.com/sergi0g/cup)) `GPL-3.0` `Docker`
- [Cupdate](https://alexgustafsson.github.io/cupdate/) - Zero-config service for keeping container images up-to-date ([源代码](https://github.com/AlexGustafsson/cupdate)) `GPL-3.0` `Docker`
...
- [DashLit](https://dashlit.cwec.dev/) - Simple server startpage ([源代码](https://github.com/codewec/dashlit)) `MIT` `Docker`
- [Dashwise](https://dashwise-next.vercel.app/) - All-in-one homelab dashboard ([源代码](https://github.com/andreasmolnardev/dashwise)) `GPL-3.0` `Docker`
- [ddclient](https://ddclient.net) - Dynamic DNS updates across a range of services ([源代码](https://github.com/ddclient/ddclient)) `GPL-3.0` `Docker`
- [DeepSubX](https://github.com/garanda21/deepsubx) - Use DeepL API to translate media subtitles `GPL-3.0` `Docker`
- [degoog](https://github.com/degoog-org/degoog) - Search engine aggregator with plugins `GPL-3.0` `Docker`
- [Deployrr](https://www.deployrr.app) - Automated homelab setups using Docker ([源代码](https://github.com/SimpleHomelab/Deployrr)) `GPL-3.0` `Docker`
...
- [Dim](https://github.com/Dusk-Labs/dim) - Media manager and organizer with a minimal setup `Apache-2.0` `Docker`
- [Diskover](https://diskoverdata.com) - File indexer, search engine, and data management platform ([源代码](https://github.com/diskoverdata/diskover-community)) `GPL-3.0` `Docker`
- [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) - IPTV stream and EPG data management `GPL-3.0` `Docker`
- [diyHue](https://diyhue.org/) - Open source Hue Bridge emulator ([源代码](https://github.com/diyhue/diyHue)) `GPL-3.0` `Docker`
- [DOCAT](https://github.com/docat-org/docat) - 托管您的文档。简单。有版本。时尚。 `MIT` `Python/Docker`
- [Dock-Dploy](https://docker-compose.hhf.technology) - Visually build and manage Docker Compose files ([源代码](https://github.com/hhftechnology/Dock-Dploy)) `GPL-3.0` `Docker`
- [Dockcheck](https://github.com/mag37/dockcheck) - CLI tool for Docker container updates and notifications `GPL-3.0` `Docker`
- [docker-php-startpage](https://github.com/loganmarchione/docker-php-startpage) - PHP-based startpage and status monitor in Docker `GPL-3.0` `Docker`
- [Docker Registry Browser](https://github.com/klausmeyer/docker-registry-browser) - Web interface for the Docker Registry HTTP API `GPL-3.0` `Docker`
- [Docker Socket Proxy](https://github.com/Tecnativa/docker-socket-proxy) - Socket proxy for the Docker API `GPL-3.0` `Docker`
- [docker-staticmaps](https://dietrichmax.github.io/docker-staticmaps/) - API for rendering static map images ([源代码](https://github.com/dietrichmax/docker-staticmaps)) `GPL-3.0` `Docker`
- [Docker Volume Backup](https://offen.github.io/docker-volume-backup/) - Backup Docker volumes to compatible storage backends ([源代码](https://github.com/offen/docker-volume-backup)) `GPL-3.0` `Docker`
- [Dockerizalo](https://github.com/undernightcore/dockerizalo) - Simple container deployment and management platform `GPL-3.0` `Docker`
- [DockFlare](https://dockflare.app) - Cloudflare Tunnel controller ([源代码](https://github.com/ChrispyBacon-dev/DockFlare)) `GPL-3.0` `Docker`
- [Dockhand](https://dockhand.pro) - Docker management and orchestration app ([源代码](https://github.com/Finsys/dockhand)) `GPL-3.0` `Docker`
- [Docking Station](https://github.com/LooLzzz/docking-station) - Web app for managing and updating Docker containers `GPL-3.0` `Docker`
- [Dockman](https://dockman.radn.dev/) - Docker Compose file simplification ([源代码](https://github.com/RA341/dockman)) `GPL-3.0` `Docker`
- [Dockpeek](https://github.com/dockpeek/dockpeek) - Dashboard for exposed Docker container ports `Apache-2.0` `Docker`
- [DockTail](https://docktail.org) - Expose containers as Tailscale Services with labels ([源代码](https://github.com/marvinvr/docktail)) `GPL-3.0` `Docker`
- [Dockwatch](https://dockwatch.wiki) - Simple UI for managing container updates and notifications ([源代码](https://github.com/Notifiarr/dockwatch)) `GPL-3.0` `Docker`
- [Doco-CD](https://github.com/kimdre/doco-cd) - Docker Compose continuous deployment `GPL-3.0` `Docker`
- [Docusaurus](https://docusaurus.io) - Easy to maintain open source docs ([源代码](https://github.com/facebook/docusaurus)) `GPL-3.0` `Docker`
- [Doku](https://github.com/amerkurev/doku) - Lightweight web app for analyzing Docker disk usage `Apache-2.0` `Docker`
- [DollarDollar Bill Y'all](https://github.com/harung1993/dollardollar) - Expense tracking and bill-splitting application `GPL-3.0` `Docker`
...
- [Domain Watchdog](https://domainwatchdog.eu) - Monitor and auto-purchase domains when they become available ([源代码](https://github.com/maelgangloff/domain-watchdog)) `GPL-3.0` `Docker`
...
- [Dribdat](https://dribdat.cc) - Self-hosted challenge boards for sweeter hackathons ([源代码](https://github.com/dribdat/dribdat)) `GPL-3.0` `Docker`
- [Drivebase](https://drivebase.io) - Cloud-agnostic file management platform ([源代码](https://github.com/drivebase/drivebase)) `GPL-3.0` `Docker`
- [DroppedNeedle](https://musicseerr.com/) - Music request and discovery for Lidarr ([源代码](https://github.com/DroppedNeedle/DroppedNeedle)) `GPL-3.0` `Docker`
- [DumbAssets](https://dumbassets.dumbware.io) - Stupidly simple asset tracker ([源代码](https://github.com/DumbWareio/DumbAssets)) `Apache-2.0` `Docker`
- [DumbBudget](https://github.com/DumbWareio/DumbBudget) - Stupidly simple personal budget `Apache-2.0` `Docker`
- [DumbDo](https://github.com/DumbWareio/DumbDo) - Stupidly simple to-do list `Apache-2.0` `Docker`
- [DumbDrop](https://github.com/DumbWareio/DumbDrop) - Stupidly simple file uploads `Apache-2.0` `Docker`
- [DumbKan](https://github.com/DumbWareio/DumbKan) - Stupidly simple Kanban boards `MIT` `Docker`
- [DumbPad](https://github.com/DumbWareio/DumbPad) - Stupidly simple modern notepad `Apache-2.0` `Docker`
- [DumbWhoIs](https://dumbwhois.dumbware.io/) - Stupidly simple WHOIS, IP, and ASN lookups ([源代码](https://github.com/DumbWareio/DumbWhoIs)) `GPL-3.0` `Docker`
- [DVinyl](https://kyonew.me/dvinyl) - Collection manager for physical media enthusiasts ([源代码](https://github.com/Kyonew/DVinyl)) `GPL-3.0` `Docker`
- [DweebUI](https://www.dweebui.com/) - Management interface for Docker containers ([源代码](https://github.com/lllllllillllllillll/DweebUI)) `MIT` `Docker`
- [Dynacat](https://dynacat.artur.zone/) - Glance fork with dynamic widget updates ([源代码](https://github.com/Panonim/dynacat)) `GPL-3.0` `Docker`
- [DynamoDB Dashboard](https://github.com/kritish-dhaubanjar/dynamodb-dashboard) - Web GUI dashboard for DynamoDB `GPL-3.0` `Docker`
- [eddrit](https://eddrit.com) - Lightweight alternative frontend for Reddit ([源代码](https://github.com/corenting/eddrit)) `GPL-3.0` `Docker`
- [Edit Mind](https://github.com/IliasHad/edit-mind) - AI-powered video indexing and search `GPL-3.0` `Docker`
- [Elysian](https://github.com/Aadityajoshi151/Elysian) - Backup and sync tool for browser bookmarks `MIT` `Docker`
- [Emoncms](https://emoncms.org) - Process, log, and visualize energy data ([源代码](https://github.com/emoncms/emoncms)) `GPL-3.0` `Docker`
- [Erugo](https://erugo.app) - Easy-to-deploy file sharing app with a sleek interface ([源代码](https://github.com/ErugoOSS/Erugo)) `GPL-3.0` `Docker`
...
- [EteSync](https://www.etesync.com) - Secure syncing for contacts, calendars, tasks, and notes ([源代码](https://github.com/etesync/server)) `MIT` `Docker`
- [ExcaliDash](https://github.com/ZimengXiong/ExcaliDash) - Dashboard and organizer for Excalidraw `GPL-3.0` `Docker`
...
- [Exercise Diary](https://github.com/aceberg/ExerciseDiary) - Workout diary with GitHub-style yearly visualization `MIT` `Docker`
- [Explo](https://github.com/LumePart/Explo) - Music discovery for self-hosted music platforms `GPL-3.0` `Docker`
- [eziwiki](https://github.com/i3months/eziwiki) - Lightweight wiki and documentation generator `Apache-2.0` `Docker`
- [F-Droid](https://f-droid.org) - 用于维护F-Droid存储库系统的服务器工具。 ([源代码](https://gitlab.com/fdroid/fdroidserver)) `AGPL-3.0` `Python/Docker/deb`
- [Fail2Ban-Report](https://github.com/SubleXBle/Fail2Ban-Report) - Web-based dashboard for Fail2Ban logging `Apache-2.0` `Docker`
- [Faridoon](https://jamesread.github.io/Faridoon/) - Save and publish chat quotes for others to see ([源代码](https://github.com/jamesread/Faridoon)) `GPL-3.0` `Docker`
- [Fast Music Remover](https://github.com/omeryusufyagci/fast-music-remover) - Lightweight background music and noise remover `MIT` `Docker`
- [Feedbin](https://feedbin.com) - Simple, fast, and nice looking RSS reader ([源代码](https://github.com/feedbin/feedbin)) `GPL-3.0` `Docker`
- [Feedlynx](https://github.com/wezm/feedlynx) - Generate RSS feeds for links collected via browser extension `Apache-2.0` `Docker`
- [Fenrus](https://github.com/revenz/Fenrus) - Personal home page for quick access to personal apps `GPL-3.0` `Docker`
- [FerriShare](https://github.com/TobiasMarschner/ferrishare) - Simple file sharing app with E2E encryption `Apache-2.0` `Docker`
- [Figranium](https://figranium.dev) - Browser automation and extraction tool ([源代码](https://github.com/figranium/figranium)) `GPL-3.0` `Docker`
- [File Wizard](https://github.com/LoredCast/filewizard) - Browser-based utility for file conversion and transcription `Apache-2.0` `Docker`
- [FileSync](https://filesync.app) - Encrypted, real-time file sharing ([源代码](https://github.com/polius/FileSync)) `GPL-3.0` `Docker`
- [Fireshare](https://fireshare.net) - Share your game clips, videos, or other media via unique links ([源代码](https://github.com/ShaneIsrael/fireshare)) `GPL-3.0` `Docker`
- [Fitbit Health Dashboard](https://github.com/arpanghosh8453/fitbit-grafana) - Script for FitBit data retrieval, storage, and visualization `GPL-3.0` `Docker`
- [Fladder](https://donutware.github.io/Fladder/) - Simple Jellyfin frontend ([源代码](https://github.com/DonutWare/Fladder)) `GPL-3.0` `Docker`
- [FlashPaper](https://github.com/AndrewPaglusch/FlashPaper) - One-time encrypted password and secret sharing `GPL-3.0` `Docker`
- [Fli.so](https://Fli.so) - Lightning-fast URL shortener with a clean interface ([源代码](https://github.com/thisuxhq/fli.so)) `MIT` `Docker`
- [Flint](https://github.com/0xchasercat/flint) - Lightweight tool for managing Linux VMs `GPL-3.0` `Docker`
- [Flow-Like](https://flow-like.com) - Visual workflow automation platform ([源代码](https://github.com/Rheosoph/flow-like)) `GPL-3.0` `Docker`
- [Flox](https://simounet.github.io/flox/) - Self-hosted movie, series, and anime watch list ([源代码](https://github.com/Simounet/flox)) `GPL-3.0` `Docker`
- [FluidCalendar](https://github.com/dotnetfactory/fluid-calendar) - Intelligent task scheduling and calendar management `GPL-3.0` `Docker`
...
- [Foldergram](https://foldergram.github.io) - Instagram-inspired photo and video gallery ([源代码](https://github.com/foldergram/foldergram)) `GPL-3.0` `Docker`
- [FolderHost](https://folderhost.org) - Share files and collaborate with others in real-time ([源代码](https://github.com/MertJSX/folderhost)) `GPL-3.0` `Docker`
- [Forms.md](https://forms.md) - Build multi-step forms and surveys with minimal code ([源代码](https://github.com/formsmd/formsmd)) `MIT` `Docker`
- [Foundry Virtual Tabletop](https://foundryvtt.com/) - Modern roleplaying platform ([源代码](https://github.com/foundryvtt/foundryvtt)) `GPL-3.0` `Docker`
- [Frames](https://github.com/eleven-am/frames) - Modern streaming video on demand platform `MIT` `Docker`
- [Frigate-Notify](https://frigate-notify.0x2142.com/) - Event notifications for a standalone Frigate NVR instance ([源代码](https://github.com/0x2142/frigate-notify)) `Apache-2.0` `Docker`
- [FTPGrab](https://crazymax.dev/ftpgrab/) - Easily grab files periodically from a remote server ([源代码](https://github.com/crazy-max/ftpgrab)) `GPL-3.0` `Docker`
- [Games on Whales](https://games-on-whales.github.io/wolf/stable/) - Stream virtual desktops and games via Docker ([源代码](https://github.com/games-on-whales/wolf)) `GPL-3.0` `Docker`
- [Garage](https://garagehq.deuxfleurs.fr) - S3-compatible object store ([源代码](https://github.com/deuxfleurs-org/garage)) `GPL-3.0` `Docker`
- [Geeftlist](https://codeberg.org/nanawel/geeftlist) - 供朋友和家人之间管理、共享和预定礼物的协作平台。 `GPL-3.0` `Docker`
- [Geoposler](https://github.com/garanda21/geoposler) - E-mail campaign management application `GPL-3.0` `Docker`
- [GeoPulse](https://tess1o.github.io/geopulse/) - Location tracking and analysis platform ([源代码](https://github.com/tess1o/geopulse)) `GPL-3.0` `Docker`
- [Ghostboard](https://github.com/jon6fingrs/ghostboard) - Real-time synchronized text sharing `MIT` `Docker`
- [GhostFile](https://github.com/jon6fingrs/ghostfile) - Lightweight, one-time file upload server `MIT` `Docker`
- [GiftManager](https://github.com/icbestCA/giftmanager) - Gift idea manager for families `GPL-3.0` `Docker`
- [Git-Sync](https://github.com/AkashRajpurohit/git-sync/wiki) - Backup and sync tool for git repositories ([源代码](https://github.com/AkashRajpurohit/git-sync)) `GPL-3.0` `Docker`
- [GitSave](https://github.com/TimWitzdam/GitSave) - Easily back up git repositories on a schedule `Apache-2.0` `Docker`
- [Glass Keep](https://github.com/nikunjsingh93/react-glass-keep) - Glassy Keep-style notes app `Apache-2.0` `Docker`
- [Global Threat Map](https://github.com/unicodeveloper/globalthreatmap) - Real-time global situational awareness map `GPL-3.0` `Docker`
- [Gmail Cleaner](https://gururagavendra.github.io/gmail-cleaner/) - Web-based GUI for cleaning Gmail inboxes ([源代码](https://github.com/Gururagavendra/gmail-cleaner)) `GPL-3.0` `Docker`
- [GoAway](https://pommee.github.io/goaway/) - Lightweight DNS sinkhole for blocking unwanted domains ([源代码](https://github.com/pommee/goaway)) `GPL-3.0` `Docker`
- [GoMFT](https://github.com/StarFleetCPTN/GoMFT) - Web-based file transfer application `MIT` `Docker`
...
- [Gravity](https://gravity.beryju.io) - DNS and DHCP server with ad-blocking ([源代码](https://github.com/BeryJu/gravity)) `GPL-3.0` `Docker`
- [Grimmory](https://grimmory.org) - Digital library organization and access ([源代码](https://github.com/grimmory-tools/grimmory)) `GPL-3.0` `Docker`
- [Grimoire](https://github.com/goniszewski/grimoire) - Bookmark manager for wizards `MIT` `Docker`
- [GrowChief](https://growchief.com) - Ultimate social media automation tool ([源代码](https://github.com/growchief/growchief)) `Apache-2.0` `Docker`
- [Guardian](https://github.com/HydroshieldMKII/Guardian) - Security and management app for Plex `GPL-3.0` `Docker`
- [HA Time Machine](https://github.com/saihgupr/HomeAssistantTimeMachine) - Web-based time machine tool for Home Assistant configs `GPL-3.0` `Docker`
- [Habitat](https://gethabitat.org) - Social platform for local communities ([源代码](https://github.com/carlnewton/habitat)) `GPL-3.0` `Docker`
...
- [HabitSync](https://github.com/jofoerster/habitsync) - Powerful habit tracking app with social features `GPL-3.0` `Docker`
- [HabitTrove](https://demo.habittrove.com/) - Gamified habit tracking application for building positive habits ([源代码](https://github.com/dohsimpson/HabitTrove)) `GPL-3.0` `Docker`
- [Haptic](https://haptic.md) - Local-first, privacy-focused home for Markdown notes ([源代码](https://github.com/chroxify/haptic)) `Apache-2.0` `Docker`
- [Hollo](https://docs.hollo.social/) - Federated single-user microblogging software ([源代码](https://github.com/fedify-dev/hollo)) `GPL-3.0` `Docker`
- [HomeTube](https://github.com/EgalitarianMonkey/hometube) - Universal internet video downloader `GPL-3.0` `Docker`
- [Honey](https://demos-honey.djank.me/) - A nice and sweet place for your self-hosted services ([源代码](https://github.com/dani3l0/honey)) `GPL-3.0` `Docker`
- [Hoodik](https://github.com/hudikhq/hoodik) - Lightweight and secure cloud storage solution `GPL-3.0` `Docker`
- [HortusFox](https://hortusfox.github.io) - 协作式植物管理与追踪系统，适合植物爱好者。 ([源代码](https://github.com/danielbrendel/hortusfox-web)) `MIT` `PHP/Docker`
- [html2rss](https://html2rss.github.io/web-application/) - Generate RSS feeds for any website ([源代码](https://github.com/html2rss/html2rss-web)) `GPL-3.0` `Docker`
- [HymnoScribe](https://hymnoscribe.de) - Comprehensive tool for creating hymn sheets ([源代码](https://github.com/Revisor01/HymnoScribe)) `Apache-2.0` `Docker`
- [Hyvor Relay](https://relay.hyvor.com) - E-mail API for developers ([源代码](https://github.com/hyvor/relay)) `GPL-3.0` `Docker`
- [Ignidash](https://ignidash.com) - Personal finance planning app ([源代码](https://github.com/schelskedevco/ignidash)) `GPL-3.0` `Docker`
- [Imagor Studio](https://imagor.net) - Image gallery and live editing web app ([源代码](https://github.com/cshum/imagor-studio)) `GPL-3.0` `Docker`
...
- [Immich Drop](https://github.com/Nasogaa/immich-drop) - Tiny, zero-login web app for collecting media for Immich `GPL-3.0` `Docker`
- [Immich-Frame](https://github.com/immichFrame/ImmichFrame) - Awesome way to display photos as a digital photo frame `GPL-3.0` `Docker`
- [Immich Power Tools](https://immich-power-tools.featureos.app/) - Power tools for organizing Immich libraries ([源代码](https://github.com/immich-power-tools/immich-power-tools)) `GPL-3.0` `Docker`
- [Immich Public Proxy](https://github.com/alangrainger/immich-public-proxy) - Share Immich assets without exposing the instance to the public `GPL-3.0` `Docker`
...
- [Investbrain](https://investbra.in) - Manage and track investment portfolio performance ([源代码](https://github.com/investbrainapp/investbrain)) `GPL-3.0` `Docker`
- [Invio](https://invio.dev) - Minimalist invoicing without the bloat ([源代码](https://github.com/kittendevv/Invio)) `GPL-3.0` `Docker`
- [Invoice Builder](https://github.com/piratuks/invoice-builder) - Invoice and quoting app for freelancers `GPL-3.0` `Docker`
- [Invoicerr](https://docs.invoicerr.app/) - Invoicing app for freelancers ([源代码](https://github.com/invoicerr-app/invoicerr)) `GPL-3.0` `Docker`
- [IronCalc](https://www.ironcalc.com) - Modern in-browser spreadsheet engine ([源代码](https://github.com/ironcalc/IronCalc)) `GPL-3.0` `Docker`
- [Iso](https://iso.tim.cv) - Plug-and-play dashboard ([源代码](https://github.com/Coyenn/iso)) `Apache-2.0` `Docker`
- [iSponsorBlockTV](https://github.com/dmunozv04/iSponsorBlockTV) `⚠` - 阻止和跳过赞助内容，同时在 YouTube 上静音和跳过广告。 `GPL-3.0` `Docker/Python`
- [It's MyTabs](https://github.com/louislam/its-mytabs) - Guitar tab viewer and player `GPL-3.0` `Docker`
...
- [Jellyfin Rewind](https://jellyfin-rewind.chaphasilor.xyz) - A year-in-review app for Jellyfin music listeners ([源代码](https://github.com/Chaphasilor/jellyfin-rewind)) `GPL-3.0` `Docker`
- [Jellyplist](https://github.com/kamilkosek/jellyplist) - Sync Spotify playlists to Jellyfin `Apache-2.0` `Docker`
- [Jellystat](https://github.com/CyferShepard/Jellystat) - Open source statistics app for Jellyfin `GPL-3.0` `Docker`
- [Jellyswarrm](https://github.com/LLukas22/Jellyswarrm) - Combine multiple Jellyfin servers into one library `GPL-3.0` `Docker`
- [Jellysweep](https://github.com/jon4hz/jellysweep) - Smart cleanup tool for Jellyfin media servers `GPL-3.0` `Docker`
...
- [Journiv](https://www.journiv.com) - Private journaling app ([源代码](https://github.com/journiv/journiv-app)) `GPL-3.0` `Docker`
- [Kanba](https://kanba.co) - Project management and collaboration ([源代码](https://github.com/Kanba-co/kanba)) `GPL-3.0` `Docker`
- [Karakeep HomeDash](https://github.com/CodeJawn/karakeep-homedash) - Compact dashboard view for Karakeep `MIT` `Docker`
...
- [Kill-the-Newsletter](https://kill-the-newsletter.com) - Convert email newsletters into Atom feeds ([源代码](https://github.com/leafac/kill-the-newsletter)) `GPL-3.0` `Docker`
- [Kite](https://github.com/kite-org/kite) - Lightweight Kubernetes dashboard `GPL-3.0` `Docker`
- [Kitsu](https://kitsu.cg-wire.com) - Collaboration platform for VFX and animation ([源代码](https://github.com/cgwire/kitsu)) `GPL-3.0` `Docker`
- [Koffan](https://github.com/PanSalut/Koffan) - Shopping lists for families and couples `GPL-3.0` `Docker`
...
- [Koito](https://koito.io) - Modern music scrobbler ([源代码](https://github.com/gabehf/Koito)) `GPL-3.0` `Docker`
- [Kontoj](https://kontoj.galaksio.tech) - Tool for creating account credentials for multiple services via JSON ([源代码](https://github.com/galaksiotech/kontoj)) `MIT` `Docker`
- [KrakenD](https://www.krakend.io) - API gateway for microservices and communications ([源代码](https://github.com/krakend/krakend-ce)) `GPL-3.0` `Docker`
- [Kriti Images](https://kritiimages.com) - Image transformation service for real-time processing ([源代码](https://github.com/kritihq/kriti-images)) `Apache-2.0` `Docker`
- [Ktistec](https://github.com/toddsundsted/ktistec) - Single-user ActivityPub server `GPL-3.0` `Docker`
- [Kubetail](https://www.kubetail.com) - Real-time logging dashboard for Kubernetes ([源代码](https://github.com/kubetail-org/kubetail)) `GPL-3.0` `Docker`
- [Lab Dash](https://github.com/AnthonyGress/lab-dash) - Application and server management dashboard `GPL-3.0` `Docker`
- [LANCommander](https://lancommander.app) - Open source video game distribution platform ([源代码](https://github.com/LANCommander/LANCommander)) `GPL-3.0` `Docker`
...
- [Laudspeaker](https://laudspeaker.com/?ref=github) - Customer and product engagement platform ([源代码](https://github.com/laudspeaker/laudspeaker)) `GPL-3.0` `Docker`
- [LetterFeed](https://github.com/LeonMusCoden/LetterFeed) - Transform e-mail into RSS feeds `GPL-3.0` `Docker`
...
- [Librum](https://librumreader.com) - Ebook reader and manager ([源代码](https://github.com/Librum-Reader/Librum)) `MIT` `Docker`
- [Lingarr](https://github.com/lingarr-translate/lingarr) - Automatically translate subtitle files to a desired language `GPL-3.0` `Docker`
- [LinguaCafe](https://simjanos-dev.github.io/LinguaCafeHome/) - Self-hosted software that helps language learners acquire vocabulary through reading ([源代码](https://github.com/simjanos-dev/LinguaCafe)) `MIT` `Docker`
- [Liquor Locker](https://github.com/nguyenjessev/liquor-locker) - Bar management with AI-powered recommendations `Apache-2.0` `Docker`
- [Listenarr](https://getlistenarr.com) - Automated audiobook management ([源代码](https://github.com/Listenarrs/Listenarr)) `GPL-3.0` `Docker`
- [Live Blog](https://www.sourcefabric.org/software/liveblog) - Live blogging platform for professionals ([源代码](https://github.com/liveblog/liveblog)) `GPL-3.0` `Docker`
- [Lodestone](https://www.lodestone.cc/) - Hosting tool for Minecraft and other multiplayer games ([源代码](https://github.com/Lodestone-Team/lodestone)) `MIT` `Docker`
- [Logchef](https://logchef.app/) - Lightweight log analytics platform ([源代码](https://github.com/mr-karan/logchef)) `GPL-3.0` `Docker`
- [Logdy](https://logdy.dev) - Web-based real-time log viewer ([源代码](https://github.com/logdyhq/logdy-core)) `Apache-2.0` `Docker`
- [LogForge](https://www.logforge.dev/) - Service monitoring dashboard for Docker containers ([源代码](https://github.com/log-forge/logforge)) `GPL-3.0` `Docker`
- [LoggiFly](https://clemcer.github.io/LoggiFly/) - Docker container log monitoring and notifications ([源代码](https://github.com/clemcer/LoggiFly)) `GPL-3.0` `Docker`
- [Loops](https://joinloops.org) - Federated short video sharing platform ([源代码](https://github.com/joinloops/loops-server)) `GPL-3.0` `Docker`
- [Lowcoder](https://www.lowcoder.cloud/) - Rapid business app builder with minimal coding ([源代码](https://github.com/lowcoder-org/lowcoder)) `Apache-2.0` `Docker`
...
- [Lufin](https://github.com/VityaSchel/lufin) - Modern file sharing service `Apache-2.0` `Docker`
- [Luna](https://github.com/Opisek/luna) - Calendar frontend and aggregator `GPL-3.0` `Docker`
- [Lunalytics](https://lunalytics.xyz) - Open source uptime monitoring tool ([源代码](https://github.com/KSJaay/Lunalytics)) `GPL-3.0` `Docker`
- [Lunar](https://lunarphp.com) - Modern headless e-commerce platform ([源代码](https://github.com/lunarphp/lunar)) `GPL-3.0` `Docker`
- [lurker](https://github.com/oppiliappan/lurker) - Read-only Reddit frontend with mobile support `GPL-3.0` `Docker`
- [Lute](https://github.com/LuteOrg/lute-v3) - Learn new languages through reading `GPL-3.0` `Docker`
- [m3u-editor](https://github.com/m3ue/m3u-editor) - IPTV playlist filtering and editing `GPL-3.0` `Docker`
- [MailFlow](https://mailflow.sh) - Unified webmail client ([源代码](https://github.com/maathimself/mailflow)) `GPL-3.0` `Docker`
- [Mailpit](https://mailpit.axllent.org) - 面向开发者的电子邮件测试和调试工具。 ([源代码](https://github.com/axllent/mailpit)) `GPL-3.0` `Docker`
- [Maintainerr](https://maintainerr.info) - Monitor and remove unwatched Plex media ([源代码](https://github.com/Maintainerr/Maintainerr)) `GPL-3.0` `Docker`
- [Maintenant](https://maintenant.dev) - Monitor everything with a single container ([源代码](https://github.com/kOlapsis/maintenant)) `GPL-3.0` `Docker`
- [Maloja](https://maloja.krateng.ch) - Music scrobble database for personal listening ([源代码](https://github.com/krateng/maloja)) `MIT` `Docker`
- [Managarr](https://github.com/Dark-Alex-17/managarr) - TUI and CLI tool for managing *arr apps `GPL-3.0` `Docker`
- [Mantium](https://github.com/diogovalentte/mantium) - Manga tracking dashboard from multiple sources `GPL-3.0` `Docker`
- [Mantrae](https://mantrae.pages.dev) - User-friendly Traefik management interface ([源代码](https://github.com/MizuchiLabs/mantrae)) `GPL-3.0` `Docker`
- [Markopolis](https://markopolis.app) - Web app and API server for Markdown files ([源代码](https://github.com/rishikanthc/markopolis)) `MIT` `Docker`
- [Marreta](https://marreta.link) - Tool for analyzing, cleaning, and tidying up web URLs ([源代码](https://github.com/manualdousuario/marreta)) `GPL-3.0` `Docker`
- [Materialious](https://materialio.us) - Modern Material Design frontend for Invidious ([源代码](https://github.com/Materialious/Materialious)) `GPL-3.0` `Docker`
- [Mazanoke](https://MAZANOKE.com) - Local image compression in the browser ([源代码](https://github.com/civilblur/mazanoke)) `GPL-3.0` `Docker`
- [Mbin](https://joinmbin.org) - Federated content aggregator and microblogging platform ([源代码](https://github.com/MbinOrg/mbin)) `GPL-3.0` `Docker`
- [MedAssist](https://github.com/njic/medassist) - Daily medication reminders and management `MIT` `Docker`
- [Medialytics](https://github.com/Drewpeifer/medialytics) - Plex media server statistics `GPL-3.0` `Docker`
- [MediaLyze](https://www.medialyze.app) - Media library analysis for large collections ([源代码](https://github.com/frederikemmer/MediaLyze)) `GPL-3.0` `Docker`
- [MediaManager](https://github.com/maxdorninger/MediaManager) - TV and movie library manager `GPL-3.0` `Docker`
- [MediKeep](https://github.com/afairgiant/MediKeep) - Personal health record keeper `GPL-3.0` `Docker`
- [Meerkat CRM](https://fbuchner.github.io/meerkat-crm/) - Simple CRM for the personal life ([源代码](https://github.com/fbuchner/meerkat-crm)) `GPL-3.0` `Docker`
- [Meet](https://visio.numerique.gouv.fr) - HD video calls, screen sharing, and chats directly from the browser ([源代码](https://github.com/suitenumerique/meet)) `GPL-3.0` `Docker`
- [Melody Auth](https://auth.valuemelody.com/) - Effortless authentication built for flexibility and control ([源代码](https://github.com/ValueMelody/melody-auth)) `GPL-3.0` `Docker`
- [Mergeable](https://www.usemergeable.dev) - Better inbox for GitHub pull requests ([源代码](https://github.com/pvcnt/mergeable)) `MIT` `Docker`
- [Meshping](https://github.com/Svedrin/meshping) - Ping any number of targets and collect response times `GPL-3.0` `Docker`
- [Metadata Remote](https://github.com/wow-signal-dev/metadata-remote) - Web-based metadata manager for audio files `Apache-2.0` `Docker`
- [Middleware Manager](https://github.com/hhftechnology/middleware-manager) - Traefik middleware, router, and server manager `GPL-3.0` `Docker`
- [Mindwtr](https://mindwtr.app) - Getting-things-done productivity system ([源代码](https://github.com/dongdongbh/Mindwtr)) `GPL-3.0` `Docker`
- [Mini QR](https://github.com/lyqht/mini-qr) - Scan and generate customized QR codes easily `GPL-3.0` `Docker`
- [Minne](https://github.com/perstarkse/minne) - Read-later and personal knowledge management `GPL-3.0` `Docker`
- [MinusPod](https://github.com/ttlequals0/MinusPod) - Podcast server with automatic ad removal `GPL-3.0` `Docker`
- [mkcert Web UI](https://github.com/jeffcaldwellca/mkcertWeb) - Modern web interface for mkcert `GPL-3.0` `Docker`
- [Moocup](https://github.com/jellydeck/moocup) - Visual editor for stunning screenshots `GPL-3.0` `Docker`
- [Moodist](https://github.com/remvze/moodist) - Ambient sounds for focus and calm `GPL-3.0` `Docker`
...
- [MQTT Web Interface](https://github.com/terdia/mqttui) - Lightweight web interface for MQTT visualization `GPL-3.0` `Docker`
- [Music Service](https://thijstakken.github.io/MusicService/) - Monitor, download, and sync online music ([源代码](https://github.com/thijstakken/MusicService)) `GPL-3.0` `Docker`
- [MyBibliotheca](https://github.com/pickles4evaaaa/mybibliotheca) - Personal library and reading tracker `GPL-3.0` `Docker`
- [Mydia](https://github.com/getmydia/mydia) - Media management platform `GPL-3.0` `Docker`
- [myDrive](https://github.com/subnub/myDrive) - Open source cloud file storage server `MIT` `Docker`
- [Nametag](https://github.com/mattogodoy/nametag) - Simple personal relationship manager `GPL-3.0` `Docker`
- [Nanote](https://github.com/omarmir/nanote) - Lightweight note-taking app `GPL-3.0` `Docker`
- [Neko](https://neko.m1k1o.net) - 在 Docker 中运行并使用 WebRTC 的虚拟浏览器。 ([源代码](https://github.com/m1k1o/neko)) `Apache-2.0` `Docker/Go`
- [NeoDB](https://neodb.net) - Federated tracking server ([源代码](https://github.com/neodb-social/neodb)) `GPL-3.0` `Docker`
- [NextBeats](https://nextbeats.vercel.app) - Modern, customizable lofi music player ([源代码](https://github.com/btahir/next-beats)) `Apache-2.0` `Docker`
- [Nextcloud Deck](https://apps.nextcloud.com/apps/deck) - Kanban-style project management app for Nextcloud ([源代码](https://github.com/nextcloud/deck)) `GPL-3.0` `Docker`
- [Nextcloud Forms](https://apps.nextcloud.com/apps/forms) - Simple form and survey app for Nextcloud ([源代码](https://github.com/nextcloud/forms)) `GPL-3.0` `Docker`
- [Nextcloud Mail](https://apps.nextcloud.com/apps/mail) - Email application for Nextcloud ([源代码](https://github.com/nextcloud/mail)) `GPL-3.0` `Docker`
- [Nextcloud News](https://apps.nextcloud.com/apps/news) - RSS/Atom feed reader ([源代码](https://github.com/nextcloud/news)) `GPL-3.0` `Docker`
- [Nextcloud Notes](https://apps.nextcloud.com/apps/notes) - Distraction-free notes and writing ([源代码](https://github.com/nextcloud/notes)) `GPL-3.0` `Docker`
- [Nextcloud Office](https://nextcloud.com/collaboraonline) - Collabora Online integration for Nextcloud ([源代码](https://github.com/nextcloud/richdocuments)) `GPL-3.0` `Docker`
- [Nextcloud Social](https://apps.nextcloud.com/apps/social) - Nextcloud app for federated networking ([源代码](https://github.com/nextcloud/social)) `GPL-3.0` `Docker`
- [Nextcloud Tables](https://apps.nextcloud.com/apps/tables) - No-code apps and tables ([源代码](https://github.com/nextcloud/tables)) `GPL-3.0` `Docker`
- [Nextcloud Talk](https://nextcloud.com/talk) - Chat, video, and audio calls for Nextcloud ([源代码](https://github.com/nextcloud/spreed)) `GPL-3.0` `Docker`
- [Nextcloud Tasks](https://apps.nextcloud.com/apps/tasks) - Tasks app for Nextcloud ([源代码](https://github.com/nextcloud/tasks)) `GPL-3.0` `Docker`
- [Nexterm](https://nexterm.dev) - Server management software for SSH, VNC, and RDP ([源代码](https://github.com/gnmyt/Nexterm)) `GPL-3.0` `Docker`
- [NextExplorer](https://explorer.nxz.ai) - Modern web-based file explorer ([源代码](https://github.com/nxzai/NextExplorer)) `GPL-3.0` `Docker`
- [nforwardauth](https://github.com/nosduco/nforwardauth) - Simple and minimalist forward auth service intended for use with reverse proxies `GPL-3.0` `Docker`
- [Nimtable](https://github.com/nimtable/nimtable) - Web interface for Apache Iceberg `Apache-2.0` `Docker`
- [Nixopus](https://nixopus.com) - Deploy, manage, and scale infrastructure ([源代码](https://github.com/nixopus/nixopus)) `GPL-3.0` `Docker`
- [nodecast-tv](https://github.com/technomancer702/nodecast-tv) - Web-based IPTV player `GPL-3.0` `Docker`
- [Norish](https://github.com/norish-recipes/norish) - Real-time recipe app for families and friends `GPL-3.0` `Docker`
- [Nortix Mail](https://github.com/Zhoros/NortixMail) - Disposable e-mail server with an easy configuration `GPL-3.0` `Docker`
- [NoteDiscovery](https://www.notediscovery.com) - Lightweight Obsidian-like note-taking app ([源代码](https://github.com/gamosoft/NoteDiscovery)) `GPL-3.0` `Docker`
- [Notifiarr](https://notifiarr.wiki) - Monitoring and notifications via Discord ([源代码](https://github.com/Notifiarr/notifiarr)) `GPL-3.0` `Docker`
- [Notifuse](https://www.notifuse.com) - Platform for sending newsletters and transactional mail ([源代码](https://github.com/Notifuse/notifuse)) `GPL-3.0` `Docker`
- [NPMplus](https://github.com/ZoeyVid/NPMplus) - Nginx Proxy Manager with improvements `GPL-3.0` `Docker`
- [NPS Enhanced](https://d-jy.net/docs/nps/) - Lightweight NAT traversal and reverse proxy ([源代码](https://github.com/djylb/nps)) `GPL-3.0` `Docker`
- [Nutify](https://github.com/DartSteven/Nutify) - Modern web-based UPS monitoring `GPL-3.0` `Docker`
- [NutriTrace](https://github.com/TraceApps/nutritrace) - Personal nutrition tracker `GPL-3.0` `Docker`
- [Nzb DAV](https://github.com/nzbdav-dev/nzbdav) - Virtually mount NZB files for direct streaming `GPL-3.0` `Docker`
- [NZBGet](https://nzbget.com) - Fast, reliable, and feature-packed NZB downloader ([源代码](https://github.com/nzbgetcom/nzbget)) `GPL-3.0` `Docker`
- [Obico](https://obico.io) - Smart 3D printing platform with AI failure detection ([源代码](https://github.com/TheSpaghettiDetective/obico-server)) `GPL-3.0` `Docker`
- [Obskurnee](https://github.com/zblesk/obskurnee) - Book club companion for voting on upcoming books `Apache-2.0` `Docker`
- [Octelium](https://octelium.com/docs) - Unified zero trust secure access platform ([源代码](https://github.com/octelium/octelium)) `GPL-3.0` `Docker`
- [Octo-Fiesta](https://github.com/V1ck3s/octo-fiesta) - Subsonic proxy for integrating streaming providers as music sources `GPL-3.0` `Docker`
- [OmniPoly](https://github.com/kWeglinski/OmniPoly) - Frontend for LanguageTool and LibreTranslate with AI translation `GPL-3.0` `Docker`
...
- [Omoide](https://github.com/EinAeffchen/Omoide) - Photo and video library with AI features `GPL-3.0` `Docker`
- [Ontime](https://www.getontime.no) - Timers for event rundowns, scheduling, and cueing ([源代码](https://github.com/cpvalente/ontime)) `GPL-3.0` `Docker`
- [onWatch](https://onwatch.onllm.dev) - Real-time API quota tracking across AI platforms ([源代码](https://github.com/onllm-dev/onWatch)) `GPL-3.0` `Docker`
- [Open DroneLog](https://www.opendronelog.com) - Drone flight log analyzer and dashboard ([源代码](https://github.com/arpanghosh8453/open-dronelog)) `GPL-3.0` `Docker`
...
- [Openchangelog](https://openchangelog.com) - Easy to configure and self-hostable changelog website ([源代码](https://github.com/JonasHiltl/openchangelog)) `GPL-3.0` `Docker`
- [OpenCut](https://opencut.app) - Video editor for web, desktop, and mobile ([源代码](https://github.com/OpenCut-app/OpenCut)) `GPL-3.0` `Docker`
- [OpenPanel](https://openpanel.com) - Powerful and flexible web hosting control panel for Linux ([源代码](https://github.com/stefanpejcic/OpenPanel)) `GPL-3.0` `Docker`
...
- [Openreads](https://github.com/mateusz-bak/openreads) - Privacy-oriented and cross-platform book tracking app `Apache-2.0` `Docker`
- [OpenTogetherTube](https://opentogethertube.com) - Remote YouTube watch parties ([源代码](https://github.com/dyc3/opentogethertube)) `GPL-3.0` `Docker`
- [OpenUEM](https://openuem.eu) - Unified endpoint and IT asset manager ([源代码](https://github.com/open-uem/openuem-console)) `GPL-3.0` `Docker`
...
- [Operately](https://operately.com) - Startup platform for managing projects, goals, and processes ([源代码](https://github.com/operately/operately)) `GPL-3.0` `Docker`
...
- [OrigamiVault](https://github.com/origamivault/origamivault) - Encrypt secrets and share them with QR codes `GPL-3.0` `Docker`
- [osTicket](https://osticket.com) - Open source support ticket system ([源代码](https://github.com/osTicket/osTicket)) `GPL-3.0` `Docker`
- [Overr-Syncerr](https://github.com/gssariev/overr-syncerr) - Webhook handler for subtitle management `Apache-2.0` `Docker`
- [Owlistic](https://owlistic-notes.github.io/owlistic/) - Real-time note-taking and to-do app ([源代码](https://github.com/owlistic-notes/owlistic)) `MIT` `Docker`
- [ownCloud Infinite Scale](https://doc.owncloud.com/ocis/) - File sync and share platform ([源代码](https://github.com/owncloud/ocis)) `GPL-3.0` `Docker`
- [OwnTracks Frontend](https://github.com/owntracks/frontend) - Advanced interface for the OwnTracks ecosystem `MIT` `Docker`
- [OxiCloud](https://atalayalabs.github.io/OxiCloud/) - Efficient and secure cloud storage ([源代码](https://github.com/AtalayaLabs/OxiCloud)) `GPL-3.0` `Docker`
- [Oxker](https://github.com/mrjackwills/oxker) - Manage and control Docker containers from the terminal `GPL-3.0` `Docker`
- [pad.ws](https://github.com/coderamp-labs/pad.ws) - Whiteboard IDE in the browser `MIT` `Docker`
- [Panora](https://panora.dev) - API endpoints for a catalogue of integrations for SaaS software ([源代码](https://github.com/panoratech/Panora)) `Apache-2.0` `Docker`
- [Parseable](https://parseable.com) - Log analytics system for high throughput log ingestion ([源代码](https://github.com/parseablehq/parseable)) `GPL-3.0` `Docker`
- [PASTA](https://www.pastatool.com) - Audio and subtitle track changer for Plex ([源代码](https://github.com/cglatot/pasta)) `GPL-3.0` `Docker`
- [PatchMon](https://patchmon.net) - Linux patch monitoring made simple ([源代码](https://github.com/PatchMon/PatchMon)) `GPL-3.0` `Docker`
- [PatchPanda](https://github.com/dkorecko/PatchPanda) - Docker Compose stack update manager `GPL-3.0` `Docker`
- [PeaNUT](https://github.com/Brandawg93/PeaNUT) - Tiny dashboard for network UPS tools `GPL-3.0` `Docker`
- [Peekaping](https://github.com/0xfurai/peekaping) - Modern uptime monitoring solution `GPL-3.0` `Docker`
- [penpot](https://penpot.app/) - 面向跨领域团队的基于 Web 的设计和原型制作平台。 ([源代码](https://github.com/penpot/penpot)) `MPL-2.0` `Docker`
- [Pepperminty Wiki](https://peppermint.mooncarrot.space/) - Complete wiki engine contained in a single file ([源代码](https://github.com/sbrl/Pepperminty-Wiki)) `GPL-3.0` `Docker`
- [Perfice](https://perfice.adoe.dev) - Self-tracking platform for various life metrics ([源代码](https://github.com/p0lloc/perfice)) `GPL-3.0` `Docker`
- [Perses](https://perses.dev) - Declarative dashboard for observability visualization ([源代码](https://github.com/perses/perses)) `GPL-3.0` `Docker`
- [Petio](https://petio.tv) - Request, review, and discover companion app for Plex ([源代码](https://github.com/petio-team/petio)) `MIT` `Docker`
- [PG Back Web](https://github.com/eduardolat/pgbackweb) - Effortless PostgreSQL backups with a user-friendly web interface `Apache-2.0` `Docker`
- [pgAdmin](https://www.pgadmin.org) - Administration and development platform for PostgreSQL ([源代码](https://github.com/pgadmin-org/pgadmin4)) `GPL-3.0` `Docker`
- [PigeonPod](https://pigeonpod.cloud) - Turn YouTube channels into podcasts ([源代码](https://github.com/aizhimou/pigeon-pod)) `GPL-3.0` `Docker`
- [Piglet](https://github.com/k3nd0x/piglet) - Simple web app for managing household budgets `MIT` `Docker`
- [Pinkary](https://pinkary.com) - Federated landing page for links and connecting with others without the noise ([源代码](https://github.com/pinkary-project/pinkary.com)) `GPL-3.0` `Docker`
- [Pixelfin](https://github.com/nothing2obvi/pixelfin) - Create HTML galleries from Jellyfin photo libraries `GPL-3.0` `Docker`
- [PlanarAlly](https://www.planarally.io/) - Virtual tabletop with offline capabilities ([源代码](https://github.com/Kruptein/PlanarAlly)) `GPL-3.0` `Docker`
- [Plex Rewind](https://github.com/RaunoT/plex-rewind) - Present Plex user statistics and habits in a beautiful and organized manner `GPL-3.0` `Docker`
- [PlikShare](https://plikshare.com) - Self-hosted file sharing solution ([源代码](https://github.com/damian-krychowski/plikshare)) `GPL-3.0` `Docker`
- [Pluton](https://usepluton.com) - Secure backups across local and cloud storage ([源代码](https://github.com/plutonhq/pluton)) `GPL-3.0` `Docker`
- [Podsync](https://github.com/mxpv/podsync) - Turn Youtube channels into podcast feeds `GPL-3.0` `Docker`
- [PoeticMetric](https://poeticmetric.com) - Privacy-focused web analytics ([源代码](https://github.com/th0th/poeticmetric)) `GPL-3.0` `Docker`
- [POMjs](https://password.oppetmoln.se/) - 随机密码生成器。 ([源代码](https://github.com/joho1968/POMjs)) `GPL-2.0` `JavaScript`
- [Portall](https://github.com/need4swede/Portall) - Generate, track, and organize container ports across multiple hosts `MIT` `Docker`
- [PortChecker](https://portchecker.io) - Port status queries for provided hostnames or IP addresses ([源代码](https://github.com/dsgnr/portchecker.io)) `GPL-3.0` `Docker`
- [PortNote](https://github.com/crocofied/PortNote) - Port tracking interface `MIT` `Docker`
- [portracker](https://github.com/mostafa-wahied/portracker) - Real-time port monitoring and discovery `GPL-3.0` `Docker`
- [positive-intentions Chat](https://github.com/positive-intentions/chat) - Decentralized chat in the browser `GPL-3.0` `Docker`
- [Posteria](https://posteria.app) - Web-based media poster management system ([源代码](https://github.com/jeremehancock/Posteria)) `GPL-3.0` `Docker`
- [Postmarks](https://postmarks.glitch.me) - Single-user bookmarking for the Fediverse ([源代码](https://github.com/ckolderup/postmarks)) `GPL-3.0` `Docker`
- [Poznote](https://poznote.com) - Personal note-taking and documentation platform ([源代码](https://github.com/timothepoznanski/poznote)) `GPL-3.0` `Docker`
- [Private Captcha](https://privatecaptcha.com) - Independent, privacy-first CAPTCHA service ([源代码](https://github.com/PrivateCaptcha/PrivateCaptcha)) `GPL-3.0` `Docker`
- [Priviblur](https://github.com/syeopite/priviblur) - Privacy-focused alternative frontend to Tumblr `Apache-2.0` `Docker`
- [Profilarr](https://dictionarry.dev) - Import, export, and sync profiles and custom formats via Radarr and Sonarr API ([源代码](https://github.com/Dictionarry-Hub/profilarr)) `GPL-3.0` `Docker`
- [Project N.O.M.A.D.](https://github.com/Crosstalk-Solutions/project-nomad) - Offline-first knowledge base and tools `GPL-3.0` `Docker`
- [ProperDocs](https://properdocs.org/) - Drop-in replacement for MkDocs ([源代码](https://github.com/ProperDocs/properdocs)) `GPL-3.0` `Docker`
- [ProxCenter](https://www.proxcenter.io) - Modern web interface for Proxmox ([源代码](https://github.com/adminsyspro/proxcenter-ui)) `GPL-3.0` `Docker`
- [PruneMate](https://prunemate.org) - Docker image and resource cleanup helper ([源代码](https://github.com/anoniemerd/PruneMate)) `GPL-3.0` `Docker`
- [Pulsarr](https://jamcalli.github.io/Pulsarr/) - Plex watchlist monitoring, routing, and notifications ([源代码](https://github.com/jamcalli/Pulsarr)) `GPL-3.0` `Docker`
- [PWgen](https://github.com/jocxfin/pwgen) - Secure password generator with customizable options `MIT` `Docker`
- [pyShelf](https://github.com/th3r00t/pyShelf) - Simple terminal-based ebook server `Apache-2.0` `Docker`
- [Pønskelisten](https://github.com/aunefyren/poenskelisten) - 分享愿望清单，并协作准备礼物与赠品。 `GPL-3.0` `Docker/Go`
- [qBit Manage](https://github.com/StuffAnThings/qbit_manage) - Manage and automate tedious tasks in qBittorrent `GPL-3.0` `Docker`
- [Quetre](https://quetre.iket.me) - Alternative frontend for Quora ([源代码](https://github.com/zyachel/quetre)) `Apache-2.0` `Docker`
- [QuickDrop](https://github.com/RoastSlav/quickdrop) - Easy-to-use file sharing application `GPL-3.0` `Docker`
- [Rachoon](https://github.com/ad-on-is/rachoon) - Modern invoicing platform for freelancers and small businesses `GPL-3.0` `Docker`
- [Rackpad](https://rackpad.net) - Infrastructure inventory and operations workspace ([源代码](https://github.com/Kobii-git/rackpad)) `GPL-3.0` `Docker`
- [Rackula](https://racku.la) - Drag-and-drop server rack visualizer ([源代码](https://github.com/RackulaLives/Rackula)) `GPL-3.0` `Docker`
- [RadaRec](https://github.com/TheWicklowWolf/RadaRec) - Web GUI for finding similar movies to selected Radarr movies `GPL-3.0` `Docker`
- [Rauthy](https://sebadob.github.io/rauthy/) - Lightweight and simple identity provider ([源代码](https://github.com/sebadob/rauthy)) `GPL-3.0` `Docker`
...
- [ReadMeABook](https://github.com/kikootwo/ReadMeABook) - Audiobook discovery, requests, and downloads `GPL-3.0` `Docker`
- [Recyclarr](https://recyclarr.dev) - Automatically sync TRaSH Guides to Sonarr and Radarr ([源代码](https://github.com/recyclarr/recyclarr)) `GPL-3.0` `Docker`
- [Redirecterr](https://github.com/varthe/Redirecterr) - Filter and redirect Overseerr requests `Apache-2.0` `Docker`
- [Redis Commander](https://http://joeferner.github.io/redis-commander/) - Redis web management tool ([源代码](https://github.com/joeferner/redis-commander)) `Apache-2.0` `Docker`
- [Refeed](https://github.com/michaelkremenetsky/Refeed) - Open source RSS reader for the modern human `MIT` `Docker`
- [Reitti](https://www.dedicatedcode.com/projects/reitti/) - Location tracking and analysis ([源代码](https://github.com/dedicatedcode/reitti)) `GPL-3.0` `Docker`
- [Reiverr](https://github.com/aleksilassila/reiverr) - Clean, combined interface for Jellyfin, TMDB, Radarr, and Sonarr `MIT` `Docker`
- [Relaticle](https://relaticle.com) - Modern client relationship management ([源代码](https://github.com/relaticle/relaticle)) `GPL-3.0` `Docker`
- [Repliqate](https://lminlone.github.io/repliqate/) - Modular backup solution for Docker environments ([源代码](https://github.com/lminlone/repliqate)) `Apache-2.0` `Docker`
- [RetroAssembly](https://retroassembly.com) - Personal retro game collection in your browser ([源代码](https://github.com/arianrhodsandlot/retroassembly)) `GPL-3.0` `Docker`
...
- [Riven](https://riven.tv) - Media streaming with various third-party integrations ([源代码](https://github.com/rivenmedia/riven)) `GPL-3.0` `Docker`
- [Rotki](https://rotki.com) - Portfolio manager and analytics tool ([源代码](https://github.com/rotki/rotki)) `GPL-3.0` `Docker`
- [Roundup](https://www.roundup-tracker.org/) - Simple-to-use issue tracking system ([源代码](https://github.com/roundup-tracker/roundup)) `GPL-3.0` `Docker`
- [RSS Librarian](https://www.rsslibrarian.ch/librarian.php) - Read later service for RSS purists ([源代码](https://github.com/thefranke/rss-librarian)) `GPL-3.0` `Docker`
- [RSSBox](https://rssbox.app) - RSS translation tool for subscribing to RSS feeds ([源代码](https://github.com/versun/RSSBox)) `GPL-3.0` `Docker`
- [RunsOn](https://runs-on.com) - Self-hosted runner for GitHub Actions via AWS ([源代码](https://github.com/runs-on/runs-on)) `GPL-3.0` `Docker`
- [Rustpad](https://rustpad.io) - Minimal collaborative code editor ([源代码](https://github.com/ekzhang/rustpad)) `MIT` `Docker`
- [SANE Network Scanning](http://sane-project.org/) - 允许远程客户端访问本地主机上可用的图像采集设备（扫描仪）。 ([源代码](http://www.sane-project.org/cvs.html)) `GPL-2.0` `C`
- [Scholarsome](https://http://scholarsome.com) - Web-based interactive flash cards ([源代码](https://github.com/hwgilbert16/scholarsome)) `GPL-3.0` `Docker`
- [Scratch Map](https://github.com/ad3m3r5/scratch-map) - Scratch-off style map for tracking travels `MIT` `Docker`
- [Screenlite](https://screenlite.org) - Digital signage solution ([源代码](https://github.com/screenlite/screenlite)) `Apache-2.0` `Docker`
- [Scriberr](https://scriberr.app) - Self-hosted AI audio transcription ([源代码](https://github.com/rishikanthc/Scriberr)) `GPL-3.0` `Docker`
- [Seanime](https://seanime.app) - Media streaming server for anime and manga ([源代码](https://github.com/5rahim/seanime)) `GPL-3.0` `Docker`
- [Secrover](https://secrover.org) - Open source security reports ([源代码](https://github.com/Secrover/Secrover)) `GPL-3.0` `Docker`
- [seelf](https://yuukanoo.github.io/seelf/) - Lightweight self-hosted deployment platform written in Go ([源代码](https://github.com/YuukanOO/seelf)) `MIT` `Docker`
- [SeerrBridge](https://soluify.com) - Integration for Jellyseerr/Overseerr and DebridMediaManager ([源代码](https://github.com/Woahai321/SeerrBridge)) `Apache-2.0` `Docker`
- [Self-Hosted Gateway](https://gethomerun.app) - Self-hosted Docker native tunneling to localhost ([源代码](https://github.com/hintjen/selfhosted-gateway)) `MIT` `Docker`
- [Self-Hosted Metrics](https://self-hosted-metrics.com) - Agnostic telemetry for self-hosted software ([源代码](https://github.com/kOlapsis/shm)) `GPL-3.0` `Docker`
- [selfh.st/icons](https://selfh.st/icons) - Dashboard icons with support for custom colors ([源代码](https://github.com/selfhst/icons)) `GPL-3.0` `Docker`
- [SerpBear](https://docs.serpbear.com/) - Search engine position tracking and keyword research ([源代码](https://github.com/towfiqi/serpbear)) `GPL-3.0` `Docker`
- [Shared Moments](https://github.com/tech-kev/SharedMoments) - A website designed for couples to capture and preserve their special moments `GPL-3.0` `Docker`
- [Sharkord](https://sharkord.com) - Lightweight real-time communication platform ([源代码](https://github.com/Sharkord/sharkord)) `GPL-3.0` `Docker`
- [Shelfmark](https://github.com/calibrain/shelfmark) - Interface for searching and requesting book downloads `GPL-3.0` `Docker`
- [ShotShare](https://github.com/mdshack/shotshare) - Open source image sharing application `MIT` `Docker`
- [Silicon Notes](https://github.com/cu/silicon) - Web-based personal knowledge base with few frills `GPL-3.0` `Docker`
- [SkySend](https://skysend.app) - Encrypted file and note sharing ([源代码](https://github.com/Skyfay/SkySend)) `GPL-3.0` `Docker`
- [SmokePing](https://http://www.smokeping.org) - Latency logging, graphing, and alerts ([源代码](https://github.com/oetiker/SmokePing)) `GPL-3.0` `Docker`
- [SnapOtter](https://snapotter.com) - Image manipulator and converter ([源代码](https://github.com/snapotter-hq/SnapOtter)) `GPL-3.0` `Docker`
- [Snippets Library](https://snippetslibrary.com/) - Modern code snippet manager for devs ([源代码](https://github.com/cojocaru-david/snippetslibrary.com)) `Apache-2.0` `Docker`
- [SoFE](https://github.com/chkpwd/sofe) - Monitor non-filler episodes in Sonarr and generate Plex collections `GPL-3.0` `Docker`
- [SonaShow](https://github.com/TheWicklowWolf/SonaShow) - Web GUI for finding similar shows to selected Sonarr shows `GPL-3.0` `Docker`
- [Soulbeet](https://github.com/terry90/soulbeet) - Music downloads and discovery `GPL-3.0` `Docker`
- [SoulSync](https://ssync.net/) - Automated music discovery and collection manager ([源代码](https://github.com/Nezreka/SoulSync)) `GPL-3.0` `Docker`
- [Spacepad](https://spacepad.io) - Simple meeting room occupancy display ([源代码](https://github.com/magweter/spacepad)) `GPL-3.0` `Docker`
- [SparkyBudget](https://github.com/CodeWithCJ/SparkyBudget) - Personal finance management app `GPL-3.0` `Docker`
- [SparkyFitness](https://codewithcj.github.io/SparkyFitness/) - Comprehensive fitness tracking ([源代码](https://github.com/CodeWithCJ/SparkyFitness)) `GPL-3.0` `Docker`
- [Speakr](https://github.com/murtaza-nasir/speakr) - Intelligent note-taking for recordings and meetings `GPL-3.0` `Docker`
- [SpendSpentSpent](https://lamarios.github.io/SpendSpentSpent/) - Easy-to-use expense tracker ([源代码](https://github.com/lamarios/SpendSpentSpent)) `GPL-3.0` `Docker`
- [Sprout Track](https://www.sprout-track.com) - Track baby diapers, feedings, naps, pumping, and other activities ([源代码](https://github.com/Oak-and-Sprout/sprout-track)) `GPL-3.0` `Docker`
- [Squirrel Servers Manager](https://squirrelserversmanager.io/) - User-friendly server configuration and management tool ([源代码](https://github.com/SquirrelCorporation/SquirrelServersManager)) `Apache-2.0` `Docker`
- [Statamic](https://statamic.com) - Build beautiful, easy-to-manage websites ([源代码](https://github.com/statamic/cms)) `GPL-3.0` `Docker`
- [Statping-ng](https://statping-ng.github.io) - Easy-to-use status page for websites and applications ([源代码](https://github.com/statping-ng/statping-ng)) `MIT` `Docker`
- [StencilBox](https://jamesread.github.io/StencilBox/) - Build YAML into simple and speedy static sites ([源代码](https://github.com/jamesread/StencilBox)) `GPL-3.0` `Docker`
- [Sticky](https://www.sticky.today) - Digital sticky note application for organizing thoughts, ideas, and tasks ([源代码](https://github.com/hamzasaleem2/sticky)) `GPL-3.0` `Docker`
- [Stormkit](https://app.stormkit.io) - Infrastructure provider for Jamstack applications ([源代码](https://github.com/stormkit-io/app-stormkit-io)) `Apache-2.0` `Docker`
- [Storybook](https://storybook.js.org) - Build UI components and pages in isolation ([源代码](https://github.com/storybookjs/storybook)) `GPL-3.0` `Docker`
- [Storyden](https://www.storyden.org/) - Fresh take on bulletin board forum software ([源代码](https://github.com/Southclaws/storyden)) `GPL-3.0` `Docker`
- [Streamystats](https://github.com/fredrikburmester/streamystats) - Statistics and analytics service for Jellyfin `GPL-3.0` `Docker`
- [string.is](https://string.is/) - 面向开发人员的开源、注重隐私的在线字符串工具包。 ([源代码](https://github.com/recurser/string-is)) `AGPL-3.0` `Node.js`
- [Subatic](https://subatic.com) - Simple video hosting site that scales with content ([源代码](https://github.com/orthdron/subatic)) `GPL-3.0` `Docker`
- [Subscription Manager](https://github.com/dh1011/subscription-manager) - Track subscriptions and manage expenses `GPL-3.0` `Docker`
- [Subtrackr](https://subtrackr.xyz/) - Subscription management application ([源代码](https://github.com/bscott/subtrackr)) `GPL-3.0` `Docker`
- [SUB/WAVE](https://www.getsubwave.com) - Personal internet radio station ([源代码](https://github.com/perminder-klair/subwave)) `GPL-3.0` `Docker`
- [SuggestArr](https://giuseppe99barchetta.github.io/SuggestArr/) - Automated media recommendations and requests based on user activity ([源代码](https://github.com/giuseppe99barchetta/SuggestArr)) `GPL-3.0` `Docker`
- [SuperBin](https://github.com/Zhoros/SuperBin) - File sharing, URL shortening, and pastebin all-in-one `GPL-3.0` `Docker`
- [Surmai](https://surmai.app/) - Personal and family travel organizer ([源代码](https://github.com/rohitkumbhar/surmai)) `GPL-3.0` `Docker`
- [SurveyJS](https://surveyjs.io/form-library) - Open source surveys and forms ([源代码](https://github.com/surveyjs/survey-library)) `GPL-3.0` `Docker`
- [TapMap](https://olalie.github.io/tapmap/) - Visualize network connections on an interactive map ([源代码](https://github.com/olalie/tapmap)) `GPL-3.0` `Docker`
- [TaskTrove](https://tasktrove.io) - Task management and productivity platform ([源代码](https://github.com/dohsimpson/TaskTrove)) `Apache-2.0` `Docker`
- [TaskView](https://taskview.tech/) - Project and task management platform ([源代码](https://github.com/Gimanh/taskview-community)) `GPL-3.0` `Docker`
- [TasmoAdmin](https://github.com/TasmoAdmin/TasmoAdmin) - Administration platform for devices flashed with Tasmota `GPL-3.0` `Docker`
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) - Distributed transcode automation `GPL-3.0` `Docker`
...
- [Tenzu](https://http://tenzu.net) - Companion tool for launching digital projects ([源代码](https://github.com/BIRU-Scop/tenzu-back)) `GPL-3.0` `Docker`
- [TeslaMate](https://github.com/teslamate-org/teslamate) - 一款强大的特斯拉车辆数据记录器。 `MIT` `Elixir/Docker`
- [TestFlight Watcher](https://github.com/MaximilianGT500/testflight-watcher) - Monitor TestFlight betas and notify on availability `MIT` `Docker`
- [The One File](https://therecanonlybe.one/The-One-File/) - Visualization and mapping platform ([源代码](https://github.com/gelatinescreams/The-One-File)) `GPL-3.0` `Docker`
- [Thrifty](https://buymeacoffee.com/tiehfood) - Simple monthly income and expense tracker ([源代码](https://github.com/tiehfood/thrifty)) `GPL-3.0` `Docker`
- [Ticky](https://github.com/dkorecko/Ticky) - Modern Kanban app `GPL-3.0` `Docker`
- [Ties](https://github.com/raffomania/ties) - Federated bookmark and link sharing `GPL-3.0` `Docker`
- [Timeful](https://timeful.app) - Scheduling platform for group meets ([源代码](https://github.com/schej-it/timeful.app)) `GPL-3.0` `Docker`
- [Tootik](https://github.com/dimkr/tootik) - Federated nano-blogging service with federation `GPL-3.0` `Docker`
- [torrra](https://torrra.readthedocs.io) - Download torrents directly from the CLI ([源代码](https://github.com/stabldev/torrra)) `GPL-3.0` `Docker`
- [Touitomamout](https://github.com/louisgrasset/touitomamout) - Easily sync tweets to Mastodon and Bluesky `MIT` `Docker`
- [Tracearr](https://www.tracearr.com) - Streaming access manager for Plex, Jellyfin, and Emby ([源代码](https://github.com/connorgallopo/Tracearr)) `GPL-3.0` `Docker`
- [Trackly](https://github.com/7eventy7/trackly) - Jellyfin music library interface and release notifications `GPL-3.0` `Docker`
- [Tracktor](https://tracktor.bytedge.in) - Comprehensive vehicle management ([源代码](https://github.com/javedh-dev/tracktor)) `GPL-3.0` `Docker`
- [TradeTally](https://tradetally.io) - Advanced financial trade tracking and analytics ([源代码](https://github.com/GeneBO98/tradetally)) `GPL-3.0` `Docker`
- [traefik-kop](https://github.com/jittering/traefik-kop) - Single public-facing Traefik instance for Kubernetes `GPL-3.0` `Docker`
- [Traefik Log Dashboard](https://github.com/hhftechnology/traefik-log-dashboard) - Real-time dashboard for analyzing Traefik logs `GPL-3.0` `Docker`
- [Traefik Manager](https://traefik-manager.xyzlab.dev/) - Clean web interface for managing Traefik ([源代码](https://github.com/chr0nzz/traefik-manager)) `GPL-3.0` `Docker`
- [Trailarr](https://nandyalu.github.io/trailarr/) - Download and manage trailers for media libraries ([源代码](https://github.com/nandyalu/trailarr)) `GPL-3.0` `Docker`
- [TraLa](https://www.trala.fyi/) - Simple, modern dashboard for Traefik services ([源代码](https://github.com/dannybouwers/trala)) `GPL-3.0` `Docker`
- [Transfer.zip](https://transfer.zip) - Complete file sharing solution ([源代码](https://github.com/robinkarlberg/transfer.zip-web)) `GPL-3.0` `Docker`
...
- [Tugtainer](https://github.com/Quenary/tugtainer) - Automated Docker container backups `GPL-3.0` `Docker`
- [Tunarr](https://tunarr.com/) - Create and configure live TV channels from personal media ([源代码](https://github.com/chrisbenincasa/tunarr)) `GPL-3.0` `Docker`
- [TVHeadend](https://tvheadend.org) - TV streaming server and digital video recorder ([源代码](https://github.com/tvheadend/tvheadend)) `GPL-3.0` `Docker`
- [Tymeslot](https://tymeslot.app) - Privacy-first scheduling platform ([源代码](https://github.com/Tymeslot/tymeslot)) `GPL-3.0` `Docker`
- [TypeType](https://typetype.video) - Privacy-respecting YouTube frontend ([源代码](https://github.com/TypeType-Video/TypeType)) `GPL-3.0` `Docker`
- [Unblink](https://github.com/zapdos-labs/unblink) - Camera monitoring app with AI vision `GPL-3.0` `Docker`
- [UniFi Voucher Site](https://github.com/glenndehaan/unifi-voucher-site) - Generate and manage UniFi network guest vouchers `GPL-3.0` `Docker`
- [Unpackerr](https://unpackerr.zip) - Download and extract media for *arr imports ([源代码](https://github.com/Unpackerr/unpackerr)) `GPL-3.0` `Docker`
- [Unraid Guardian](https://github.com/stephondoestech/unraid-config-guardian) - Disaster recovery generator for Unraid `GPL-3.0` `Docker`
- [Unregistry](https://github.com/psviderski/unregistry) - Internal container image registry `GPL-3.0` `Docker`
...
- [VaulTLS](https://github.com/7ritn/VaulTLS) - mTLS certificate manager `GPL-3.0` `Docker`
- [Velld](https://velld.vercel.app) - Database backup management and automation ([源代码](https://github.com/dendianugerah/velld)) `GPL-3.0` `Docker`
- [VerneMQ](https://vernemq.com) - Distributed MQTT message broker ([源代码](https://github.com/vernemq/vernemq)) `GPL-3.0` `Docker`
- [VersityGW](https://www.versity.com/products/versitygw/) - File system and S3 object interface bridge ([源代码](https://github.com/versity/versitygw)) `GPL-3.0` `Docker`
- [ViniPlay](https://github.com/ardoviniandrea/ViniPlay) - IPTV player with a modern web interface `Apache-2.0` `Docker`
- [Vito](https://vitodeploy.com) - Manage server and deploy apps from the web ([源代码](https://github.com/vitodeploy/vito)) `GPL-3.0` `Docker`
- [Vocard](https://vocard.xyz) - Highly customizable Discord music bot ([源代码](https://github.com/ChocoMeow/Vocard)) `GPL-3.0` `Docker`
- [VoidAuth](https://http://voidauth.app) - Simplified user management and SSO ([源代码](https://github.com/voidauth/voidauth)) `GPL-3.0` `Docker`
- [Vykar](https://vykar.borgbase.com) - Fast, encrypted, deduplicated backups ([源代码](https://github.com/borgbase/vykar)) `GPL-3.0` `Docker`
- [WagmiOS](https://http://wiki.wagmilabs.fun/) - Container deployment and management with AI integration ([源代码](https://github.com/mentholmike/wagmios)) `GPL-3.0` `Docker`
...
- [Wapy.dev](https://www.wapy.dev) - Subscription management platform ([源代码](https://github.com/meceware/wapy.dev)) `GPL-3.0` `Docker`
- [Warracker](https://warracker.com) - 保修期追踪工具，可监控到期日、上传收据/文件，并在保修到期前提醒。 ([源代码](https://github.com/sassanix/Warracker)) `AGPL-3.0` `Docker`
- [WatchState](https://github.com/arabcoders/watchstate) - Sync media play states across Plex, Jellyfin, and Emby `GPL-3.0` `Docker`
...
- [Webtop](https://github.com/linuxserver/docker-webtop) - Desktop environments accessible via the browser `GPL-3.0` `Docker`
...
- [WGDashboard](https://github.com/WGDashboard/WGDashboard) - WireGuard config and management dashboard `GPL-3.0` `Docker`
- [WhoRang](https://github.com/Beast12/who-rang) - AI-powered doorbell intelligence `MIT` `Docker`
- [Willow](https://heywillow.io/) - Open source local voice assistant alternative ([源代码](https://github.com/HeyWillow/willow)) `GPL-3.0` `Docker`
- [Wiredoor](https://www.wiredoor.net) - Expose applications running in private or local networks ([源代码](https://github.com/wiredoor/wiredoor)) `GPL-3.0` `Docker`
- [Wishlist](https://github.com/cmintey/wishlist) - 可与亲友分享的愿望清单应用。 `MIT` `Docker/K8S`
- [withoutbg](https://github.com/withoutbg/withoutbg-inference) - AI-powered image background removal `GPL-3.0` `Docker`
- [wol](https://github.com/Trugamr/wol) - Simple Wake-on-LAN web interface `GPL-3.0` `Docker`
- [WoLi WebGUI](https://github.com/RemyFV/WoLi-webgui) - Extremely lightweight image for sending WoL magic packets `MIT` `Docker`
- [Workout Tracker](https://github.com/jovandeginste/workout-tracker) - Workout tracking web application geared towards running and other GPX-based activities `GPL-3.0` `Docker`
- [Workout.cool](https://workout.cool) - Modern fitness coaching platform ([源代码](https://github.com/Snouzy/workout-cool)) `GPL-3.0` `Docker`
- [WUD](https://getwud.github.io/wud/) - Notifications for Docker image updates ([源代码](https://github.com/getwud/wud)) `GPL-3.0` `Docker`
- [Xibo](https://xibosignage.com) - Open source digital signage platform ([源代码](https://github.com/xibosignage/xibo)) `GPL-3.0` `Docker`
- [XPipe](https://xpipe.io) - Connection hub for SSH, VNC, RDP, and more ([源代码](https://github.com/xpipe-io/xpipe)) `GPL-3.0` `Docker`
- [xyOps](https://github.com/pixlcore/xyops) - Workflow automation and server monitoring `GPL-3.0` `Docker`
- [Yacht](https://github.com/SelfhostedPro/Yacht) - Web interface for managing docker containers with templating and 1-click deployments `MIT` `Docker`
- [YAMLResume](https://yamlresume.dev) - Resume creation, generation, and version control ([源代码](https://github.com/yamlresume/yamlresume)) `GPL-3.0` `Docker`
...
- [YeetFile](https://github.com/benbusby/yeetfile) - Encrypted file sharing vault service `Apache-2.0` `Docker`
- [Youlag](https://github.com/civilblur/youlag) - Theme and video extension for FreshRSS `GPL-3.0` `Docker`
- [YT-DLP Web Player](https://github.com/Matszwe02/ytdlp_web_player) - Web video player powered by yt-dlp `GPL-3.0` `Docker`
- [YTPTube](https://github.com/arabcoders/ytptube) - Web-based GUI for yt-dlp `GPL-3.0` `Docker`
- [yubal](https://github.com/guillevc/yubal) - YouTube Music album downloader with metadata tagging `GPL-3.0` `Docker`
- [Yuvomi](https://yuvomi.cloud/) - Family planner for small households ([源代码](https://github.com/ulsklyc/yuvomi)) `GPL-3.0` `Docker`
- [Z-Wave JS UI](https://zwave-js.github.io/zwave-js-ui) - Full featured Z-Wave control panel UI and MQTT gateway ([源代码](https://github.com/zwave-js/zwave-js-ui)) `GPL-3.0` `Docker`
- [ZaneOps](https://zaneops.dev) - Platform for deploying static sites, web apps, databases, and CRON jobs ([源代码](https://github.com/zane-ops/zane-ops)) `GPL-3.0` `Docker`
- [Zen Notes](https://www.sheshbabu.com/zen/) - Simple Markdown note-taking app ([源代码](https://github.com/sheshbabu/zen)) `GPL-3.0` `Docker`
- [ZenNotes](https://zennotes.org) - Keyboard-first Markdown note-taking ([源代码](https://github.com/ZenNotes/zennotes)) `GPL-3.0` `Docker`
...
- [ZipCaptions](https://zipcaptions.app) - Generate text from a given audio source using only your browser ([源代码](https://github.com/jptrsn/zip-captions)) `GPL-3.0` `Docker`
- [ZTNET](https://ztnet.network) - Self-hosted ZeroTier network controller ([源代码](https://github.com/sinamics/ztnet)) `GPL-3.0` `Docker`
...
- [Argus](https://release-argus.io) - Software release monitoring and notifications ([源代码](https://github.com/release-argus/Argus)) `GPL-3.0` `Docker`
...
- [Monitarr](https://github.com/nickshanks347/monitarr) - Monitor downloads from Radarr and Sonarr `GPL-3.0` `Docker`
...
- [Boxarr](https://github.com/iongpt/boxarr) - Automatically add trending box office movies to Radarr `GPL-3.0` `Docker`
...
- [Decypharr](https://github.com/sirrobot01/decypharr) - qBittorrent implementation with Debrid support `GPL-3.0` `Docker`
...
- [Rangarr](https://github.com/JudoChinX/rangarr) - Automate media searches across the *arr stack `GPL-3.0` `Docker`
- [Rundeck](https://http://rundeck.org) - 跨多服务器的作业调度和自动化运维平台。 ([源代码](https://github.com/rundeck/rundeck)) `GPL-3.0` `Docker`
- [Scraparr](https://github.com/thecfu/scraparr) - Prometheus exporter for *arr apps `GPL-3.0` `Docker`
- [Sonobarr](https://github.com/Dodelidoo-Labs/sonobarr) - Music discovery for Lidarr users via Last.fm `GPL-3.0` `Docker`
- [Sortarr](https://github.com/Jaredharper1/Sortarr) - Sonarr and Radarr library insights `GPL-3.0` `Docker`
